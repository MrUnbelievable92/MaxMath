...
Assert.IsWithinArrayBounds(index, 16);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool16 operator < (byte16 lhs, byte16 rhs) => (short16)lhs < (short16)rhs;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(byte16 other) => maxmath.cvt_boolean(Sse4_1.test_all_ones(Sse2.cmpeq_epi8(this, other)));

...
namespace MaxMath
{
    ...
    unsafe public struct ushort3 : IEquatable<ushort3>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
        public static implicit operator v128(ushort3 input) => Sse2.insert_epi16(Sse2.set1_epi32(*(int*)&input), input.z, 2);
...
Assert.IsWithinArrayBounds(index, 3);
        ...
        {
            int result = 0x0001_0101 & Sse4_1.extract_epi32((byte3)(ushort3)input, 0);
        ...
        {
            int result = maxmath.andn(0x0001_0101, Sse4_1.extract_epi32((byte3)(ushort3)input, 0));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(ushort3 other) => maxmath.cvt_boolean(Sse4_1.testc_si128(Sse2.cmpeq_epi16(this, other), new v128(-1, -1, -1, 0, 0, 0, 0, 0)));

        public override bool Equals(object obj) => Equals((ushort3)obj);
    
    
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override int GetHashCode() => (Sse4_1.extract_epi64(this, 0) & (long)maxmath.bitmask64(48)).GetHashCode();

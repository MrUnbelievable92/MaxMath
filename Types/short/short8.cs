...
namespace MaxMath
{
    ...
    unsafe public struct short8 : IEquatable<short8>
    {
        ...
        public short4 v4_1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(2, 3,  4, 5,  6, 7,  8, 9,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        public short4 v4_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(0, 0, 2, 1)); } 
        public short4 v4_3 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(6, 7,  8, 9,  10, 11,  12, 13,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        ...
        public short3 v3_1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(2, 3,  4, 5,  6, 7,  8, 9,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        public short3 v3_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(0, 0, 2, 1)); } 
        public short3 v3_3 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(6, 7,  8, 9,  10, 11,  12, 13,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        public short3 v3_4 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(0, 0, 3, 2)); } 
        public short3 v3_5 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(10, 11,  12, 13,  14, 15,  15, 15,   0, 0, 0, 0, 0, 0, 0, 0)); } 
                                                                                   
        public short2 v2_0 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => (v128)this; }
        public short2 v2_1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(2, 3,  4, 5,  6, 7,  8, 9,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        public short2 v2_2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(0, 0, 2, 1)); } 
        public short2 v2_3 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(6, 7,  8, 9,  10, 11,  12, 13,   0, 0, 0, 0, 0, 0, 0, 0)); } 
        public short2 v2_4 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(0, 0, 3, 2)); } 
        public short2 v2_5 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Ssse3.shuffle_epi8(this, new v128(10, 11,  12, 13,  14, 15,  15, 15,   0, 0, 0, 0, 0, 0, 0, 0)); } 
...
Assert.IsWithinArrayBounds(index, 8);
        ...
        {
            return Sse2.and_si128((byte8)(short8)input, new v128(0x0101_0101_0101_0101L, 0L));
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool8 TestIsFalse(v128 input)
        {
            return Sse2.andnot_si128((byte8)(short8)input, new v128(0x0101_0101_0101_0101L, 0L));
        }

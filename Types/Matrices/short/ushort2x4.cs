...
namespace MaxMath
{
    ...
    unsafe public struct ushort2x4 : IEquatable<ushort2x4>, IFormattable
    {
        ...
        public static ushort2x4 zero => default(ushort2x4);
        ...
        public ref ushort2 this[[AssumeRange(0, 3)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 4);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort2x4 operator + (ushort2x4 lhs, ushort2x4 rhs) => new ushort2x4 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2, lhs.c3 + rhs.c3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort2x4 operator * (ushort2x4 lhs, ushort rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort2x4 operator * (ushort lhs, ushort2x4 rhs) => new ushort2x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort2x4 operator / (ushort2x4 lhs, ushort rhs) => new ushort2x4 (lhs.c0 / rhs, lhs.c1 / rhs, lhs.c2 / rhs, lhs.c3 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x4 operator == (ushort2x4 lhs, ushort2x4 rhs) => new bool2x4 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1, lhs.c2 == rhs.c2, lhs.c3 == rhs.c3);

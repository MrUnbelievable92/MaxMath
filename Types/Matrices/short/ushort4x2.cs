...
namespace MaxMath
{
    ...
    unsafe public struct ushort4x2 : IEquatable<ushort4x2>, IFormattable
    {
        ...
        public static ushort4x2 zero => default(ushort4x2);
        ...
        public ref ushort4 this[[AssumeRange(0, 1)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x2 operator + (ushort4x2 lhs, ushort4x2 rhs) => new ushort4x2 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x2 operator * (ushort4x2 lhs, ushort rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x2 operator * (ushort lhs, ushort4x2 rhs) => new ushort4x2 (lhs * rhs.c0, lhs * rhs.c1);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x2 operator / (ushort4x2 lhs, ushort rhs) => new ushort4x2 (lhs.c0 / rhs, lhs.c1 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x2 operator == (ushort4x2 lhs, ushort4x2 rhs) => new bool4x2 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(ushort4x2 other) => this.c0.Equals(other.c0) & this.c1.Equals(other.c1);
        public override bool Equals(object obj) => Equals((ushort4x2)obj);
        ...
        public override string ToString() => $"ushort4x2({c0.x}, {c1.x},  {c0.y}, {c1.y},  {c0.z}, {c1.z},  {c0.w}, {c1.w})";
        public string ToString(string format, IFormatProvider formatProvider) => $"ushort4x2({c0.x.ToString(format, formatProvider)}, {c1.x.ToString(format, formatProvider)},  {c0.y.ToString(format, formatProvider)}, {c1.y.ToString(format, formatProvider)},  {c0.z.ToString(format, formatProvider)}, {c1.z.ToString(format, formatProvider)},  {c0.w.ToString(format, formatProvider)}, {c1.w.ToString(format, formatProvider)})";
    }
}
...
namespace MaxMath
{
    ...
    unsafe public struct ushort4x3 : IEquatable<ushort4x3>, IFormattable
    {
        ...
        public ref ushort4 this[[AssumeRange(0, 2)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x3 operator + (ushort4x3 lhs, ushort4x3 rhs) => new ushort4x3 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x3 operator * (ushort4x3 lhs, ushort rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x3 operator * (ushort lhs, ushort4x3 rhs) => new ushort4x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort4x3 operator / (ushort4x3 lhs, ushort rhs) => new ushort4x3 (lhs.c0 / rhs, lhs.c1 / rhs, lhs.c2 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x3 operator == (ushort4x3 lhs, ushort4x3 rhs) => new bool4x3 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1, lhs.c2 == rhs.c2);

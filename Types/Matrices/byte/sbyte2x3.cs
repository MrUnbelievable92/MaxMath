...
namespace MaxMath
{
    ...
    unsafe public struct sbyte2x3 : IEquatable<sbyte2x3>, IFormattable
    {
        ...
        public static sbyte2x3 zero => default(sbyte2x3);
        ...
        public ref sbyte2 this[[AssumeRange(0, 2)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte2x3 operator + (sbyte2x3 lhs, sbyte2x3 rhs) => new sbyte2x3 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte2x3 operator * (sbyte2x3 lhs, sbyte rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte2x3 operator * (sbyte lhs, sbyte2x3 rhs) => new sbyte2x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte2x3 operator / (sbyte2x3 lhs, sbyte rhs) => new sbyte2x3 (lhs.c0 / rhs, lhs.c1 / rhs, lhs.c2 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator == (sbyte2x3 lhs, sbyte2x3 rhs) => new bool2x3 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1, lhs.c2 == rhs.c2);

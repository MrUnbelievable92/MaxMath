...
namespace MaxMath
{
    ...
    unsafe public struct byte4x3 : IEquatable<byte4x3>, IFormattable
    {
        ...
        public static byte4x3 zero => default(byte4x3);
        ...
        public ref byte4 this[[AssumeRange(0, 2)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte4x3 operator + (byte4x3 lhs, byte4x3 rhs) => new byte4x3 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte4x3 operator * (byte4x3 lhs, byte rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte4x3 operator * (byte lhs, byte4x3 rhs) => new byte4x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte4x3 operator / (byte4x3 lhs, byte rhs) => new byte4x3 (lhs.c0 / rhs, lhs.c1 / rhs, lhs.c2 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x3 operator == (byte4x3 lhs, byte4x3 rhs) => new bool4x3 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1, lhs.c2 == rhs.c2);

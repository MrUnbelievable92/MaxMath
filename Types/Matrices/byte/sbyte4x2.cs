...
namespace MaxMath
{
    ...
    unsafe public struct sbyte4x2 : IEquatable<sbyte4x2>, IFormattable
    {
        ...
        public static sbyte4x2 zero => default(sbyte4x2);
        ...
        public ref sbyte4 this[[AssumeRange(0, 1)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte4x2 operator + (sbyte4x2 lhs, sbyte4x2 rhs) => new sbyte4x2 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte4x2 operator * (sbyte4x2 lhs, sbyte rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte4x2 operator * (sbyte lhs, sbyte4x2 rhs) => new sbyte4x2 (lhs * rhs.c0, lhs * rhs.c1);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte4x2 operator / (sbyte4x2 lhs, sbyte rhs) => new sbyte4x2 (lhs.c0 / rhs, lhs.c1 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x2 operator == (sbyte4x2 lhs, sbyte4x2 rhs) => new bool4x2 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1);

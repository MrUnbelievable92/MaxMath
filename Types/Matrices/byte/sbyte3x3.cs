...
namespace MaxMath
{
    ...
    unsafe public struct sbyte3x3 : IEquatable<sbyte3x3>, IFormattable
    {
        ...
        public ref sbyte3 this[[AssumeRange(0, 2)] int index]
        {
            get
            {
Assert.IsWithinArrayBounds(index, 3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3x3 operator + (sbyte3x3 lhs, sbyte3x3 rhs) => new sbyte3x3 (lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3x3 operator * (sbyte3x3 lhs, sbyte rhs) => rhs * lhs;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3x3 operator * (sbyte lhs, sbyte3x3 rhs) => new sbyte3x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3x3 operator / (sbyte3x3 lhs, sbyte rhs) => new sbyte3x3 (lhs.c0 / rhs, lhs.c1 / rhs, lhs.c2 / rhs);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool3x3 operator == (sbyte3x3 lhs, sbyte3x3 rhs) => new bool3x3 (lhs.c0 == rhs.c0, lhs.c1 == rhs.c1, lhs.c2 == rhs.c2);

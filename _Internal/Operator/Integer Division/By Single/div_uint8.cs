...
Assert.AreNotEqual(divisor, 0u);
        ...
        private static uint8 div_uint_365(uint8 x)
        {
            ...
            ulong4 lo_mul = Avx2.mm256_mul_epu32(lo, new ulong4(1_729_753_953ul));
            ulong4 hi_mul = Avx2.mm256_mul_epu32(hi, new ulong4(1_729_753_953ul));

            uint8 castShift = Avx2.mm256_permute2x128_si256(Avx2.mm256_permutevar8x32_epi32(lo_mul, new v256(1, 3, 5, 7, 0, 0, 0, 0)),
                                                                Avx2.mm256_permutevar8x32_epi32(hi_mul, new v256(1, 3, 5, 7, 0, 0, 0, 0)),
                                                                Sse.SHUFFLE(0, 2, 0, 0));
            x -= castShift;
            x >>= 1;
            x += castShift;
        ...
        private static uint8 div_uint_366(uint8 x)
        {
            ...
            lo = Avx2.mm256_mul_epu32(lo, new ulong4(3_004_130_131ul));
            hi = Avx2.mm256_mul_epu32(hi, new ulong4(3_004_130_131ul));

            x = Avx2.mm256_permute2x128_si256(Avx2.mm256_permutevar8x32_epi32(lo, new v256(1, 3, 5, 7, 0, 0, 0, 0)),
                                                  Avx2.mm256_permutevar8x32_epi32(hi, new v256(1, 3, 5, 7, 0, 0, 0, 0)),
                                                  Sse.SHUFFLE(0, 2, 0, 0));
            x >>= 8;

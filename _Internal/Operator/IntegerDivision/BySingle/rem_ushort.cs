...
#endif
                case 1: return 0;
                case ushort.MaxValue: return X86.Sse4_1.blendv_epi8(dividend, default(ushort8), X86.Sse2.cmpeq_epi16(dividend, new ushort8(ushort.MaxValue)));
...
#endif
                case 1: return 0;
                case ushort.MaxValue: return X86.Avx2.mm256_blendv_epi8(dividend, default(ushort16), X86.Avx2.mm256_cmpeq_epi16(dividend, new ushort16(ushort.MaxValue)));

...
#endif
                case 1ul: return 0;
                case ulong.MaxValue: return X86.Sse4_1.blendv_epi8(dividend, default(ulong2), X86.Sse4_1.cmpeq_epi64(dividend, new ulong2(ulong.MaxValue)));
...
#endif
                case 1ul: return 0;
                case ulong.MaxValue: return X86.Avx2.mm256_blendv_epi8(dividend, default(ulong4), X86.Avx2.mm256_cmpeq_epi64(dividend, new ulong4(ulong.MaxValue)));

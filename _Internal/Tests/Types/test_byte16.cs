...
namespace MaxMath.Tests
{
    ...
    unsafe public static class Byte16
    {
        ...
        {
            new byte16(183, 55, 99, 76, 65, 1, 211, 35, 75, 99, 211, 54, 68, 32, 254, 177),
            new byte16(22, 12, 16, 211, 99, 80, 54, 39, 76, 65, 1, 211, 35, 75, 99, 211),      // EQUAL
            new byte16(87, byte.MaxValue, 17, 21, 0, 47, 32, 156, 87, 21, 47, 170, 54, 222, 12, 88),
            new byte16(byte.MinValue, 13, 111, 66, 199, 39, 250, 121, 3, 32, 198, 6, 34, 124, 15, 99)
        };

        internal static byte16[] TestData_RHS => new byte16[]
        {
            new byte16(12, 8, 53, 98, 2, 173, 97, 44, 87, 219, 182, 43, 211, 35, 75, 99),
            new byte16(22, 12, 16, 211, 99, 80, 54, 39, 76, 65, 1, 211, 35, 75, 99, 211),      // EQUAL
            new byte16(17, 87, 9, 182, 239, 45, 90, 162, 177, 12, 47, 149, 65, 7, 127, 88),
            new byte16(2, 9, 200, 192, 87, 219, 182, 43, 43, 2, 242, 99, 158, 92, 13, 21)
        };

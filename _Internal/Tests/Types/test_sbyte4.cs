...
namespace MaxMath.Tests
{
    ...
    unsafe public static class SByte4
    {
        ...
        {
            new sbyte4(-43, -55, 99, 76),
            new sbyte4(22, 12, 16, -11),      // EQUAL
            new sbyte4(47, sbyte.MaxValue, -17, 21),
            new sbyte4(sbyte.MinValue, 13, -111, 66)
        };

        internal static sbyte4[] TestData_RHS => new sbyte4[]
        {
            new sbyte4(12, 4, 53, 98),
            new sbyte4(22, 12, 16, -11),      // EQUAL
            new sbyte4(-17, 47, 9, -42),
            new sbyte4(2, 9, -80, -92)
        };
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte_SByte_SByte_SByte()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte2_SByte_SByte()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte_SByte2_SByte()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte_SByte_SByte2()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte2_SByte2()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte3_SByte()
        {
        ...
        [UnitTest("Types", "sbyte4")]
        public static bool Constructor_SByte_SByte3()
        {
        ...
        public static bool ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                {
                    sbyte4 x = TestData_LHS[i] << TestData_int32[j];
                    ...
                    result &= x.x == (sbyte)(TestData_LHS[i].x << TestData_int32[j]) & 
                              ...
                              x.w == (sbyte)(TestData_LHS[i].w << TestData_int32[j]);
                }
            }

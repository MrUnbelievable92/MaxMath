...
namespace MaxMath.Tests
{
    ...
    unsafe public static class ULong4
    {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong_ULong_ULong_ULong()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong2_ULong_ULong()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong_ULong2_ULong()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong_ULong_ULong2()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong2_ULong2()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong3_ULong()
        {
        ...
        [UnitTest("Types", "ulong4")]
        public static bool Constructor_ULong_ULong3()
        {
        ...
        public static bool ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                {
                    ulong4 x = TestData_LHS[i] << TestData_int32[j];

                    result &= x.x == (ulong)(TestData_LHS[i].x << TestData_int32[j]) & 
                              x.y == (ulong)(TestData_LHS[i].y << TestData_int32[j]) &
                              x.z == (ulong)(TestData_LHS[i].z << TestData_int32[j]) &
                              x.w == (ulong)(TestData_LHS[i].w << TestData_int32[j]);
                }
            }

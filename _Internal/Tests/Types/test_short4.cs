...
namespace MaxMath.Tests
{
    ...
    unsafe public static class Short4
    {
        ...
        {
            new short4(-14693, 554, 9119, 7076),
            new short4(22555, 14742, 14276, -21001),      // EQUAL
            new short4(4764, short.MaxValue, -17789, -27521),
            new short4(short.MinValue, 16333, -1011, 6556)
        };

        internal static short4[] TestData_RHS => new short4[]
        {
            new short4(120, 4457, -3888, 980),
            new short4(22555, 14742, 14276, -21001),      // EQUAL
            new short4(1747, -4627, -709, -14662),
            new short4(2, -9653, 200, 1902)
        };
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short_Short_Short_Short()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short2_Short_Short()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short_Short2_Short()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short_Short_Short2()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short2_Short2()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short3_Short()
        {
        ...
        [UnitTest("Types", "short4")]
        public static bool Constructor_Short_Short3()
        {
        ...
        public static bool ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                {
                    short4 x = TestData_LHS[i] << TestData_int32[j];

                    result &= x.x == (short)(TestData_LHS[i].x << TestData_int32[j]) & 
                              x.y == (short)(TestData_LHS[i].y << TestData_int32[j]) &
                              x.z == (short)(TestData_LHS[i].z << TestData_int32[j]) &
                              x.w == (short)(TestData_LHS[i].w << TestData_int32[j]);
                }
            }

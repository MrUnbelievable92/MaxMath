...
namespace MaxMath.Tests
{
    ...
    unsafe public static class ULong3
    {
        ...
        [UnitTest("Types", "ulong3")]
        public static bool Constructor_ULong_ULong_ULong()
        {
        ...
        [UnitTest("Types", "ulong3")]
        public static bool Constructor_ULong2_ULong()
        {
        ...
        [UnitTest("Types", "ulong3")]
        public static bool Constructor_ULong_ULong2()
        {
        ...
        public static bool ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                {
                    ulong3 x = TestData_LHS[i] << TestData_int32[j];

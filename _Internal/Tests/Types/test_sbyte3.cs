...
{
#if UNITY_EDITOR
    unsafe public static class SByte3
    {
        ...
        {
            new sbyte3(-43, 55, 99),
            new sbyte3(22, -12, 16),      // EQUAL
            new sbyte3(47, sbyte.MaxValue, 17),
            new sbyte3(sbyte.MinValue, 13, -111)
        };
        ...
        [UnitTest("Types", "sbyte3")]
        public static bool Constructor_SByte2_SByte()
        {
        ...
        [UnitTest("Types", "sbyte3")]
        public static bool Constructor_SByte_SByte2()
        {

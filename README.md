...
- This library uses Wojciech Mula's SIMD population count algorithm. Population count functions for (s)byte and (u)short types are very fast, and this library contains a functions to sum up the number of 1-bits in a given block of memory based on it, too

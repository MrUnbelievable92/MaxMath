...
Note: 
- [C Sharp Dev Tools](https://github.com/MrUnbelievable92/C-Sharp-Dev-Tools)  (a repository of mine) is required. Unit tests for this library are included in this repository.

...
{
    unsafe public static class t_UInt128
    {
       ...
       [Test]
        ...
        public static void MulHi()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                __UInt256__ product = __UInt256__.umul256(left, right);

                Assert.AreEqual((BigInteger)left * (BigInteger)right,
                                (BigInteger)product.lo128 | ((BigInteger)product.hi128 << 128));
            }
        }
        ...
        public static void Parse()
        {
            ...
            Assert.AreEqual(UInt128.Parse("0"),  (UInt128)0);
            Assert.AreEqual(UInt128.Parse("1"),  (UInt128)1);
            Assert.AreEqual(UInt128.Parse("10"), (UInt128)10);

            for (int i = 0; i < 25; i++)
            {
                UInt128 x = rng.NextUInt128();

                Assert.AreEqual(x, UInt128.Parse(x.ToString()));
            }
        }
    }
}
...
{
    unsafe public static class t_Int128
    {
        ...
        public static void MulHi()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                __UInt256__ product = __UInt256__.imul256(left, right);

                if ((Int128)product.lo128 < 0)
                {
                    Assert.AreEqual((BigInteger)left * (BigInteger)right,
                                    ((BigInteger)(Int128)product.lo128 & UInt128.MaxValue) | ((BigInteger)(Int128)product.hi128 << 128));
                }
                else
                {
                    Assert.AreEqual((BigInteger)left * (BigInteger)right,
                                    (BigInteger)(Int128)product.lo128 | ((BigInteger)(Int128)product.hi128 << 128));
                }
            }
        }
        ...
        new public static void ToString()
        {
            ...
            Assert.AreEqual(Int128.MAX_DECIMAL_DIGITS - 1, ((BigInteger)Int128.MaxValue).ToString().Length);
            Assert.AreEqual(Int128.MAX_DECIMAL_DIGITS, ((BigInteger)Int128.MinValue).ToString().Length);
        ...
        public static void Parse()
        {
            ...
            Assert.AreEqual(Int128.Parse("0"),   (Int128)0);
            Assert.AreEqual(Int128.Parse("-0"),  (Int128)0);
            Assert.AreEqual(Int128.Parse("-1"),  (Int128)(-1));
            Assert.AreEqual(Int128.Parse("-10"), (Int128)(-10));

            for (int i = 0; i < 25; i++)
            {
                Int128 x = rng.NextInt128();

                Assert.AreEqual(x, Int128.Parse(x.ToString()));
            }
        }

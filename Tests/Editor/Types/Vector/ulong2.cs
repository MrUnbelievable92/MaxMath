...
{
    unsafe public static class t_ulong2
    {
        ...
        public static void op_Division()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ulong2 r = rng.NextULong2(1, ulong.MaxValue);
                ulong2 sanity = 0;
                for (int j = 0; j < 2; j++)
                {
                    sanity[j] = l[j] / r[j];
                ...
                l = rng.NextULong2(Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, ulong.MaxValue);
                r = rng.NextULong2(1, ulong.MaxValue);
                for (int j = 0; j < 2; j++)
                {
                    sanity[j] = l[j] / r[j];
                }
                ...
                l = rng.NextULong2(1, ulong.MaxValue);
                r = rng.NextULong2(Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, ulong.MaxValue);
                for (int j = 0; j < 2; j++)
                {
                    sanity[j] = l[j] / r[j];
                }
        ...
        public static void Cast_FromFloat()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                float2 x = rng.NextFloat2(0f, ulong.MaxValue - 1e10f);
                ulong2 test = (ulong2)x;
        ...
        public static void Cast_FromDouble()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                double2 x = rng.NextDouble2(0d, ulong.MaxValue - 1e10d);
                ulong2 test = (ulong2)x;

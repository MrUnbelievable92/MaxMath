...
{
    unsafe public static class t_long3
    {
        internal const int NUM_TESTS = 4;


        internal static long3[] TestData_LHS => new long3[]
        {
            new long3{x =143876593,
					  y =552995665,
                      z =-99090052},
            ...
            new long3{x =long.MinValue,
					  y =374478857,
                      z =1964478840}
        };

        internal static long3[] TestData_RHS => new long3[]
        {
            new long3{x =121890,
					  y =-52996104,
                      z =5304100},
        ...
        {
            long3 x = new long3(TestData_LHS[0].x);
        ...
        public static void op_Addition()
        {
            ...
            {
                long3 x = TestData_LHS[i] + TestData_RHS[i];
        ...
        public static void Cast_FromFloat()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                float3 x = rng.NextFloat3(long.MinValue + 1e10f, long.MaxValue - 1e10f);
                long3 test = (long3)x;
        ...
        public static void Cast_FromDouble()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                double3 x = rng.NextDouble3(long.MinValue + 1e10d, long.MaxValue - 1e10d);
                long3 test = (long3)x;

...
{
    unsafe public static class t_short4
    {
        internal const int NUM_TESTS = 4;


        internal static short4[] TestData_LHS => new short4[]
        {
            new short4{x = -14693,
					   y = 554,
					   z = 9119,
            ...
            new short4{x = short.MinValue,
					   y = 16333,
					   z = -1011,
                       w = 6556}
        };

        internal static short4[] TestData_RHS => new short4[]
        {
            new short4{x = 120,
					   y = 4457,
					   z = -3888,
        ...
        {
            short4 x = new short4(TestData_LHS[0].x);
        ...
        public static void op_Addition()
        {
            ...
            {
                short4 x = TestData_LHS[i] + TestData_RHS[i];

                result &= x.x == (short)(TestData_LHS[i].x + TestData_RHS[i].x) &
                          x.y == (short)(TestData_LHS[i].y + TestData_RHS[i].y) &
                          x.z == (short)(TestData_LHS[i].z + TestData_RHS[i].z) &
                          x.w == (short)(TestData_LHS[i].w + TestData_RHS[i].w);
            }
        ...
        public static void ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                for (int j = 0; j < 16; j++)
                {
                    short4 x = TestData_LHS[i] << j;

                    result &= x.x == (short)(TestData_LHS[i].x << j) &
                              x.y == (short)(TestData_LHS[i].y << j) &
                              x.z == (short)(TestData_LHS[i].z << j) &
                              x.w == (short)(TestData_LHS[i].w << j);
                }
            }
        ...
        public static void Cast_ToV128()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                result &= x.SShort0 == TestData_LHS[i].x &
                          ...
                          x.SShort2 == TestData_LHS[i].z &
                          x.SShort3 == TestData_LHS[i].w;
            }

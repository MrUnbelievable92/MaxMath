...
{
    unsafe public static class t_ulong4
    {
        ...
        {
            ulong4 x = new ulong4(TestData_LHS[0].x);
        ...
        public static void op_Addition()
        {
            ...
            {
                ulong4 x = TestData_LHS[i] + TestData_RHS[i];
                ...
                result &= x.x == (ulong)(TestData_LHS[i].x + TestData_RHS[i].x) &
                          ...
                          x.w == (ulong)(TestData_LHS[i].w + TestData_RHS[i].w);
            }
        ...
        public static void op_Division()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ulong4 r = rng.NextULong4(1, ulong.MaxValue);
                ulong4 sanity = 0;
                for (int j = 0; j < 4; j++)
                {
                    sanity[j] = l[j] / r[j];
                ...
                Assert.AreEqual(l / r, sanity);

                l = rng.NextULong4(Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, ulong.MaxValue);
                r = rng.NextULong4(1, ulong.MaxValue);
                for (int j = 0; j < 4; j++)
                {
                    sanity[j] = l[j] / r[j];
                }
                ...
                l = rng.NextULong4(1, ulong.MaxValue);
                r = rng.NextULong4(Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, ulong.MaxValue);
                for (int j = 0; j < 4; j++)
                {
                    sanity[j] = l[j] / r[j];
                }
        ...
        public static void ShiftLeft()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                for (int j = 0; j < 64; j++)
                {
                    ulong4 x = TestData_LHS[i] << j;

                    result &= x.x == (ulong)(TestData_LHS[i].x << j) &
                              x.y == (ulong)(TestData_LHS[i].y << j) &
                              x.z == (ulong)(TestData_LHS[i].z << j) &
                              x.w == (ulong)(TestData_LHS[i].w << j);
                }
            }
        ...
        public static void ShuffleGetter()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                ulong4 xxxw = TestData_LHS[i].xxxw;
                ...
                ulong4 xxyw = TestData_LHS[i].xxyw;
                ...
                ulong4 xyxw = TestData_LHS[i].xyxw;
                ...
                ulong4 xyyw = TestData_LHS[i].xyyw;
                ...
                ulong4 xzxw = TestData_LHS[i].xzxw;
                ...
                ulong4 xzyw = TestData_LHS[i].xzyw;
                ...
                ulong4 yxxw = TestData_LHS[i].yxxw;
                ...
                ulong4 yxyw = TestData_LHS[i].yxyw;
                ...
                ulong4 yyxw = TestData_LHS[i].yyxw;
                ...
                ulong4 yyyw = TestData_LHS[i].yyyw;
                ...
                ulong4 yzxw = TestData_LHS[i].yzxw;
                ...
                ulong4 yzyw = TestData_LHS[i].yzyw;
                ...
                ulong4 zxxw = TestData_LHS[i].zxxw;
                ...
                ulong4 zxyw = TestData_LHS[i].zxyw;
                ...
                ulong4 zyxw = TestData_LHS[i].zyxw;
                ...
                ulong4 zyyw = TestData_LHS[i].zyyw;
                ...
                ulong4 zzxw = TestData_LHS[i].zzxw;
                ...
                ulong4 zzyw = TestData_LHS[i].zzyw;
        ...
        public static void Cast_FromFloat()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                float4 x = rng.NextFloat4(0f, ulong.MaxValue - 1e10f);
                ulong4 test = (ulong4)x;

                for (int j = 0; j < 4; j++)
                {
                    Assert.AreEqual(test[j], (ulong)x[j]);
                }
            }
        }
        ...
        public static void Cast_FromDouble()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                double4 x = rng.NextDouble4(0d, ulong.MaxValue - 1e10d);
                ulong4 test = (ulong4)x;

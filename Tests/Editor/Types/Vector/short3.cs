...
{
    unsafe public static class t_short3
    {
        internal const int NUM_TESTS = 4;


        internal static short3[] TestData_LHS => new short3[]
        {
            new short3{x =-14383,
					   y =5665,
                       z =9902},
            ...
            new short3{x =short.MinValue,
					   y =-357,
                       z =1940}
        };

        internal static short3[] TestData_RHS => new short3[]
        {
            new short3{x =120,
					   y =5204,
                       z =-5300},
        ...
        [Test]
        public static void Constructor___short___short_Short()
        {
            short3 x = new short3(TestData_LHS[0].x, TestData_LHS[0].y, TestData_LHS[0].z);
        ...
        [Test]
        public static void Constructor___short2_Short()
        {
            short3 x = new short3(new short2(TestData_LHS[0].x, TestData_LHS[0].y), TestData_LHS[0].z);
        ...
        [Test]
        public static void Constructor___short_Short2()
        {
        ...
        public static void op_Addition()
        {
            ...
            {
                short3 x = TestData_LHS[i] + TestData_RHS[i];

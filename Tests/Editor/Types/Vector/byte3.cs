...
{
    unsafe public static class t_byte3
    {
        ...
        public static void op_Division()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                byte3 divisor = maxmath.select(TestData_RHS[i], 1, TestData_RHS[i] == 0);

                byte3 x = TestData_LHS[i] / divisor;

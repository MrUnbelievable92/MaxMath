...
{
    unsafe public static class t_byte4
    {
        ...
        public static void op_Division()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual(x.x, (byte)(l.x / r.x));
                Assert.AreEqual(x.y, (byte)(l.y / r.y));
                Assert.AreEqual(x.z, (byte)(l.z / r.z));
                Assert.AreEqual(x.w, (byte)(l.w / r.w));
            }
        }

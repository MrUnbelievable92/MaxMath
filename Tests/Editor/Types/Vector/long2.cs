...
{
    unsafe public static class t_long2
    {
        ...
        [Test]
        public static void Constructor___long_Long()
        {
        ...
        public static void Cast_FromFloat()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                float2 x = rng.NextFloat2(long.MinValue + 1e10f, long.MaxValue - 1e10f);
                long2 test = (long2)x;
        ...
        public static void Cast_FromDouble()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                double2 x = rng.NextDouble2(long.MinValue + 1e10d, long.MaxValue - 1e10d);
                long2 test = (long2)x;

...
{
    unsafe public static class t_ushort4
    {
        ...
        {
            ushort4 x = new ushort4(TestData_LHS[0].x);
        ...
        public static void op_Addition()
        {
            ...
            {
                ushort4 x = TestData_LHS[i] + TestData_RHS[i];
                ...
                result &= x.x == (ushort)(TestData_LHS[i].x + TestData_RHS[i].x) &
                          ...
                          x.w == (ushort)(TestData_LHS[i].w + TestData_RHS[i].w);
            }
        ...
        public static void Cast_ToV128()
        {
            ...
            for (int i = 0; i < NUM_TESTS; i++)
            {
                ...
                result &= x.UShort0 == TestData_LHS[i].x &
                          ...
                          x.UShort2 == TestData_LHS[i].z &
                          x.UShort3 == TestData_LHS[i].w;
            }

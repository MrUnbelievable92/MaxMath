...
{
    unsafe public static class t_ushort4x4
    {
        ...
        public static void op_Increment()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ushort4x4 l = new ushort4x4(rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4());
                ushort4x4 test = l;
                test++;
        ...
        public static void op_Addition()
        {
            ...
            {
                ushort4x4 l = new ushort4x4(rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4());
                ushort4x4 r = new ushort4x4(rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4(), rng.NextUShort4());
        ...
        public static void op_ConvertFrom_float4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float4x4 x = new float4x4(rng.NextFloat4(0, 2f * ushort.MaxValue), rng.NextFloat4(0, 2f * ushort.MaxValue), rng.NextFloat4(0, 2f * ushort.MaxValue), rng.NextFloat4(0, 2f * ushort.MaxValue));
        ...
        public static void op_ConvertFrom_double4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double4x4 x = new double4x4(rng.NextDouble4(0, 2d* ushort.MaxValue), rng.NextDouble4(0, 2d* ushort.MaxValue), rng.NextDouble4(0, 2d* ushort.MaxValue), rng.NextDouble4(0, 2d* ushort.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ushort4x4 test = new ushort4x4(columns[0], columns[1], columns[2], columns[3]);

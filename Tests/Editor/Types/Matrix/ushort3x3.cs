...
{
    unsafe public static class t_ushort3x3
    {
        ...
        public static void op_Increment()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ushort3x3 l = new ushort3x3(rng.NextUShort3(), rng.NextUShort3(), rng.NextUShort3());
                ushort3x3 test = l;
                test++;
        ...
        public static void op_Addition()
        {
            ...
            {
                ushort3x3 l = new ushort3x3(rng.NextUShort3(), rng.NextUShort3(), rng.NextUShort3());
                ushort3x3 r = new ushort3x3(rng.NextUShort3(), rng.NextUShort3(), rng.NextUShort3());
        ...
        public static void op_ConvertFrom_float3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float3x3 x = new float3x3(rng.NextFloat3(0, 2f * ushort.MaxValue), rng.NextFloat3(0, 2f * ushort.MaxValue), rng.NextFloat3(0, 2f * ushort.MaxValue));
        ...
        public static void op_ConvertFrom_double3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double3x3 x = new double3x3(rng.NextDouble3(0, 2d* ushort.MaxValue), rng.NextDouble3(0, 2d* ushort.MaxValue), rng.NextDouble3(0, 2d* ushort.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ushort3x3 test = new ushort3x3(columns[0], columns[1], columns[2]);

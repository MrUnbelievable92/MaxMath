...
{
    unsafe public static class t_byte4x4
    {
        ...
        public static void op_Increment()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                byte4x4 l = new byte4x4(rng.NextByte4(), rng.NextByte4(), rng.NextByte4(), rng.NextByte4());
                byte4x4 test = l;
                test++;
        ...
        public static void op_Addition()
        {
            ...
            {
                byte4x4 l = new byte4x4(rng.NextByte4(), rng.NextByte4(), rng.NextByte4(), rng.NextByte4());
                byte4x4 r = new byte4x4(rng.NextByte4(), rng.NextByte4(), rng.NextByte4(), rng.NextByte4());
        ...
        [Test]
        public static void op_ConvertFrom_sbyte4x4()
        {
            Random8 rng = Random8.New;
        ...
        public static void op_ConvertFrom_float4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float4x4 x = new float4x4(rng.NextFloat4(0, 2f * byte.MaxValue), rng.NextFloat4(0, 2f * byte.MaxValue), rng.NextFloat4(0, 2f * byte.MaxValue), rng.NextFloat4(0, 2f * byte.MaxValue));
        ...
        public static void op_ConvertFrom_double4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double4x4 x = new double4x4(rng.NextDouble4(0, 2d* byte.MaxValue), rng.NextDouble4(0, 2d* byte.MaxValue), rng.NextDouble4(0, 2d* byte.MaxValue), rng.NextDouble4(0, 2d* byte.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                byte4x4 test = new byte4x4(columns[0], columns[1], columns[2], columns[3]);

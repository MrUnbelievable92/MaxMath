...
{
    unsafe public static class t_ushort2x2
    {
        ...
        public static void op_Increment()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ushort2x2 l = new ushort2x2(rng.NextUShort2(), rng.NextUShort2());
                ushort2x2 test = l;
                test++;
        ...
        public static void op_Addition()
        {
            ...
            {
                ushort2x2 l = new ushort2x2(rng.NextUShort2(), rng.NextUShort2());
                ushort2x2 r = new ushort2x2(rng.NextUShort2(), rng.NextUShort2());
        ...
        public static void op_ConvertFrom_float2x2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float2x2 x = new float2x2(rng.NextFloat2(0, 2f * ushort.MaxValue), rng.NextFloat2(0, 2f * ushort.MaxValue));
        ...
        public static void op_ConvertFrom_double2x2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double2x2 x = new double2x2(rng.NextDouble2(0, 2d* ushort.MaxValue), rng.NextDouble2(0, 2d* ushort.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ushort2x2 test = new ushort2x2(columns[0], columns[1]);

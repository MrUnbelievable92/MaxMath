...
{
    unsafe public static class t_sbyte3x3
    {
        ...
        public static void op_UnaryNegation()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                sbyte3x3 l = new sbyte3x3(rng.NextSByte3(), rng.NextSByte3(), rng.NextSByte3());
                sbyte3x3 test = -l;
        ...
        public static void op_Addition()
        {
            ...
            {
                sbyte3x3 l = new sbyte3x3(rng.NextSByte3(), rng.NextSByte3(), rng.NextSByte3());
                sbyte3x3 r = new sbyte3x3(rng.NextSByte3(), rng.NextSByte3(), rng.NextSByte3());
        ...
        [Test]
        public static void op_ConvertFrom_byte3x3()
        {
            Random8 rng = Random8.New;
        ...
        public static void op_ConvertFrom_float3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float3x3 x = new float3x3(rng.NextFloat3(2f * sbyte.MinValue, 2f * sbyte.MaxValue), rng.NextFloat3(2f * sbyte.MinValue, 2f * sbyte.MaxValue), rng.NextFloat3(2f * sbyte.MinValue, 2f * sbyte.MaxValue));
        ...
        public static void op_ConvertFrom_double3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double3x3 x = new double3x3(rng.NextDouble3(2d * sbyte.MinValue, 2d* sbyte.MaxValue), rng.NextDouble3(2d * sbyte.MinValue, 2d* sbyte.MaxValue), rng.NextDouble3(2d * sbyte.MinValue, 2d* sbyte.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                sbyte3x3 test = new sbyte3x3(columns[0], columns[1], columns[2]);

...
{
    unsafe public static class t_ulong3x3
    {
        ...
        public static void op_Increment()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ulong3x3 l = new ulong3x3(rng.NextULong3(), rng.NextULong3(), rng.NextULong3());
                ulong3x3 test = l;
                test++;
        ...
        public static void op_Addition()
        {
            ...
            {
                ulong3x3 l = new ulong3x3(rng.NextULong3(), rng.NextULong3(), rng.NextULong3());
                ulong3x3 r = new ulong3x3(rng.NextULong3(), rng.NextULong3(), rng.NextULong3());
        ...
        public static void op_ConvertFrom_float3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float3x3 x = new float3x3(rng.NextFloat3(0, 2f * ulong.MaxValue), rng.NextFloat3(0, 2f * ulong.MaxValue), rng.NextFloat3(0, 2f * ulong.MaxValue));
        ...
        public static void op_ConvertFrom_double3x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double3x3 x = new double3x3(rng.NextDouble3(0, Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble3(0, Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble3(0, Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                ulong3x3 test = new ulong3x3(columns[0], columns[1], columns[2]);

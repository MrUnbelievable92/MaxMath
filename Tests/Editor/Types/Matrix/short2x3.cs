...
{
    unsafe public static class t_short2x3
    {
        ...
        public static void op_UnaryNegation()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                short2x3 l = new short2x3(rng.NextShort2(), rng.NextShort2(), rng.NextShort2());
                short2x3 test = -l;
        ...
        public static void op_Addition()
        {
            ...
            {
                short2x3 l = new short2x3(rng.NextShort2(), rng.NextShort2(), rng.NextShort2());
                short2x3 r = new short2x3(rng.NextShort2(), rng.NextShort2(), rng.NextShort2());
        ...
        public static void op_ConvertFrom_float2x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float2x3 x = new float2x3(rng.NextFloat2(2f * short.MinValue, 2f * short.MaxValue), rng.NextFloat2(2f * short.MinValue, 2f * short.MaxValue), rng.NextFloat2(2f * short.MinValue, 2f * short.MaxValue));
        ...
        public static void op_ConvertFrom_double2x3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double2x3 x = new double2x3(rng.NextDouble2(2d * short.MinValue, 2d* short.MaxValue), rng.NextDouble2(2d * short.MinValue, 2d* short.MaxValue), rng.NextDouble2(2d * short.MinValue, 2d* short.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                short2x3 test = new short2x3(columns[0], columns[1], columns[2]);

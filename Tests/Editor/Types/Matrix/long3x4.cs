...
{
    unsafe public static class t_long3x4
    {
        ...
        public static void op_UnaryNegation()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                long3x4 l = new long3x4(rng.NextLong3(), rng.NextLong3(), rng.NextLong3(), rng.NextLong3());
                long3x4 test = -l;
        ...
        public static void op_Addition()
        {
            ...
            {
                long3x4 l = new long3x4(rng.NextLong3(), rng.NextLong3(), rng.NextLong3(), rng.NextLong3());
                long3x4 r = new long3x4(rng.NextLong3(), rng.NextLong3(), rng.NextLong3(), rng.NextLong3());
        ...
        public static void op_ConvertFrom_float3x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float3x4 x = new float3x4(rng.NextFloat3(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat3(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat3(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat3(2f * long.MinValue, 2f * long.MaxValue));
        ...
        public static void op_ConvertFrom_double3x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double3x4 x = new double3x4(rng.NextDouble3(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble3(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble3(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble3(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                long3x4 test = new long3x4(columns[0], columns[1], columns[2], columns[3]);

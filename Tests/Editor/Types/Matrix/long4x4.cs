...
{
    unsafe public static class t_long4x4
    {
        ...
        public static void op_UnaryNegation()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                long4x4 l = new long4x4(rng.NextLong4(), rng.NextLong4(), rng.NextLong4(), rng.NextLong4());
                long4x4 test = -l;
        ...
        public static void op_Addition()
        {
            ...
            {
                long4x4 l = new long4x4(rng.NextLong4(), rng.NextLong4(), rng.NextLong4(), rng.NextLong4());
                long4x4 r = new long4x4(rng.NextLong4(), rng.NextLong4(), rng.NextLong4(), rng.NextLong4());
        ...
        public static void op_Equality()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 0; j < COLUMNS; j++)
                {
                    Assert.AreEqual(test[j], (bool4)(l[j] == r[j]));
                }
            }
        }
        ...
        public static void op_ConvertFrom_float4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float4x4 x = new float4x4(rng.NextFloat4(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat4(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat4(2f * long.MinValue, 2f * long.MaxValue), rng.NextFloat4(2f * long.MinValue, 2f * long.MaxValue));
        ...
        public static void op_ConvertFrom_double4x4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double4x4 x = new double4x4(rng.NextDouble4(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble4(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble4(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1), rng.NextDouble4(-(long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG, (long)Helper.MAX_MONO_RUNTIME_CVT_DOUBLE_LONG + 1));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                long4x4 test = new long4x4(columns[0], columns[1], columns[2], columns[3]);

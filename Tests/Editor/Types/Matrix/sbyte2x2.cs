...
{
    unsafe public static class t_sbyte2x2
    {
        ...
        public static void op_UnaryNegation()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                sbyte2x2 l = new sbyte2x2(rng.NextSByte2(), rng.NextSByte2());
                sbyte2x2 test = -l;
        ...
        public static void op_Addition()
        {
            ...
            {
                sbyte2x2 l = new sbyte2x2(rng.NextSByte2(), rng.NextSByte2());
                sbyte2x2 r = new sbyte2x2(rng.NextSByte2(), rng.NextSByte2());
        ...
        [Test]
        public static void op_ConvertFrom_byte2x2()
        {
            Random8 rng = Random8.New;
        ...
        public static void op_ConvertFrom_float2x2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                float2x2 x = new float2x2(rng.NextFloat2(2f * sbyte.MinValue, 2f * sbyte.MaxValue), rng.NextFloat2(2f * sbyte.MinValue, 2f * sbyte.MaxValue));
        ...
        public static void op_ConvertFrom_double2x2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                double2x2 x = new double2x2(rng.NextDouble2(2d * sbyte.MinValue, 2d* sbyte.MaxValue), rng.NextDouble2(2d * sbyte.MinValue, 2d* sbyte.MaxValue));
        ...
        public static void get_Item_int()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                sbyte2x2 test = new sbyte2x2(columns[0], columns[1]);

...
namespace MaxMath.Tests
{
    ...
    unsafe public static class __quarter
    {
        ...
        private static bool IsDenormal(quarter value)
        {
        ...
        public static void ToDouble()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                double lead = IsDenormal(q) ? 0d : 1d;
        ...
        public static void ToByte()
        {
            ...
            {
                Assert.AreEqual((byte)i, (byte)(quarter)i);
            }
        }
        ...
        public static void ToSByte()
        {
            for (float i = -15f; i < 16f; i++)
            {
                Assert.AreEqual((sbyte)i, (sbyte)(quarter)i);
            }
        }
        ...
        {
            Assert.IsTrue(math.all((quarter2)quarter.NaN != (quarter2)quarter.NaN));
            Assert.IsTrue(math.all((quarter2)quarter.NaN != (quarter2)(quarter)1f));
        ...
        public static void ToHalf2()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                float2 lead = IsDenormal(q.x) ? 0f : 1f;
        ...
        public static void ToDouble2()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                double2 lead = IsDenormal(q.x) ? 0d : 1d;
        ...
        {
            Assert.IsTrue(math.all((quarter3)quarter.NaN != (quarter3)quarter.NaN));
            Assert.IsTrue(math.all((quarter3)quarter.NaN != (quarter3)(quarter)1f));
        ...
        public static void ToHalf3()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                float3 lead = IsDenormal(q.x) ? 0f : 1f;
        ...
        public static void ToDouble3()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                double3 lead = IsDenormal(q.x) ? 0d : 1d;
        ...
        {
            Assert.IsTrue(math.all((quarter4)quarter.NaN != (quarter4)quarter.NaN));
            Assert.IsTrue(math.all((quarter4)quarter.NaN != (quarter4)(quarter)1f));
        ...
        public static void ToHalf4()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                float4 lead = IsDenormal(q.x) ? 0f : 1f;
        ...
        public static void ToDouble4()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                double4 lead = IsDenormal(q.x) ? 0d : 1d;
        ...
        {
            Assert.IsTrue(maxmath.all((quarter8)quarter.NaN != (quarter8)quarter.NaN));
            Assert.IsTrue(maxmath.all((quarter8)quarter.NaN != (quarter8)(quarter)1f));
        ...
        public static void ToHalf8()
        {
            for (int i = 0; i < 256; i++)
            {
                ...
                float8 lead = IsDenormal(q.x0) ? 0f : 1f;

...
{
    unsafe public static class f_bits_setlowest
    {
        private static void TestByte(byte original, byte testValue)
        {
            Assert.AreEqual(testValue, (byte)(original | bits_extractlowest0(original)));
        }

        private static void TestUShort(ushort original, ushort testValue)
        {
            Assert.AreEqual(testValue, (ushort)(original | bits_extractlowest0(original)));
        }

        private static void TestUInt(uint original, uint testValue)
        {
            Assert.AreEqual(testValue, original | bits_extractlowest0(original));
        }
        ...
        public static void _UInt128()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                TestUInt128(test, bits_setlowest(test));
            }
        }
        ...
        public static void _byte()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                TestByte(test, bits_setlowest(test));
            }
        }
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte2 result = bits_setlowest(test);
        ...
        public static void _byte3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte3 result = bits_setlowest(test);
        ...
        public static void _byte4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte4 result = bits_setlowest(test);
        ...
        public static void _byte8()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte8 result = bits_setlowest(test);
        ...
        public static void _byte16()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte16 result = bits_setlowest(test);
        ...
        public static void _byte32()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                byte32 result = bits_setlowest(test);
        ...
        public static void _ushort()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                TestUShort(test, bits_setlowest(test));
            }
        }
        ...
        public static void _ushort2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ushort2 result = bits_setlowest(test);
        ...
        public static void _ushort3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ushort3 result = bits_setlowest(test);
        ...
        public static void _ushort4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ushort4 result = bits_setlowest(test);
        ...
        public static void _ushort8()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ushort8 result = bits_setlowest(test);
        ...
        public static void _ushort16()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ushort16 result = bits_setlowest(test);
        ...
        public static void _uint()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                TestUInt(test, bits_setlowest(test));
            }
        }
        ...
        public static void _uint2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                uint2 result = bits_setlowest(test);
        ...
        public static void _uint3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                uint3 result = bits_setlowest(test);
        ...
        public static void _uint4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                uint4 result = bits_setlowest(test);
        ...
        public static void _uint8()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                uint8 result = bits_setlowest(test);
        ...
        public static void _ulong()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                TestULong(test, bits_setlowest(test));
            }
        }
        ...
        public static void _ulong2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ulong2 result = bits_setlowest(test);
        ...
        public static void _ulong3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ulong3 result = bits_setlowest(test);
        ...
        public static void _ulong4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                ulong4 result = bits_setlowest(test);

    ...
    unsafe public static class f_parityodd
    {
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool2)parityodd(test), (bool2)((countbits(test) & 1) == 1));
            }
        }
        ...
        public static void _byte3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool3)parityodd(test), (bool3)((countbits(test) & 1) == 1));
            }
        }
        ...
        public static void _byte4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool4)parityodd(test), (bool4)((countbits(test) & 1) == 1));
            }
        }
        ...
        public static void _byte8()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool8)parityodd(test), (bool8)((countbits(test) & 1) == 1));
            }
        }
        ...
        public static void _byte16()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool16)parityodd(test), (bool16)((countbits(test) & 1) == 1));
            }
        }
        ...
        public static void _byte32()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool32)parityodd(test), (bool32)((countbits(test) & 1) == 1));
            }
        }
    ...
    unsafe public static class f_parityeven
    {
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool2)parityeven(test), (bool2)((countbits(test) & 1) == 0));
            }
        }
        ...
        public static void _byte3()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool3)parityeven(test), (bool3)((countbits(test) & 1) == 0));
            }
        }
        ...
        public static void _byte4()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool4)parityeven(test), (bool4)((countbits(test) & 1) == 0));
            }
        }
        ...
        public static void _byte8()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool8)parityeven(test), (bool8)((countbits(test) & 1) == 0));
            }
        }
        ...
        public static void _byte16()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool16)parityeven(test), (bool16)((countbits(test) & 1) == 0));
            }
        }
        ...
        public static void _byte32()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual((bool32)parityeven(test), (bool32)((countbits(test) & 1) == 0));
            }
        }

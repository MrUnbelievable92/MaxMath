    ...
    unsafe public static class f_testbitflip
    {
        ...
        public static void _UInt128()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                for (int j = 0; j < 128; j++)
                {
                    Assert.AreEqual(btc(ref val, j), math.testbit(cpy, (uint)j));
                    Assert.AreNotEqual(math.testbit(val, (uint)j), math.testbit(cpy, (uint)j));
                }
            }
        }
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                for (int k = 0; k < 2; k++)
                {
                    ...
                    val[k] = b;
                    Assert.AreNotEqual(math.testbit(val, idx)[k], res[k]);
                }
            }
        }
        ...
        public static void _ulong()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                for (int j = 0; j < 64; j++)
                {
                    Assert.AreEqual(btc(ref val, j), math.testbit(cpy, j));
                    Assert.AreNotEqual(math.testbit(val, j), math.testbit(cpy, j));
                }
            }
        }

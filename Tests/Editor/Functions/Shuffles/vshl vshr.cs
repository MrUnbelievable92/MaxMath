        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 2; j++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 2) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 3; j++)
                {
                    ...
                    for (int k = 0; k < 3; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 3) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 4; j++)
                {
                    ...
                    for (int k = 0; k < 4; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 4) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte8()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 8; j++)
                {
                    ...
                    for (int k = 0; k < 8; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 8) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte16()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 16; j++)
                {
                    ...
                    for (int k = 0; k < 16; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 16) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte32()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 32; j++)
                {
                    ...
                    for (int k = 0; k < 32; k++)
                    {
                        Assert.IsTrue(shr[k] == ((j + k >= 32) ? 0 : test[j + k]));
                    }
                }
            }
        }
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 1; j < 2; j++)
                {
                    ...
                    for (int k = 0; k < 2; k++)
                    {
                        Assert.IsTrue(shl[k] == ((k - j < 0) ? 0 : test[k - j]));
                    }
                }
            }
        }

...
namespace MaxMath.Tests
{
    ...
    unsafe public static class f_roundtoushort
    {
        ...
        public static void _half()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                half h = (half)rng.NextFloat(ushort.MinValue, ushort.MaxValue + 1);
        ...
        public static void _half2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                half2 h = (half2)rng.NextFloat2((float)ushort.MinValue, ushort.MaxValue + 1);
        ...
        public static void _half3()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                half3 h = (half3)rng.NextFloat3((float)ushort.MinValue, ushort.MaxValue + 1);
        ...
        public static void _half4()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                half4 h = (half4)rng.NextFloat4((float)ushort.MinValue, ushort.MaxValue + 1);
        ...
        public static void _half8()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                half8 h = (half8)rng.NextFloat8(ushort.MinValue, ushort.MaxValue + 1);

...
namespace MaxMath.Tests
{
    public static class f_PROMISE_nextgreater
    {
        ...
        {
            Assert.AreEqual(maxmath.nextgreater((quarter16)(1.747f)),  maxmath.nextgreater((quarter16)(1.747f), Promise.NonZero));
            Assert.AreEqual(maxmath.nextgreater((quarter16)(1.747f)),  maxmath.nextgreater((quarter16)(1.747f), Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter16)(1.747f)),  maxmath.nextgreater((quarter16)(1.747f), Promise.Positive));
            Assert.AreEqual(maxmath.nextgreater((quarter16)(-1.747f)), maxmath.nextgreater((quarter16)(-1.747f), Promise.Negative));

            Assert.AreEqual(maxmath.nextgreater((quarter16)(1.747f)),  maxmath.nextgreater((quarter16)(1.747f), Promise.NonZero | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter16)(1.747f)),  maxmath.nextgreater((quarter16)(1.747f), Promise.Positive | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter16)(-1.747f)), maxmath.nextgreater((quarter16)(-1.747f), Promise.Negative | Promise.Unsafe0));
        }

        [Test]
        public static void _quarter32()
        {
            Assert.AreEqual(maxmath.nextgreater((quarter32)(1.747f)),  maxmath.nextgreater((quarter32)(1.747f), Promise.NonZero));
            Assert.AreEqual(maxmath.nextgreater((quarter32)(1.747f)),  maxmath.nextgreater((quarter32)(1.747f), Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter32)(1.747f)),  maxmath.nextgreater((quarter32)(1.747f), Promise.Positive));
            Assert.AreEqual(maxmath.nextgreater((quarter32)(-1.747f)), maxmath.nextgreater((quarter32)(-1.747f), Promise.Negative));

            Assert.AreEqual(maxmath.nextgreater((quarter32)(1.747f)),  maxmath.nextgreater((quarter32)(1.747f), Promise.NonZero | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter32)(1.747f)),  maxmath.nextgreater((quarter32)(1.747f), Promise.Positive | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((quarter32)(-1.747f)), maxmath.nextgreater((quarter32)(-1.747f), Promise.Negative | Promise.Unsafe0));
        }
        ...
        {
            Assert.AreEqual(maxmath.nextgreater((half16)(1747f)),  maxmath.nextgreater((half16)(1747f), Promise.NonZero));
            Assert.AreEqual(maxmath.nextgreater((half16)(1747f)),  maxmath.nextgreater((half16)(1747f), Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((half16)(1747f)),  maxmath.nextgreater((half16)(1747f), Promise.Positive));
            Assert.AreEqual(maxmath.nextgreater((half16)(-1747f)), maxmath.nextgreater((half16)(-1747f), Promise.Negative));

            Assert.AreEqual(maxmath.nextgreater((half16)(1747f)),  maxmath.nextgreater((half16)(1747f), Promise.NonZero | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((half16)(1747f)),  maxmath.nextgreater((half16)(1747f), Promise.Positive | Promise.Unsafe0));
            Assert.AreEqual(maxmath.nextgreater((half16)(-1747f)), maxmath.nextgreater((half16)(-1747f), Promise.Negative | Promise.Unsafe0));
        }

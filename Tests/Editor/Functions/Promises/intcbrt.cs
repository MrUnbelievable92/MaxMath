    ...
    public static class f_PROMISE_intcbrt
    {
        ...
        public static void _sbyte()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.ZeroOrGreater));
            }
        }
        ...
        public static void _short()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.Unsafe0));

                b = rng.NextShort(0, byte.MaxValue + 1);
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.ZeroOrGreater | Promise.Unsafe0));
            }
        }
        ...
        public static void _int()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.Unsafe1));

                b = rng.NextInt(0, byte.MaxValue + 1);
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.ZeroOrGreater | Promise.Unsafe1));
            }
        }
        ...
        public static void _long()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.Unsafe2));

                b = rng.NextLong(0, byte.MaxValue + 1);
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.ZeroOrGreater | Promise.Unsafe2));
            }
        }
        ...
        public static void _long2()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.Unsafe3));

                b = rng.NextLong2(0, byte.MaxValue + 1);
                Assert.AreEqual(math.intcbrt(b), math.intcbrt(b, Promise.ZeroOrGreater | Promise.Unsafe3));
            }
        }

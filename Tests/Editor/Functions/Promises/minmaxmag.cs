...
{
    public static class PROMISE_minmaxmag
    {
        [Test]
        public static void _int2()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out int2 minusf, out int2 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _int3()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out int3 minusf, out int3 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _int4()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out int4 minusf, out int4 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _int8()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out int8 minusf, out int8 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _long2()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out long2 minusf, out long2 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _long3()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out long3 minusf, out long3 maxusf, maxmath.Promise.NoOverflow);
        ...
        public static void _long4()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                maxmath.minmaxmag(l, r, out long4 minusf, out long4 maxusf, maxmath.Promise.NoOverflow);

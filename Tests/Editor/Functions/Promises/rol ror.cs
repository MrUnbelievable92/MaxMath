    ...
    public static class f_PROMISE_rotatevarying
    {
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                Assert.AreEqual(math.rol(random, shift), math.rol(random, shift, Promise.NoOverflow));
                Assert.AreEqual(math.ror(random, shift), math.ror(random, shift, Promise.NoOverflow));
            }
        }

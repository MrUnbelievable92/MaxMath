...
{
    public static class f_PROMISE_ceilmultiple
    {
        [Test]
        public static void _byte()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                if (maxmath.addsaturated(x, (byte)(n - 1)) == (byte)(x + (byte)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        }
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (byte)(n[j] - 1)) == (byte)(x[j] + (byte)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
            }
        }
        ...
        public static void _sbyte()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                if (maxmath.addsaturated(x, (sbyte)(n - 1)) == (sbyte)(x + (sbyte)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.ZeroOrGreater));
            }
        }
        ...
        public static void _sbyte2()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (sbyte)(n[j] - 1)) == (sbyte)(x[j] + (byte)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.ZeroOrGreater)[j]);
                }
            }
        }
        ...
        public static void _ushort()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                if (maxmath.addsaturated(x, (ushort)(n - 1)) == (ushort)(x + (ushort)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _ushort2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (ushort)(n[j] - 1)) == (ushort)(x[j] + (ushort)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _short()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                if (maxmath.addsaturated(x, (short)(n - 1)) == (short)(x + (short)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _short2()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (short)(n[j] - 1)) == (short)(x[j] + (short)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _uint()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                if (maxmath.addsaturated(x, (uint)(n - 1)) == (uint)(x + (uint)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _uint2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (uint)(n[j] - 1)) == (uint)(x[j] + (uint)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _int()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                if (maxmath.addsaturated(x, (int)(n - 1)) == (int)(x + (int)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _int2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (int)(n[j] - 1)) == (int)(x[j] + (uint)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _ulong()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                if (maxmath.addsaturated(x, (ulong)(n - 1)) == (ulong)(x + (ulong)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _ulong2()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (ulong)(n[j] - 1)) == (ulong)(x[j] + (ulong)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _long()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                if (maxmath.addsaturated(x, (long)(n - 1)) == (long)(x + (long)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _long2()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    if (maxmath.addsaturated(x[j], (long)(n[j] - 1)) == (long)(x[j] + (long)(n[j] - 1)))
                    {
                        Assert.AreEqual(maxmath.ceilmultiple(x, n)[j], maxmath.ceilmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
        ...
        public static void _UInt128()
        {
            ...
            for (int i = 0; i < 128; i++)
            {
                ...
                if (maxmath.addsaturated(x, (UInt128)(n - 1)) == (UInt128)(x + (UInt128)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }
        ...
        public static void _Int128()
        {
            ...
            for (int i = 0; i < 128; i++)
            {
                ...
                if (maxmath.addsaturated(x, (Int128)(n - 1)) == (Int128)(x + (Int128)(n - 1)))
                {
                    Assert.AreEqual(maxmath.ceilmultiple(x, n), maxmath.ceilmultiple(x, n, Promise.Unsafe0));
                }
            }

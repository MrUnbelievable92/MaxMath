    ...
    public static class f_PROMISE_truncmultiple
    {
        ...
        public static void _byte()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                {
                    Assert.AreEqual(math.truncmultiple(x, n), math.truncmultiple(x, n, Promise.Unsafe0));
                }
            }
        }
        ...
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    {
                        Assert.AreEqual(math.truncmultiple(x, n)[j], math.truncmultiple(x, n, Promise.Unsafe0)[j]);
                    }
                }
            }
        }
        ...
        public static void _sbyte()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                {
                    Assert.AreEqual(math.truncmultiple(x, n), math.truncmultiple(x, n, Promise.ZeroOrGreater));
                }
            }
        }
        ...
        public static void _sbyte2()
        {
            ...
            for (int i = 0; i < 32; i++)
            {
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    {
                        Assert.AreEqual(math.truncmultiple(x, n)[j], math.truncmultiple(x, n, Promise.ZeroOrGreater)[j]);
                    }
                }
            }
        }

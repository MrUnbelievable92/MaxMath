    ...
    public static class f_PROMISE_floor
    {
        ...
        public static void _quarter()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter std = maxmath.floor(q);
                quarter usf = maxmath.floor(q, p);
        ...
        public static void _quarter2()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter2 std = maxmath.floor(q);
                quarter2 usf = maxmath.floor(q, p);
        ...
        public static void _quarter3()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter3 std = maxmath.floor(q);
                quarter3 usf = maxmath.floor(q, p);
        ...
        public static void _quarter4()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter4 std = maxmath.floor(q);
                quarter4 usf = maxmath.floor(q, p);
        ...
        public static void _quarter8()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter8 std = maxmath.floor(q);
                quarter8 usf = maxmath.floor(q, p);
        ...
        public static void _quarter16()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter16 std = maxmath.floor(q);
                quarter16 usf = maxmath.floor(q, p);
        ...
        public static void _quarter32()
        {
            for (int i = 0; i < byte.MaxValue + 1; i++)
            {
                ...
                quarter32 std = maxmath.floor(q);
                quarter32 usf = maxmath.floor(q, p);
        ...
        public static void _half()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half std = maxmath.floor(q);
                half usf = maxmath.floor(q, p);
        ...
        public static void _half2()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half2 std = maxmath.floor(q);
                half2 usf = maxmath.floor(q, p);
        ...
        public static void _half3()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half3 std = maxmath.floor(q);
                half3 usf = maxmath.floor(q, p);
        ...
        public static void _half4()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half4 std = maxmath.floor(q);
                half4 usf = maxmath.floor(q, p);
        ...
        public static void _half8()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half8 std = maxmath.floor(q);
                half8 usf = maxmath.floor(q, p);
        ...
        public static void _half16()
        {
            for (int i = 0; i < ushort.MaxValue + 1; i++)
            {
                ...
                half16 std = maxmath.floor(q);
                half16 usf = maxmath.floor(q, p);

...
{
    unsafe public static class f_cminmag
    {
        [Test]
        public static void _sbyte2()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Assert.AreEqual(maxmath.cminmag(l), maxmath.minmag(maxmath.cmin(l), maxmath.cmax(l)));
            }
        }
        ...
        public static void _int2()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                Assert.AreEqual(maxmath.cminmag(l), maxmath.minmag(math.cmin(l), math.cmax(l)));
            }
        }

    ...
    public static class f_isnan
    {
        ...
        public static void _quarter()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool)isnan(q), (bool)isnan((float)q));
            }
        }
        ...
        public static void _quarter2()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool2)isnan(q), (bool2)isnan((float2)q));
            }
        }
        ...
        public static void _quarter3()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool3)isnan(q), (bool3)isnan((float3)q));
            }
        }
        ...
        public static void _quarter4()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool4)isnan(q), (bool4)isnan((float4)q));
            }
        }
        ...
        public static void _quarter8()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool8)isnan(q), (bool8)isnan((float8)q));
            }
        }
        ...
        public static void _quarter16()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool8)isnan(q).v8_0, (bool8)isnan((float8)q.v8_0));
                Assert.AreEqual((bool8)isnan(q).v8_8, (bool8)isnan((float8)q.v8_8));
            }
        }
        ...
        public static void _quarter32()
        {
            ...
            for (int i = 0; i < 64; i++)
            {
                ...
                Assert.AreEqual((bool8)isnan(q).v8_0, (bool8)isnan((float8)q.v8_0));
                Assert.AreEqual((bool8)isnan(q).v8_8, (bool8)isnan((float8)q.v8_8));
                Assert.AreEqual((bool8)isnan(q).v8_16, (bool8)isnan((float8)q.v8_16));
                Assert.AreEqual((bool8)isnan(q).v8_24, (bool8)isnan((float8)q.v8_24));
            }
        }

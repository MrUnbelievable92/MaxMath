    ...
    unsafe public static class SaturatedSum
    {
        ...
        public static void byte2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte2 sum = maxmath.addsaturated(left, right);
        ...
        public static void byte3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte3 sum = maxmath.addsaturated(left, right);
        ...
        public static void byte4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte4 sum = maxmath.addsaturated(left, right);
        ...
        public static void byte8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte8 sum = maxmath.addsaturated(left, right);
        ...
        public static void byte16()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte16 sum = maxmath.addsaturated(left, right);
        ...
        public static void byte32()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte32 sum = maxmath.addsaturated(left, right);
        ...
        public static void ushort2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort2 sum = maxmath.addsaturated(left, right);
        ...
        public static void ushort3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort3 sum = maxmath.addsaturated(left, right);
        ...
        public static void ushort4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort4 sum = maxmath.addsaturated(left, right);
        ...
        public static void ushort8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort8 sum = maxmath.addsaturated(left, right);
        ...
        public static void ushort16()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort16 sum = maxmath.addsaturated(left, right);
        ...
        public static void uint2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                uint2 sum = maxmath.addsaturated(left, right);
        ...
        public static void uint3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                uint3 sum = maxmath.addsaturated(left, right);
        ...
        public static void uint4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                uint4 sum = maxmath.addsaturated(left, right);
        ...
        public static void uint8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                uint8 sum = maxmath.addsaturated(left, right);
        ...
        public static void ulong2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ulong2 sum = maxmath.addsaturated(left, right);
        ...
        public static void ulong3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ulong3 sum = maxmath.addsaturated(left, right);
        ...
        public static void ulong4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ulong4 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte2 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte3 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte4 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte8 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte16()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte16 sum = maxmath.addsaturated(left, right);
        ...
        public static void sbyte32()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte32 sum = maxmath.addsaturated(left, right);
        ...
        public static void short2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short2 sum = maxmath.addsaturated(left, right);
        ...
        public static void short3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short3 sum = maxmath.addsaturated(left, right);
        ...
        public static void short4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short4 sum = maxmath.addsaturated(left, right);
        ...
        public static void short8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short8 sum = maxmath.addsaturated(left, right);
        ...
        public static void short16()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short16 sum = maxmath.addsaturated(left, right);
        ...
        public static void int2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                int2 sum = maxmath.addsaturated(left, right);
        ...
        public static void int3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                int3 sum = maxmath.addsaturated(left, right);
        ...
        public static void int4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                int4 sum = maxmath.addsaturated(left, right);
        ...
        public static void int8()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                int8 sum = maxmath.addsaturated(left, right);
        ...
        public static void long2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                long2 sum = maxmath.addsaturated(left, right);
        ...
        public static void long3()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                long3 sum = maxmath.addsaturated(left, right);
        ...
        public static void long4()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                long4 sum = maxmath.addsaturated(left, right);

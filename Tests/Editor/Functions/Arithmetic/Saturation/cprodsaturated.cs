...
{
    unsafe public static class f_cprodsaturated
    {
        [Test]
        public static void _byte2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                byte product = math.cprodsaturated(vec);
                byte stdProduct = 1;

                for (int j = 0; j < 2; j++)
                {
                    stdProduct = math.mulsaturated(stdProduct, vec[j]);
                }
        ...
        public static void _ushort2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ushort product = math.cprodsaturated(vec);
                ushort stdProduct = 1;
        ...
        public static void _uint2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                uint product = math.cprodsaturated(vec);
                uint stdProduct = 1;
        ...
        public static void _ulong2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                ulong product = math.cprodsaturated(vec);
                ulong stdProduct = 1;
        ...
        public static void _sbyte2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                sbyte product = math.cprodsaturated(vec);
        ...
        public static void _short2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                short product = math.cprodsaturated(vec);
                BigInteger stdProduct = 1;
        ...
        public static void _int2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                int product = math.cprodsaturated(vec);
                BigInteger stdProduct = 1;
        ...
        public static void _long2()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                long product = math.cprodsaturated(vec);
                BigInteger stdProduct = 1;

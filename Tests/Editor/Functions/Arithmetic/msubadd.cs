...
namespace MaxMath.Tests
{
    public static class f_msubadd
    {
        ...
        public static void _ushort16()
        {
            ...
            ushort16 op = math.msubadd(a, b, c);

...
{
    unsafe public static class rem_byte
    {
        [UnitTest("Functions", "Arithmetic", "Rem")]
        public static bool Byte16_10()
        {
            bool result = true;

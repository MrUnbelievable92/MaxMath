...
namespace MaxMath
{
    unsafe internal static partial class Operator
    {
        ...
        //public static bool test_unsigned()
        //{
        //    bool result = true;
        //
        ...
        //}
        //
        //public static bool test_signed()
        //{
        //    bool result = true;
        //
...
Assert.AreNotEqual(divisor.x7, 0u);
            ...
            float8 divisor_f32_rcp = maxmath.rcp(divisor_f32);
...
Assert.AreNotEqual(divisor.x7, 0);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_byte_quotient(uint4 dividend, uint4 divisor)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_byte_quotient(uint3 dividend, uint3 divisor)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_byte_quotient(uint2 dividend, uint2 divisor)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_sbyte_quotient(int4 dividend, int4 divisor)
        {
            float4 dividend_f32 = dividend;
            float4 divisor_f32 = divisor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_sbyte_quotient(int3 dividend, int3 divisor)
        {
            float3 dividend_f32 = dividend;
            float3 divisor_f32 = divisor;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 vdiv_sbyte_quotient(int2 dividend, int2 divisor)
        {
            float2 dividend_f32 = dividend;
            float2 divisor_f32 = divisor;
...
Assert.AreNotEqual(divisor.w, 0);
        ...
        public static short16 vdiv_short(short16 dividend, short16 divisor)
        {
            ...
            return Avx2.mm256_permute4x64_epi64(Avx2.mm256_packs_epi32((int8)lo,
                                                                       (int8)hi),
                                                Sse.SHUFFLE(3, 1, 2, 0));
        }
        ...
        public static ushort16 vdiv_ushort(ushort16 dividend, ushort16 divisor)
        {
            ...
            return Avx2.mm256_permute4x64_epi64(Avx2.mm256_packus_epi32((uint8)lo,
                                                                        (uint8)hi),
                                                Sse.SHUFFLE(3, 1, 2, 0));
        }

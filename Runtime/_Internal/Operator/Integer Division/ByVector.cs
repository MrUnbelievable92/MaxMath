...
namespace MaxMath
{
    ...
    // this division algorithm is about FIVE times faster than - (byte16 case), EIGHT times faster than - (byte32 case) or TWICE as fast (ushort16 case)
    // as scalar division of bytes/ushorts when compiled natively without Divide-By-Zero checks (release mode).
...
Assert.AreNotEqual(divisor.x15, 0);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ushort16 vdivrem_ushort(ushort16 dividend, ushort16 divisor, out ushort16 remainder)
        {
Assert.AreNotEqual(divisor.x0,  0);
Assert.AreNotEqual(divisor.x1,  0);
Assert.AreNotEqual(divisor.x2,  0);
...
Assert.AreNotEqual(divisor.x15, 0);
            ...
            ushort16 quotients = default(ushort16);
            remainder = default(ushort16);


            remainder |= (new ushort16(1) & (dividend >> 15));

            v256 subtractDivisorFromRemainder = Avx2.mm256_andnot_si256(Operator.greater_mask_ushort(divisor, remainder), new v256(-1));

            remainder -= Avx2.mm256_blendv_epi8(default(v256), divisor, subtractDivisorFromRemainder);
            quotients |= new ushort16(1) & subtractDivisorFromRemainder;

            divrem_LOOPHEAD_ushort(14, ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(13, ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(12, ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(11, ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(10, ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(9,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(8,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(7,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(6,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(5,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(4,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(3,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(2,  ref quotients, ref remainder, in divisor, in dividend);
            divrem_LOOPHEAD_ushort(1,  ref quotients, ref remainder, in divisor, in dividend);

            remainder <<= 1;
            quotients <<= 1;

            remainder |= new ushort16(1) & dividend;

            subtractDivisorFromRemainder = Avx2.mm256_andnot_si256(Operator.greater_mask_ushort(divisor, remainder), new v256(-1));
...
Assert.AreNotEqual(divisor.x15, 0);
            ...
            ushort16 quotients = default(ushort16);
            ushort16 remainder = default(ushort16);
...
Assert.AreNotEqual(divisor.x15, 0);
            ...
            rem_LOOPHEAD_ushort(14, ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(13, ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(12, ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(11, ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(10, ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(9,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(8,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(7,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(6,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(5,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(4,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(3,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(2,  ref remainder, in divisor, in dividend);
            rem_LOOPHEAD_ushort(1,  ref remainder, in divisor, in dividend);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static short16 vdivrem_short(short16 dividend, short16 divisor, out short16 remainder)
        {
            ushort16 quotient = vdivrem_ushort((ushort16)maxmath.abs(dividend), (ushort16)maxmath.abs(divisor), out ushort16 remainders);

            ushort16 mustNegate = Avx2.mm256_cmpgt_epi16(default(short16), dividend);

            remainder = Avx2.mm256_blendv_epi8(remainders, -((short16)remainders), mustNegate);

            mustNegate = Avx2.mm256_xor_si256(Avx2.mm256_cmpgt_epi16(default(short16), divisor),
                                              Avx2.mm256_cmpgt_epi16(default(short16), dividend));

            return Avx2.mm256_blendv_epi8(quotient, -((short16)quotient), mustNegate);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static short16 vdiv_short(short16 dividend, short16 divisor)
        {
            ushort16 quotient = vdiv_ushort((ushort16)maxmath.abs(dividend), (ushort16)maxmath.abs(divisor));

            ushort16 mustNegate = Avx2.mm256_xor_si256(Avx2.mm256_cmpgt_epi16(default(short16), divisor),
                                                       Avx2.mm256_cmpgt_epi16(default(short16), dividend));
        ...
        {
            ushort16 remainder = vrem_ushort((ushort16)maxmath.abs(dividend), (ushort16)maxmath.abs(divisor));

            ushort16 mustNegate = Avx2.mm256_cmpgt_epi16(default(short16), dividend);

            return Avx2.mm256_blendv_epi8(remainder, -((short16)remainder), mustNegate);
        }


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void divrem_LOOPHEAD_ushort(int i, ref ushort16 quotients, ref ushort16 remainders, in ushort16 divisorCast, in ushort16 dividendCast)
        {
            quotients <<= 1;
            remainders <<= 1;
            ...
            v256 subtractDivisorFromRemainder = Avx2.mm256_andnot_si256(Operator.greater_mask_ushort(divisorCast, remainders), new v256(-1));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void rem_LOOPHEAD_ushort(int i, ref ushort16 remainders, in ushort16 divisorCast, in ushort16 dividendCast)
        {
            remainders <<= 1;

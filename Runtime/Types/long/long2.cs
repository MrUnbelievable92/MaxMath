...
namespace MaxMath
{
    ...
    unsafe public struct long2 : IEquatable<long2>, IFormattable
    {
        ...
        public long2 yx { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Sse2.shuffle_epi32(this, Sse.SHUFFLE(1, 0, 3, 2)); [MethodImpl(MethodImplOptions.AggressiveInlining)] set => this = value.yx; }

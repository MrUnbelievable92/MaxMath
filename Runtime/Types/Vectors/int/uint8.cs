    ...
    unsafe public struct uint8 : IEquatable<uint8>, IFormattable
    {
        ...
        public uint8(uint2 x01, uint3 x234, uint3 x567)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                hi = Mask.BlendEpi16(mid, hi, 0b1111_1100);
        ...
        public uint8(uint3 x012, uint2 x34, uint3 x567)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 lo = Mask.BlendEpi16(*(v128*)&x012, mid, 0b1100_0000);
...
Assert.IsWithinArrayBounds(index, 8);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly bool Equals(object obj) => Equals((uint8)obj);

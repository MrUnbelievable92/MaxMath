    ...
    unsafe public struct sbyte8 : IEquatable<sbyte8>, IFormattable
    {
        ...
        public sbyte4 v4_1
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 1 * sizeof(sbyte)), new byte8(0, 255, 255, 255, 255, 0, 0, 0));
                }
                else
                {
                    this.x1 = value.x;
        ...
        public sbyte4 v4_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    if (Sse4_1.IsSse41Supported)
                    {
                        this = Sse4_1.blend_epi16(this, Sse2.bslli_si128(value, 2 * sizeof(sbyte)), 0b0110);
                    }
                    else
                    {
                        this = Mask.BlendEpi16_SSE2(this, Sse2.bslli_si128(value, 2 * sizeof(sbyte)), 0b0110);
                    }
                }
                else
                {
        ...
        public sbyte4 v4_3
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 3 * sizeof(sbyte)), new byte8(0, 0, 0, 255, 255, 255, 255, 0));
                }
                else
                {
                    this.x3 = value.x;
        ...
        public sbyte3 v3_1
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 1 * sizeof(sbyte)), new byte8(0, 255, 255, 255, 0, 0, 0, 0));
                }
                else
                {
                    this.x1 = value.x;
        ...
        public sbyte3 v3_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 2 * sizeof(sbyte)), new byte8(0, 0, 255, 255, 255, 0, 0, 0));
                }
                else
                {
                    this.x2 = value.x;
        ...
        public sbyte3 v3_3
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 3 * sizeof(sbyte)), new byte8(0, 0, 0, 255, 255, 255, 0, 0));
                }
                else
                {
                    this.x3 = value.x;
        ...
        public sbyte3 v3_4
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 4 * sizeof(sbyte)), new byte8(0, 0, 0, 0, 255, 255, 255, 0));
                }
                else
                {
                    this.x4 = value.x;
        ...
        public sbyte3 v3_5
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendV(this, Sse2.bslli_si128(value, 5 * sizeof(sbyte)), new byte8(0, 0, 0, 0, 0, 255, 255, 255));
                }
                else
                {
                    this.x5 = value.x;
...
Assert.IsWithinArrayBounds(index, 8);
        ...
        public static sbyte8 operator / (sbyte8 left, sbyte8 right)
        {
            if (Constant.IsConstantExpression(right))
            {
                ...
                {
                    return Operator.Constant.vdiv_sbyte(left, right.x0, 8);
                }
            }
        ...
        public static sbyte8 operator / (sbyte8 left, sbyte right)
        {
            if (Constant.IsConstantExpression(right))
            {
                return Operator.Constant.vdiv_sbyte(left, right, 8);
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(sbyte8 other)
        {
            if (Sse2.IsSse2Supported)
            {

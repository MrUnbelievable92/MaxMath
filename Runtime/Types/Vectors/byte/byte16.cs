    ...
    unsafe public struct byte16 : IEquatable<byte16>, IFormattable
    {
        ...
        public byte8 v8_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 2 * sizeof(byte)), 0b0001_1110);
                }
                else
                {
                    this.x2  = value.x0;
        ...
        public byte8 v8_4
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 4 * sizeof(byte)), 0b0011_1100);
                }
                else
                {
                    this.x4  = value.x0;
        ...
        public byte8 v8_6
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 6 * sizeof(byte)), 0b0111_1000);
                }
                else
                {
                    this.x6  = value.x0;
        ...
        public byte4 v4_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 2 * sizeof(byte)), 0b0000_0110);
                }
                else
                {
                    this.x2  = value.x;
        ...
        public byte4 v4_6
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 6 * sizeof(byte)), 0b0001_1000);
                }
                else
                {
                    this.x6  = value.x;
        ...
        public byte4 v4_10
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 10 * sizeof(byte)), 0b0110_0000);
                }
                else
                {
                    this.x10 = value.x;
...
Assert.IsWithinArrayBounds(index, 16);
        ...
        public static byte16 operator / (byte16 left, byte16 right)
        {
            ...
            {
                return new byte16(left.v8_0 / right.v8_0, left.v8_8 / right.v8_8);
            }
        }
        ...
        public static byte16 operator ++ (byte16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.add_epi8(x, new byte16(1));
            }
            else
            {
        ...
        public static byte16 operator -- (byte16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.sub_epi8(x, new byte16(1));
            }
            else
            {
                return new byte16((byte)(x.x0 - 1), (byte)(x.x1 - 1), (byte)(x.x2 - 1), (byte)(x.x3 - 1), (byte)(x.x4 - 1), (byte)(x.x5 - 1), (byte)(x.x6 - 1), (byte)(x.x7 - 1), (byte)(x.x8 - 1), (byte)(x.x9 - 1), (byte)(x.x10 - 1), (byte)(x.x11 - 1), (byte)(x.x12 - 1), (byte)(x.x13 - 1), (byte)(x.x14 - 1), (byte)(x.x15 - 1));
        ...
        public override readonly bool Equals(object obj) => Equals((byte16)obj);

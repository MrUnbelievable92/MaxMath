    ...
    unsafe public struct byte16 : IEquatable<byte16>, IFormattable
    {
        ...
        public byte8 v8_8
        {
            ...
            set
            {
                if (Sse4_1.IsSse41Supported)
                {
                    this = Sse4_1.blend_epi16(this, Sse2.bslli_si128(value, 8 * sizeof(byte)), 0b1111_0000);
                }
                else if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16_SSE2(this, Sse2.bslli_si128(value, 8 * sizeof(byte)), 0b1111_0000);
                }
                else
                {
                    this.x8  = value.x0;
        ...
        public byte4 v4_4
        {
            ...
            set
            {
                if (Sse4_1.IsSse41Supported)
                {
                    this = Sse4_1.blend_epi16(this, Sse2.bslli_si128(value, 4 * sizeof(byte)), 0b0000_1100);
                }
                else if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16_SSE2(this, Sse2.bslli_si128(value, 4 * sizeof(byte)), 0b0000_1100);
                }
                else
                {
                    this.x4  = value.x;
        ...
        public byte4 v4_8
        {
            ...
            set
            {
                if (Sse4_1.IsSse41Supported)
                {
                    this = Sse4_1.blend_epi16(this, Sse2.bslli_si128(value, 8 * sizeof(byte)), 0b0011_0000);
                }
                else if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16_SSE2(this, Sse2.bslli_si128(value, 8 * sizeof(byte)), 0b0011_0000);
                }
                else
                {
                    this.x8  = value.x;
        ...
        public byte4 v4_12
        {
            ...
            set
            {
                if (Sse4_1.IsSse41Supported)
                {
                    this = Sse4_1.blend_epi16(this, Sse2.bslli_si128(value, 12 * sizeof(byte)), 0b1100_0000);
                }
                else if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16_SSE2(this, Sse2.bslli_si128(value, 12 * sizeof(byte)), 0b1100_0000);
                }
                else
                {
                    this.x12 = value.x;

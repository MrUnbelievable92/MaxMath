    ...
    unsafe public struct byte32 : IEquatable<byte32>, IFormattable
    {
        ...
        { 
			...
			readonly get 
			{
                ...
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(_v16_0,  2 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value,  2 * sizeof(byte)), 0b1111_1110);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value, 14 * sizeof(byte)), 0b0000_0001);
                }
                else
                {
                    this.x2  = value.x0;
        ...
        { 
			...
			readonly get 
			{
                ...
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(_v16_0,  4 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value,  4 * sizeof(byte)), 0b1111_1100);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value, 12 * sizeof(byte)), 0b0000_0011);
                }
                else
                {
                    this.x4  = value.x0;
        ...
        { 
			...
			readonly get 
			{
                if (Sse2.IsSse2Supported)
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(v16_0,  6 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value,  6 * sizeof(byte)), 0b1111_1000);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value, 10 * sizeof(byte)), 0b0000_0111);
                }
                else
                {
                    this.x6  = value.x0;
        ...
        { 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value,  8 * sizeof(byte)), 0b1111_0000);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value,  8 * sizeof(byte)), 0b0000_1111);
                }
                else
                {
                    this.x8  = value.x0;
        ...
        { 
			...
			readonly get 
			{
                if (Sse2.IsSse2Supported)
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(v16_0,  10 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value, 10 * sizeof(byte)), 0b1110_0000);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value,  6 * sizeof(byte)), 0b0001_1111);
                }
                else
                {
                    this.x10 = value.x0;
        ...
        { 
			...
			readonly get 
			{
                ...
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(_v16_0,  12 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value, 12 * sizeof(byte)), 0b1100_0000);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value,  4 * sizeof(byte)), 0b0011_1111);
                }
                else
                {
                    this.x12 = value.x0;
        ...
        { 
			...
			readonly get 
			{
                ...
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(_v16_0,  14 * sizeof(byte)), 
            ...
            set
            {
                ...
                {
                    this._v16_0  = Mask.BlendEpi16(_v16_0,  Sse2.bslli_si128(value, 14 * sizeof(byte)), 0b1000_0000);
                    this._v16_16 = Mask.BlendEpi16(_v16_16, Sse2.bsrli_si128(value,  2 * sizeof(byte)), 0b0111_1111);
                }
                else
                {
                    this.x14 = value.x0;
        ...
        { 
			...
			readonly get
            {
                ...
                {
                    return Mask.BlendEpi16(Sse2.bsrli_si128(_v16_0,  10 * sizeof(byte)),
...
Assert.IsWithinArrayBounds(index, 32);
        ...
        public static byte32 operator ++ (byte32 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_add_epi8(x, new byte32(1));
            }
            else
            {
        ...
        public static byte32 operator -- (byte32 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi8(x, new byte32(1));
            }
            else
            {
                return new byte32(x._v16_0 - 1, x._v16_16 - 1);
        ...
        public override readonly bool Equals(object obj) => Equals((byte32)obj);

...
namespace MaxMath
{
    ...
    unsafe public struct quarter2 : IEquatable<quarter2>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator v128(quarter2 input) => new v128(*(ushort*)&input, 0, 0, 0);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator quarter2(v128 input)
        {
        ...
        internal static quarter2 SByte2ToQuarter2(sbyte2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                sbyte2 sign = input & unchecked((sbyte)0b1000_0000);
                ...
                sbyte2 infinity = (sbyte)overflowValue.value;
        ...
        internal static quarter2 Byte2ToQuarter2(byte2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 overflowMask = Operator.greater_mask_byte(input, new byte2(15));
                ...
                byte2 infinity = overflowValue.value;
        ...
        internal static quarter2 Short2ToQuarter2(short2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                int2 cast = abs;
                v128 notZeroMask = Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(cast), default(v128));
        ...
        internal static quarter2 UShort2ToQuarter2(ushort2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 overflowMask = (sbyte2)(ushort2)Operator.greater_mask_ushort(input, new ushort2(15));
        ...
        internal static quarter2 Int2ToQuarter2(int2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 overflowMask = Sse2.cmpgt_epi32(UnityMathematicsLink.Tov128(abs), new v128(15, 15, 0, 0));
        ...
        internal static quarter2 UInt2ToQuarter2(uint2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 overflowMask = Operator.greater_mask_uint(UnityMathematicsLink.Tov128(input), new v128(15, 15, 0, 0));
                overflowMask = (sbyte2)(*(int2*)&overflowMask);
        ...
        internal static quarter2 Long2ToQuarter2(long2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                sbyte2 infinity = (sbyte)overflowValue.value;
                sbyte2 regular = Cast.Int4ToByte4(Sse2.andnot_si128(notZeroMask, UnityMathematicsLink.Tov128(f32)));
        ...
        internal static quarter2 ULong2ToQuarter2(ulong2 input, quarter overflowValue)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 overflowMask = (sbyte2)(ulong2)Operator.greater_mask_ulong(input, new ulong2(15));
                ...
                byte2 infinity = overflowValue.value;
                byte2 regular = Cast.Int4ToByte4(Sse2.andnot_si128(notZeroMask, UnityMathematicsLink.Tov128(f32)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quarter2 Half2ToQuarter2InRange(half2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 cmpIsZeroOrNegativeMask = Sse2.cmpgt_epi32(new v128(1L | (1L << 32), 0L), UnityMathematicsLink.Tov128(cmp));
                ...
                denormalExponent = Sse2.add_epi32(denormalExponent,
                                                  Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                                 Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f16_exponent), new v128(9L | (9L << 32), 0L)),
                ...
                v128 mantissaIfSmallerEpsilon = Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                               Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f16_exponent), new v128(8L | (8L << 32), 0L)),
                                                                              Sse2.andnot_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f16_mantissa), default(v128)), new v128(-1L, 0L))));
            ...
            {
                return new quarter2(quarter.HalfToQuarterInRange(input.x, (byte)(((uint)maxmath.asushort(input.x) >> 15) << 7), ((uint)maxmath.asushort(input.x) << 17) >> 27),
        ...
        public static explicit operator quarter2(half2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 underflowMask = Sse2.cmpgt_epi32(new v128(8L | (8L << 32), 0L), UnityMathematicsLink.Tov128(f16_exponent));
                v128 overflowMask = Sse2.cmpgt_epi32(UnityMathematicsLink.Tov128(f16_exponent), new v128(18L | (18L << 32), 0L));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quarter2 Float2ToQuarter2InRange(float2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                denormalExponent = Sse2.add_epi32(denormalExponent,
                                                  Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                                 Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f32_exponent), new v128(121L | (121L << 32), 0L)),
                                                                                Sse2.andnot_si128(Sse2.cmpgt_epi32(new v128(0x0040_0000L | (0x0040_0000L << 32), 0L),
                                                                                                                   UnityMathematicsLink.Tov128(f32_mantissa)),
                                                                                                  new v128(-1L, 0L)))));

                v128 mantissaIfSmallerEpsilon = Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                               Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f32_exponent), new v128(120L | (120L << 32), 0L)),
                                                                              Sse2.andnot_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f32_mantissa), default(v128)), new v128(-1L, 0L))));
            ...
            {
                return new quarter2(quarter.FloatToQuarterInRange(input.x, (byte)((math.asuint(input.x) >> 31) << 7), (math.asuint(input.x) << 1) >> 24),
        ...
        public static explicit operator quarter2(float2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 infNanexponentMantissa = Sse2.or_si128(new v128((long)quarter.PositiveInfinity.value | ((long)quarter.PositiveInfinity.value << 32), 0L),
                                                            Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                                           Sse2.cmpgt_epi32(Sse.and_ps(UnityMathematicsLink.Tov128(input), new v128((long)maxmath.bitmask32(31) | ((long)maxmath.bitmask32(31) << 32), 0L)),
                                                                                            new v128(0x7F80_0000L | (0x7F80_0000L << 32), 0L))));

                v128 underflowMask = Sse2.cmpgt_epi32(new v128(120L | (120L << 32), 0L), UnityMathematicsLink.Tov128(f32_exponent));
                v128 overflowMask = Sse2.cmpgt_epi32(UnityMathematicsLink.Tov128(f32_exponent), new v128(130L | (130L << 32), 0L));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quarter2 Double2ToQuarter2InRange(double2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                denormalExponent = Sse2.add_epi32(denormalExponent,
                                                  Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                                 Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f64_exponent), new v128(1017L | (1017L << 32), 0L)),
                                                                                Cast.Long2ToInt2(Sse2.andnot_si128(Operator.greater_mask_long(new v128(0x0008_0000_0000_0000ul, 0x0008_0000_0000_0000ul),
                                                                                                                                      f64_mantissa),
                                                                                                                   new v128(-1))))));

                v128 mantissaIfSmallerEpsilon = Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                               Sse2.and_si128(Sse2.cmpeq_epi32(UnityMathematicsLink.Tov128(f64_exponent), new v128(1016L | (1016L << 32), 0L)),
            ...
            {
                return new quarter2(quarter.DoubleToQuarterInRange(input.x, (byte)((math.asulong(input.x) >> 63) << 7), (uint)((math.asulong(input.x) << 1) >> 53)),
                                    quarter.DoubleToQuarterInRange(input.y, (byte)((math.asulong(input.y) >> 63) << 7), (uint)((math.asulong(input.y) << 1) >> 53)));
            }
        }
        ...
        public static explicit operator quarter2(double2 input)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 infNanexponentMantissa = Sse2.or_si128(new v128((long)quarter.PositiveInfinity.value | ((long)quarter.PositiveInfinity.value << 32), 0L),
                                                            Sse2.and_si128(new v128(1L | (1L << 32), 0L),
                                                                           Cast.Long2ToInt2(Operator.greater_mask_long(Sse2.and_pd(UnityMathematicsLink.Tov128(input), new v128(maxmath.bitmask64(63L))),
                                                                                                               new v128(0x7FF0_0000_0000_0000L)))));

                v128 underflowMask = Sse2.cmpgt_epi32(new v128(1016L | (1016L << 32), 0L), UnityMathematicsLink.Tov128(f64_exponent));
                v128 overflowMask = Sse2.cmpgt_epi32(UnityMathematicsLink.Tov128(f64_exponent), new v128(1026L | (1026L << 32), 0L));

    ...
    unsafe public struct ushort3 : IEquatable<ushort3>, IFormattable
    {
        ...
        public          ushort2 yx
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, value.yxyx, 0b0011);
                }
                else
                {
                    this.y = value.x;
        ...
        public          ushort2 yz
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, sizeof(ushort)), 0b0110);
                }
                else
                {
                    this.y = value.x;
...
Assert.IsWithinArrayBounds(index, 3);
        ...
        public static ushort3 operator * (ushort3 left, ushort right)
        {
            ...
            {
                return new ushort3((ushort)(left.x * right), (ushort)(left.y * right), (ushort)(left.z * right));
            }
        }
        ...
        public override readonly bool Equals(object obj) => Equals((ushort3)obj);

    ...
    unsafe public struct short3 : IEquatable<short3>, IFormattable
    {
        ...
        public          short2 yz
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, sizeof(short)), 0b0110);
                }
                else
                {
                    this.y = value.x;
...
Assert.IsWithinArrayBounds(index, 3);
        ...
        private static bool3 TestIsFalse(v128 input)
        {
            if (Sse2.IsSse2Supported)
            {
                input = Sse2.andnot_si128((byte3)(short3)input, new ushort4(0x0101));
        ...
        public override readonly bool Equals(object obj) => Equals((short3)obj);

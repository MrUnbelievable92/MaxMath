    ...
    unsafe public struct short8 : IEquatable<short8>, IFormattable
    {
        ...
        public short4 v4_1
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 1 * sizeof(short)), 0b0001_1110);
                }
                else
                {
                    this.x1 = value.x;
        ...
        public short4 v4_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 2 * sizeof(short)), 0b0011_1100);
                }
                else
                {
                    this.x2 = value.x;
        ...
        public short4 v4_3
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 3 * sizeof(short)), 0b0111_1000);
                }
                else
                {
                    this.x3 = value.x;
        ...
        public short3 v3_1
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 1 * sizeof(short)), 0b0000_1110);
                }
                else
                {
                    this.x1 = value.x;
        ...
        public short3 v3_2
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 2 * sizeof(short)), 0b0001_1100);
                }
                else
                {
                    this.x2 = value.x;
        ...
        public short3 v3_3
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 3 * sizeof(short)), 0b0011_1000);
                }
                else
                {
                    this.x3 = value.x;
        ...
        public short3 v3_4
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 4 * sizeof(short)), 0b0111_0000);
                }
                else
                {
                    this.x4 = value.x;
        ...
        public short3 v3_5
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 5 * sizeof(short)), 0b1110_0000);
                }
                else
                {
                    this.x5 = value.x;
        ...
        public short2 v2_1
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 1 * sizeof(short)), 0b0000_0110);
                }
                else
                {
                    this.x1 = value.x;
        ...
        public short2 v2_3
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 3 * sizeof(short)), 0b0001_1000);
                }
                else
                {
                    this.x3 = value.x;
        ...
        public short2 v2_5
        {
            ...
            set
            {
                if (Sse2.IsSse2Supported)
                {
                    this = Mask.BlendEpi16(this, Sse2.bslli_si128(value, 5 * sizeof(short)), 0b0110_0000);
                }
                else
                {
                    this.x5 = value.x;
...
Assert.IsWithinArrayBounds(index, 8);
        ...
        public static short8 operator ++ (short8 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.add_epi16(x, new short8(1));
            }
            else
            {
        ...
        public static short8 operator -- (short8 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.sub_epi16(x, new short8(1));
            }
            else
            {
                return new short8((short)(x.x0 - 1), (short)(x.x1 - 1), (short)(x.x2 - 1), (short)(x.x3 - 1), (short)(x.x4 - 1), (short)(x.x5 - 1), (short)(x.x6 - 1), (short)(x.x7 - 1));
        ...
        private static bool8 TestIsFalse(v128 input)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.andnot_si128((byte8)(short8)input, new byte8(1));
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(short8 other)
        {
            if (Sse2.IsSse2Supported)
            {
        ...
        public override readonly bool Equals(object obj) => Equals((short8)obj);

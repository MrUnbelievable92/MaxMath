...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        {
            if (Constant.IsConstantExpression(x) && x.hi == 0)
            {
                return tobyte((ulong)x > y) - tobyte((ulong)x < y);
            }
            else if (Constant.IsConstantExpression(y) && y.hi == 0)
            {
        ...
        {
            if (Constant.IsConstantExpression(x) && (x.intern.hi == 0 || x.intern.hi == ulong.MaxValue))
            {
                return tobyte((long)x > y) - tobyte((long)x < y);
            }
            else if (Constant.IsConstantExpression(y) && (y.intern.hi == 0 || y.intern.hi == ulong.MaxValue))
            {
        ...
        public static sbyte2 compareto(byte2 x, byte2 y)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.sub_epi8(Operator.greater_mask_byte(y, x), Operator.greater_mask_byte(x, y));
            }
            else
            {
                return new sbyte2((sbyte)compareto(x.x, y.x),
        ...
        public static sbyte3 compareto(byte3 x, byte3 y)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.sub_epi8(Sse2.cmpeq_epi8(Sse2.max_epu8(x, y), y), Sse2.cmpeq_epi8(Sse2.max_epu8(x, y), x));
            }
            else
            {
                return new sbyte3((sbyte)compareto(x.x, y.x),
        ...
        public static sbyte32 compareto(byte32 x, byte32 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi8(Avx2.mm256_cmpeq_epi8(Avx2.mm256_max_epu8(x, y), y), Avx2.mm256_cmpeq_epi8(Avx2.mm256_max_epu8(x, y), x));
            }
            else
            {
                return new sbyte32(compareto(x.v16_0,  y.v16_0),
        ...
        public static short2 compareto(ushort2 x, ushort2 y)
        {
            ...
            {
                return Sse2.sub_epi16(Sse2.cmpeq_epi16(Sse4_1.max_epu16(x, y), y), Sse2.cmpeq_epi16(Sse4_1.max_epu16(x, y), x));
            }
            else if (Sse2.IsSse2Supported)
            {
                return Sse2.sub_epi16(Operator.greater_mask_ushort(y, x), Operator.greater_mask_ushort(x, y));
            }
            else
            {
                return new short2((short)compareto(x.x, y.x),
        ...
        public static short16 compareto(ushort16 x, ushort16 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi16(Avx2.mm256_cmpeq_epi16(Avx2.mm256_max_epu16(x, y), y), Avx2.mm256_cmpeq_epi16(Avx2.mm256_max_epu16(x, y), x));
            }
            else
            {
                return new short16(compareto(x.v8_0, y.v8_0),
        ...
        public static int2 compareto(int2 x, int2 y)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 result = Sse2.sub_epi32(Sse2.cmpgt_epi32(_y, _x), Sse2.cmpgt_epi32(_x, _y));
        ...
        public static int2 compareto(uint2 x, uint2 y)
        {
            if (Sse4_1.IsSse41Supported)
            {
                ...
                v128 result = Sse2.sub_epi32(Sse2.cmpeq_epi32(Sse4_1.max_epu32(_y, _x), _y), Sse2.cmpeq_epi32(Sse4_1.max_epu32(_x, _y), _x));
            ...
            else if (Sse2.IsSse2Supported)
            {
                ...
                v128 result = Sse2.sub_epi32(Operator.greater_mask_uint(_y, _x), Operator.greater_mask_uint(_x, _y));
        ...
        public static int8 compareto(uint8 x, uint8 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi32(Avx2.mm256_cmpeq_epi32(Avx2.mm256_max_epu32(x, y), y), Avx2.mm256_cmpeq_epi32(Avx2.mm256_max_epu32(x, y), x));
            }
            else
            {
                return new int8(compareto(x.v4_0, y.v4_0),
        ...
        public static long2 compareto(long2 x, long2 y)
        {
            if (Sse4_1.IsSse41Supported)
            {
                return Sse2.sub_epi64(Operator.greater_mask_long(y, x), Operator.greater_mask_long(x, y));
            }
            else
            {
        ...
        public static long3 compareto(long3 x, long3 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi64(Avx2.mm256_cmpgt_epi64(y, x), Avx2.mm256_cmpgt_epi64(x, y));
            }
            else
            {
        ...
        public static long2 compareto(ulong2 x, ulong2 y)
        {
            ...
            {
                return Sse2.sub_epi64(Operator.greater_mask_ulong(y, x), Operator.greater_mask_ulong(x, y));
            }
            else
            {
                return new long2(compareto(x.x, y.x),
        ...
        public static long3 compareto(ulong3 x, ulong3 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Avx2.mm256_sub_epi64(Operator.greater_mask_ulong(y, x), Operator.greater_mask_ulong(x, y));
            }
            else
            {
                return new long3(compareto(x.xy, y.xy),
        ...
        public static int2 compareto(float2 x, float2 y)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 result = Sse2.sub_epi32(Sse.cmpgt_ps(_y, _x), Sse.cmpgt_ps(_x, _y));
        ...
        public static long3 compareto(double3 x, double3 y)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                v256 _y = UnityMathematicsLink.Tov256(y);

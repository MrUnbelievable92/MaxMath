...
namespace MaxMath
{
    ...
    {
        /// <summary>       Returns a 8-bit bitmask byte2 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
...
Assert.IsBetween(numBits.y, 0u, 8u - index.y);
            ...
            {
                return (byte2)(-toint16(numBits == 16)) | andnot(index, shl(index, numBits));
            }
        }

        /// <summary>       Returns a 8-bit bitmask byte3 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(numBits.z, 0u, 8u - index.z);
            ...
            {
                return (byte3)(-toint16(numBits == 16)) | andnot(index, shl(index, numBits));
            }
        }

        /// <summary>       Returns a 8-bit bitmask byte4 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(numBits.w, 0u, 8u - index.w);
        ...
        /// <summary>       Returns a 8-bit bitmask byte8 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(index.x14, 0u, 8u);
Assert.IsBetween(index.x15, 0u, 8u);
Assert.IsBetween(index.x16, 0u, 8u);
Assert.IsBetween(index.x17, 0u, 8u);
Assert.IsBetween(index.x18, 0u, 8u);
Assert.IsBetween(index.x19, 0u, 8u);
Assert.IsBetween(index.x20, 0u, 8u);
Assert.IsBetween(index.x21, 0u, 8u);
Assert.IsBetween(index.x22, 0u, 8u);
Assert.IsBetween(index.x23, 0u, 8u);
Assert.IsBetween(index.x24, 0u, 8u);
Assert.IsBetween(index.x25, 0u, 8u);
Assert.IsBetween(index.x26, 0u, 8u);
Assert.IsBetween(index.x27, 0u, 8u);
Assert.IsBetween(index.x28, 0u, 8u);
Assert.IsBetween(index.x29, 0u, 8u);
Assert.IsBetween(index.x30, 0u, 8u);
Assert.IsBetween(index.x31, 0u, 8u);
Assert.IsBetween(numBits.x0,  0u, 8u - index.x0);
Assert.IsBetween(numBits.x1,  0u, 8u - index.x1);
Assert.IsBetween(numBits.x2,  0u, 8u - index.x2);
Assert.IsBetween(numBits.x3,  0u, 8u - index.x3);
...
Assert.IsBetween(numBits.x31, 0u, 8u - index.x31);
        ...
        /// <summary>       Returns a 16-bit bitmask ushort2 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(numBits.y, 0u, 16u - index.y);
            ...
            {
                return (ushort2)(-toint16(numBits == 16)) | andnot(index, shl(index, numBits));
            }
        }

        /// <summary>       Returns a 16-bit bitmask ushort3 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(numBits.z, 0u, 16u - index.z);
            ...
            {
                return (ushort3)(-toint16(numBits == 16)) | andnot(index, shl(index, numBits));
            }
        }

        /// <summary>       Returns a 16-bit bitmask ushort4 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(numBits.w, 0u, 16u - index.w);
        ...
        /// <summary>       Returns a 16-bit bitmask ushort8 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(index.x6,  0u, 16u);
Assert.IsBetween(index.x7,  0u, 16u);
Assert.IsBetween(index.x8,  0u, 16u);
Assert.IsBetween(index.x9,  0u, 16u);
Assert.IsBetween(index.x10, 0u, 16u);
Assert.IsBetween(index.x11, 0u, 16u);
Assert.IsBetween(index.x12, 0u, 16u);
Assert.IsBetween(index.x13, 0u, 16u);
Assert.IsBetween(index.x14, 0u, 16u);
Assert.IsBetween(index.x15, 0u, 16u);
Assert.IsBetween(numBits.x0,  0u, 16u - index.x0);
Assert.IsBetween(numBits.x1,  0u, 16u - index.x1);
Assert.IsBetween(numBits.x2,  0u, 16u - index.x2);
Assert.IsBetween(numBits.x3,  0u, 16u - index.x3);
...
Assert.IsBetween(numBits, 0ul, 64ul - index);
            ...
            return bits_masktolowest(touint64(numBits != 64) << ((int)numBits - 1)) << (int)index;
        }
...
Assert.IsBetween(numBits.w, 0ul, 64ul - index.w);
        ...
        /// <summary>       Returns a 8-bit bitmask sbyte2 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte2 bitmask8(sbyte2 numBits, sbyte2 index = default(sbyte2)) => (sbyte2)bitmask8((byte2)numBits, (byte2)index);

        /// <summary>       Returns a 8-bit bitmask sbyte3 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3 bitmask8(sbyte3 numBits, sbyte3 index = default(sbyte3)) => (sbyte3)bitmask8((byte3)numBits, (byte3)index);

        /// <summary>       Returns a 8-bit bitmask sbyte4 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte4 bitmask8(sbyte4 numBits, sbyte4 index = default(sbyte4)) => (sbyte4)bitmask8((byte4)numBits, (byte4)index);

        /// <summary>       Returns a 8-bit bitmask sbyte8 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a 16-bit bitmask short2 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short2 bitmask16(short2 numBits, short2 index = default(short2)) => (short2)bitmask16((ushort2)numBits, (ushort2)index);

        /// <summary>       Returns a 16-bit bitmask short3 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short3 bitmask16(short3 numBits, short3 index = default(short3)) => (short3)bitmask16((ushort3)numBits, (ushort3)index);

        /// <summary>       Returns a 16-bit bitmask short4 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short4 bitmask16(short4 numBits, short4 index = default(short4)) => (short4)bitmask16((ushort4)numBits, (ushort4)index);

        /// <summary>       Returns a 16-bit bitmask short8 vector with all componentwise bits set to 1 from index to (index + numBits - 1) in LSB order.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

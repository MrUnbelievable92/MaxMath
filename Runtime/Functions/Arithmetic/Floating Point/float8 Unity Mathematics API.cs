...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        /// <summary>       Returns a normalized version of the <see cref="MaxMath.float8"/> <paramref name="x"/> by scaling it by 1 / length(<paramref name="x"/>).    </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a safe normalized version of the <see cref="MaxMath.float8"/> <paramref name="x"/> by scaling it by 1 / length(<paramref name="x"/>). Returns the given default value when 1 / length(<paramref name="x"/>) does not produce a finite number.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

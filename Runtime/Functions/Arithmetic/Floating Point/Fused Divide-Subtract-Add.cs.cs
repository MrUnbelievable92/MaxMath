...
namespace MaxMath
{
    ...
    {
        /// <summary>       Returns the result of a componentwise fast approximate divide-subtract/add operation (<paramref name="a"/> * (1 / <paramref name="b"/>) -/+ <paramref name="c"/>) on 3 <see cref="float2"/>s.    </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2 dsubadd(float2 a, float2 b, float2 c, bool fast = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                v128 temp = Fma.fmaddsub_ps(UnityMathematicsLink.Tov128(a), 
        ...
        /// <summary>       Returns the result of a componentwise fast approximate divide-subtract/add operation (<paramref name="a"/> * (1 / <paramref name="b"/>) -/+/- <paramref name="c"/>) on 3 <see cref="float3"/>s.    </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of a componentwise fast approximate divide-subtract/add operation (<paramref name="a"/> * (1 / <paramref name="b"/>) -/+/-/+ <paramref name="c"/>) on 3 <see cref="float4"/>s.    </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of a componentwise fast approximate divide-subtract/add operation (<paramref name="a"/> * (1 / <paramref name="b"/>) -/+/-/+/-/+/-/+ <paramref name="c"/>) on 3 <see cref="MaxMath.float8"/>s.    </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 dsubadd(float8 a, float8 b, float8 c, bool fast = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Fma.mm256_fmaddsub_ps(a, fast ? fastrcp(b) : rcp(b), c);
            }
            else
            {

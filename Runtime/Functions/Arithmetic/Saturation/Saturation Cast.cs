...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        public static ushort8 toushortsaturated(int4 lo, int4 hi)
        {
            if (Sse4_1.IsSse41Supported)
            {
                v128 _lo = UnityMathematicsLink.Tov128(lo);
                v128 _hi = UnityMathematicsLink.Tov128(hi);
        ...
        public static uint2 touintsaturated(long2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 result = Cast.Long2ToInt2(clamped);
        ...
        public static uint3 touintsaturated(long3 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                v128 result = Cast.Long4ToInt4(clamped);
        ...
        public static uint8 touintsaturated(long4 lo, long4 hi)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                return Avx2.mm256_inserti128_si256(Avx.mm256_castsi128_si256(Cast.Long4ToInt4(clamped_lo)), Cast.Long4ToInt4(clamped_hi), 1);
            }
            else
            {
        ...
        public static uint8 touintsaturated(float8 x)
        {
            ...
            else if (Avx.IsAvxSupported)
            {
                ...
                return new uint8(*(uint4*)&lo, *(uint4*)&hi); 
            }
            else
            {
        ...
        {
            return x.hi == 0 ? x.lo : ulong.MaxValue; 
        }
        ...
        public static ulong2 toulongsaturated(float2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                return Mask.BlendV(Mask.BlendV(cast, MIN_VALUE, underflowMask), MAX_VALUE, overflowMask);
            }
            else
            {
        ...
        public static ulong3 toulongsaturated(float3 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                return Avx2.mm256_blendv_epi8(Avx2.mm256_blendv_epi8(cast, MIN_VALUE, underflowMask256), MAX_VALUE, overflowMask256);
            }
            else
            {
        ...
        public static ulong2 toulongsaturated(double2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                return Mask.BlendV(Mask.BlendV(cast, MIN_VALUE, underflowMask, false), MAX_VALUE, overflowMask, false);
            }
            else
            {
                return new ulong2(toulongsaturated(x.x), toulongsaturated(x.y));
        ...
        public static ulong3 toulongsaturated(double3 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                v256 _x = UnityMathematicsLink.Tov256(x);
        ...
        {
            float clamped = math.clamp(x, quarter.MinValue, quarter.MaxValue);
            byte f8_sign      = (byte)((math.asuint(clamped) >> 31) << 7);
            uint f32_exponent = (math.asuint(clamped) << 1) >> 24;

            return quarter.FloatToQuarterInRange(clamped, f8_sign, f32_exponent);
        }
        ...
        {
            double clamped = math.clamp(x, quarter.MinValue, quarter.MaxValue);
            byte f8_sign      = (byte)((math.asulong(clamped) >> 63) << 7);
            uint f64_exponent = (uint)((math.asulong(clamped) << 1) >> 53);

            return quarter.DoubleToQuarterInRange(clamped, f8_sign, f64_exponent);
        }
        ...
        {
            return MaxMath.quarter2.Float2ToQuarter2InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter3.Float3ToQuarter3InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter4.Float4ToQuarter4InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter8.Float8ToQuarter8InRange(clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter2.Double2ToQuarter2InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter3.Double3ToQuarter3InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        {
            return MaxMath.quarter4.Double4ToQuarter4InRange(math.clamp(x, quarter.MinValue, quarter.MaxValue));
        }
        ...
        public static quarter8 toquartersaturated(double4 lo, double4 hi)
        {
            ...
            return new quarter8(MaxMath.quarter4.Double4ToQuarter4InRange(math.clamp(lo, MIN_VALUE, MAX_VALUE)),
                                MaxMath.quarter4.Double4ToQuarter4InRange(math.clamp(hi, MIN_VALUE, MAX_VALUE)));
        }
        #endregion

...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        public static byte cprodsaturated(byte8 x)
        {
            if (Sse4_1.IsSse41Supported)
            {
                v128 MAX_VALUE = Sse2.srli_epi32(Sse2.cmpeq_epi32(default(v128), default(v128)), 24);
        ...
        public static byte cprodsaturated(byte32 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                v256 MAX_VALUE = Avx2.mm256_srli_epi32(Avx2.mm256_cmpeq_epi32(default(v256), default(v256)), 24);

                v128 hi = Avx2.mm256_extracti128_si256(x, 1);
                v256 ints1 = Avx2.mm256_cvtepu8_epi32(Avx.mm256_castsi256_si128(x));
                v256 ints2 = Avx2.mm256_cvtepu8_epi32(Sse2.bsrli_si128(Avx.mm256_castsi256_si128(x), 8 * sizeof(byte)));
                v256 ints3 = Avx2.mm256_cvtepu8_epi32(hi);
                v256 ints4 = Avx2.mm256_cvtepu8_epi32(Sse2.bsrli_si128(hi, 8 * sizeof(byte)));

                v256 product = Avx2.mm256_mullo_epi32(Avx2.mm256_mullo_epi32(ints1, ints2), Avx2.mm256_mullo_epi32(ints3, ints4));
        ...
        public static sbyte cprodsaturated(sbyte2 x)
        {
            ...
            {
                v128 shorts = Cast.SByteToShort(x);
                v128 product;
        ...
        public static sbyte cprodsaturated(sbyte32 x)
        {
            ...
            {
                v128 hi = Avx2.mm256_extracti128_si256(x, 1);
                v256 shorts1 = Avx2.mm256_cvtepi8_epi16(Avx.mm256_castsi256_si128(x));
                v256 shorts2 = Avx2.mm256_cvtepi8_epi16(hi);
        ...
        public static short cprodsaturated(short16 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                v256 ints1 = Avx2.mm256_cvtepi16_epi32(Avx.mm256_castsi256_si128(x));
                v256 ints2 = Avx2.mm256_cvtepi16_epi32(Avx2.mm256_extracti128_si256(x, 1));
        ...
        public static ushort cprodsaturated(ushort2 x)
        {
            if (Sse4_1.IsSse41Supported)
            {
                v128 MAX_VALUE = Sse2.srli_epi32(Sse2.cmpeq_epi32(default(v128), default(v128)), 16);
        ...
        public static ushort cprodsaturated(ushort16 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                v256 MAX_VALUE = Avx2.mm256_srli_epi32(Avx2.mm256_cmpeq_epi32(default(v256), default(v256)), 16);

                v256 ints1 = Avx2.mm256_cvtepu16_epi32(Avx.mm256_castsi256_si128(x));
                v256 ints2 = Avx2.mm256_cvtepu16_epi32(Avx2.mm256_extracti128_si256(x, 1));

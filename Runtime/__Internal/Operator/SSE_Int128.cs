...
namespace MaxMath
{
    unsafe internal static partial class Operator
    {
        ...
        internal static UInt128 ror128_Sse(UInt128 x, int n)
        {
            if (Ssse3.IsSsse3Supported)
            {
                if (Constant.IsConstantExpression(n) && n % 8 == 0)
                {
                    v128 sse = *(v128*)&x;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 rol128_Sse(UInt128 x, int n)
        {
            if (Ssse3.IsSsse3Supported)
            {
                if (Constant.IsConstantExpression(n) && n % 8 == 0)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 and128_Sse(UInt128 x, UInt128 y)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 or128_Sse(UInt128 x, UInt128 y)
        {
            if (Sse2.IsSse2Supported)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 xor128_Sse(UInt128 x, UInt128 y)
        {
            if (Sse2.IsSse2Supported)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 andn128_Sse(UInt128 x, UInt128 y)
        {
            if (Sse2.IsSse2Supported)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 shl128_Sse(UInt128 x, int n)
        {
Assert.IsBetween(n, 0, 128);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static UInt128 shrl128_Sse(UInt128 x, int n)
        {
Assert.IsBetween(n, 0, 128);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Int128 shra128_Sse(Int128 x, int n)
        {
Assert.IsBetween(n, 0, 128);
        ...
        internal static bool test_mix_ones_zeroes(UInt128 x)
        {
            ...
            {
                int i = Sse4_1.test_mix_ones_zeroes(*(v128*)&x, Sse2.cmpeq_epi32(default(v128), default(v128)));
        
                return *(bool*)&i;
            }

            return ((x.lo | x.hi) != 0) & ((x.lo & x.hi) != ulong.MaxValue);
        }
        ...
        internal static bool test_all_ones(UInt128 x)
        {
            ...
            return (x.lo & x.hi) == ulong.MaxValue;
        }
        ...
        internal static bool test_all_zeros(UInt128 x)
        {
            if (Sse4_1.IsSse41Supported)
            {
                int i = Sse4_1.test_all_zeros(*(v128*)&x, Sse2.cmpeq_epi32(default(v128), default(v128)));

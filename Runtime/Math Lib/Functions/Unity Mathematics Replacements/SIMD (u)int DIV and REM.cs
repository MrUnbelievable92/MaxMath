...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        public static uint2 div(uint2 dividend, uint2 divisor)
        {
            ...
            {
                return RegisterConversion.ToType<uint2>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 2));
            }
            else
            {
        ...
        public static uint3 div(uint3 dividend, uint3 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint3>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 3));
            }
            else
            {
                return dividend / divisor;
        ...
        public static uint4 div(uint4 dividend, uint4 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint4>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 4));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int2 div(int2 dividend, int2 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int2>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 2));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int3 div(int3 dividend, int3 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int3>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 3));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int4 div(int4 dividend, int4 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int4>(Xse.div_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 4));
            }
            else
            {
                return dividend / divisor;
        ...
        /// <summary>       Divides <paramref name="dividend" /> by <paramref name="divisor"/> and returns the modainder.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 mod(uint2 dividend, uint2 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint2>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 2));
            }
            else
            {
                return dividend / divisor;
        ...
        public static uint3 mod(uint3 dividend, uint3 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint3>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 3));
            }
            else
            {
                return dividend / divisor;
        ...
        public static uint4 mod(uint4 dividend, uint4 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint4>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 4));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int2 mod(int2 dividend, int2 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int2>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 2));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int3 mod(int3 dividend, int3 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int3>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 3));
            }
            else
            {
                return dividend / divisor;
        ...
        public static int4 mod(int4 dividend, int4 divisor)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<int4>(Xse.rem_epu32(RegisterConversion.ToV128(dividend), RegisterConversion.ToV128(divisor), 4));
            }
            else
            {
                return dividend / divisor;

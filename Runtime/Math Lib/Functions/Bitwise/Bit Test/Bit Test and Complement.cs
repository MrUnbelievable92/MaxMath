...
namespace MaxMath
{
    ...
    unsafe public static partial class maxmath
    {
        ...
        public static bool2 testbitflip(ref byte2 x, byte2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.btc_epi8(ref __ref, i, MaskType.One, 2));
                x = __ref;
        ...
        public static bool3 testbitflip(ref byte3 x, byte3 i)
        {
            ...
            {
                v128 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.btc_epi8(ref __ref, i, MaskType.One, 3));
                x = __ref;
        ...
        public static bool4 testbitflip(ref byte4 x, byte4 i)
        {
            ...
            {
                v128 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.btc_epi8(ref __ref, i, MaskType.One, 4));
                x = __ref;
        ...
        public static bool2 testbitflip(ref ushort2 x, ushort2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi16_epi8(Xse.btc_epi16(ref __ref, i, MaskType.One, 2), 2));
                x = __ref;
        ...
        public static bool3 testbitflip(ref ushort3 x, ushort3 i)
        {
            ...
            {
                v128 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.cvtepi16_epi8(Xse.btc_epi16(ref __ref, i, MaskType.One, 3), 3));
                x = __ref;
        ...
        public static bool4 testbitflip(ref ushort4 x, ushort4 i)
        {
            ...
            {
                v128 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.cvtepi16_epi8(Xse.btc_epi16(ref __ref, i, MaskType.One, 4), 4));
                x = __ref;
        ...
        public static bool2 testbitflip(ref uint2 x, uint2 i)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi32_epi8(Xse.btc_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 2), 2));
        ...
        public static bool3 testbitflip(ref uint3 x, uint3 i)
        {
            ...
            {
                v128 __ref = RegisterConversion.ToV128(x);
                bool3 result = RegisterConversion.ToType<bool3>(Xse.cvtepi32_epi8(Xse.btc_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 3), 3));
        ...
        public static bool4 testbitflip(ref uint4 x, uint4 i)
        {
            ...
            {
                v128 __ref = RegisterConversion.ToV128(x);
                bool4 result = RegisterConversion.ToType<bool4>(Xse.cvtepi32_epi8(Xse.btc_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 4), 4));
        ...
        public static bool2 testbitflip(ref ulong2 x, ulong2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi64_epi8(Xse.btc_epi64(ref __ref, i, MaskType.One)));
                x = __ref;
        ...
        public static bool3 testbitflip(ref ulong3 x, ulong3 i)
        {
            ...
            {
                v256 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.mm256_cvtepi64_epi8(Xse.mm256_btc_epi64(ref __ref, i, MaskType.One)));
                x = __ref;
        ...
        public static bool4 testbitflip(ref ulong4 x, ulong4 i)
        {
            ...
            {
                v256 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.mm256_cvtepi64_epi8(Xse.mm256_btc_epi64(ref __ref, i, MaskType.One)));
                x = __ref;

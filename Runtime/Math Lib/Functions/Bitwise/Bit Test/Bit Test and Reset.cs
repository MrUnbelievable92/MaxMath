...
namespace MaxMath
{
            ...
            public static v128 btr_epi8(ref v128 a, v128 b, MaskType result = MaskType.AllOnes, byte elements = 16)
            {
                if (Sse2.IsSse2Supported)
                {
                    if (constexpr.ALL_EQ_EPI8(b, 7, elements))
                    {
                        ...
                        a = Sse2.andnot_si128(Sse2.set1_epi8(unchecked((sbyte)(1 << 7))), a);
            ...
            public static v256 mm256_btr_epi8(ref v256 a, v256 b, MaskType result = MaskType.AllOnes)
            {
                ...
                {                 
                    if (constexpr.ALL_EQ_EPI8(b, 7))
                    {
                        ...
                        a = Avx2.mm256_andnot_si256(Avx.mm256_set1_epi8(unchecked((byte)(1 << 7))), a);
            ...
            public static v256 mm256_btr_epi16(ref v256 a, v256 b, MaskType result = MaskType.AllOnes)
            {
                if (Avx2.IsAvx2Supported)
                {
                    if (constexpr.ALL_EQ_EPI8(b, 15))
                    {
                        ...
                        a = Avx2.mm256_andnot_si256(Avx.mm256_set1_epi16(unchecked((short)(1 << 15))), a);
            ...
            public static v256 mm256_btr_epi32(ref v256 a, v256 b, MaskType result = MaskType.AllOnes)
            {
                if (Avx2.IsAvx2Supported)
                {
                    if (constexpr.ALL_EQ_EPI8(b, 31))
                    {
                        ...
                        a = Avx2.mm256_andnot_si256(Avx.mm256_set1_epi32(unchecked((int)(1 << 31))), a);
            ...
            public static v256 mm256_btr_epi64(ref v256 a, v256 b, MaskType result = MaskType.AllOnes, byte elements = 4)
            {
                if (Avx2.IsAvx2Supported)
                {
                    if (constexpr.ALL_EQ_EPI64(b, 63, elements))
                    {
                        ...
                        a = Avx2.mm256_andnot_si256(Avx.mm256_set1_epi64x(unchecked((long)(1ul << 63))), a);
    ...
    unsafe public static partial class maxmath
    {
        ...
        public static bool2 testbitreset(ref byte2 x, byte2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.btr_epi8(ref __ref, i, MaskType.One, 2));
                x = __ref;
        ...
        public static bool3 testbitreset(ref byte3 x, byte3 i)
        {
            ...
            {
                v128 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.btr_epi8(ref __ref, i, MaskType.One, 3));
                x = __ref;
        ...
        public static bool4 testbitreset(ref byte4 x, byte4 i)
        {
            ...
            {
                v128 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.btr_epi8(ref __ref, i, MaskType.One, 4));
                x = __ref;
        ...
        public static bool2 testbitreset(ref ushort2 x, ushort2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi16_epi8(Xse.btr_epi16(ref __ref, i, MaskType.One, 2), 2));
                x = __ref;
        ...
        public static bool3 testbitreset(ref ushort3 x, ushort3 i)
        {
            ...
            {
                v128 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.cvtepi16_epi8(Xse.btr_epi16(ref __ref, i, MaskType.One, 3), 3));
                x = __ref;
        ...
        public static bool4 testbitreset(ref ushort4 x, ushort4 i)
        {
            ...
            {
                v128 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.cvtepi16_epi8(Xse.btr_epi16(ref __ref, i, MaskType.One, 4), 4));
                x = __ref;
        ...
        public static bool2 testbitreset(ref uint2 x, uint2 i)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi32_epi8(Xse.btr_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 2), 2));
        ...
        public static bool3 testbitreset(ref uint3 x, uint3 i)
        {
            ...
            {
                v128 __ref = RegisterConversion.ToV128(x);
                bool3 result = RegisterConversion.ToType<bool3>(Xse.cvtepi32_epi8(Xse.btr_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 3), 3));
        ...
        public static bool4 testbitreset(ref uint4 x, uint4 i)
        {
            ...
            {
                v128 __ref = RegisterConversion.ToV128(x);
                bool4 result = RegisterConversion.ToType<bool4>(Xse.cvtepi32_epi8(Xse.btr_epi32(ref __ref, RegisterConversion.ToV128(i), MaskType.One, 4), 4));
        ...
        public static bool2 testbitreset(ref ulong2 x, ulong2 i)
        {
            ...
            {
                v128 __ref = x;
                bool2 result = RegisterConversion.ToType<bool2>(Xse.cvtepi64_epi8(Xse.btr_epi64(ref __ref, i, MaskType.One)));
                x = __ref;
        ...
        public static bool3 testbitreset(ref ulong3 x, ulong3 i)
        {
            ...
            {
                v256 __ref = x;
                bool3 result = RegisterConversion.ToType<bool3>(Xse.mm256_cvtepi64_epi8(Xse.mm256_btr_epi64(ref __ref, i, MaskType.One)));
                x = __ref;
        ...
        public static bool4 testbitreset(ref ulong4 x, ulong4 i)
        {
            ...
            {
                v256 __ref = x;
                bool4 result = RegisterConversion.ToType<bool4>(Xse.mm256_cvtepi64_epi8(Xse.mm256_btr_epi64(ref __ref, i, MaskType.One)));
                x = __ref;

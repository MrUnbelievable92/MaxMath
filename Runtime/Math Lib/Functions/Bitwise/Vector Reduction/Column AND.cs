...
namespace MaxMath
{
    ...
    unsafe public static partial class math
    {
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of an <see cref="MaxMath.int2"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cand(int2 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vand_epi32(c, 2).SInt0;
            }
            else
            {
                return c.x & c.y;
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of an <see cref="MaxMath.int3"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cand(int3 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vand_epi32(c, 3).SInt0;
            }
            else
            {
                return (c.x & c.y) & c.z;
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of an <see cref="MaxMath.int4"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cand(int4 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vand_epi32(c, 4).SInt0;
            }
            else
            {
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of a <see cref="MaxMath.uint2"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of a <see cref="MaxMath.uint3"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the horizontal bitwise AND reduction of components of a <see cref="MaxMath.uint4"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

...
namespace MaxMath
{
    ...
    unsafe public static partial class math
    {
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of an <see cref="MaxMath.int2"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cor(int2 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vor_epi32(c, 2).SInt0;
            }
            else
            {
                return c.x | c.y;
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of an <see cref="MaxMath.int3"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cor(int3 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vor_epi32(c, 3).SInt0;
            }
            else
            {
                return (c.x | c.y) | c.z;
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of an <see cref="MaxMath.int4"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int cor(int4 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.vor_epi32(c, 4).SInt0;
            }
            else
            {
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of a <see cref="MaxMath.uint2"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of a <see cref="MaxMath.uint3"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the horizontal bitwise OR reduction of components of a <see cref="MaxMath.uint4"/>.       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

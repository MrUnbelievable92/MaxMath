        ...
        unsafe public static partial class Xse
        {
            ...
            public static v128 bzhi_epi8(v128 a, v128 startIndex, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    if (BurstArchitecture.IsTableLookupSupported)
                    {
                        ...
                        return and_si128(a, shuffle_epi8(LOOKUP, startIndex));
                    }
                    else
                    {
                        v128 ONE = set1_epi8(1);

                        return and_si128(a, sub_epi8(sllv_epi8(ONE, startIndex, inRange: true, elements: elements), ONE));
                    }
                }
            ...
            public static v128 bzhi_epi16(v128 a, v128 startIndex, byte elements = 8)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return and_si128(a, sub_epi16(sllv_epi16(ONE, startIndex, inRange: true, elements: elements), ONE));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 bzhi_epi32(v128 a, v128 startIndex, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return andnot_si128(sllv_epi32(setall_si128(), startIndex, inRange: true, elements: elements), a);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 bzhi_epi64(v128 a, v128 startIndex)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return andnot_si128(sllv_epi64(setall_si128(), startIndex, inRange: true), a);
                }
                else throw new IllegalInstructionException();
            }

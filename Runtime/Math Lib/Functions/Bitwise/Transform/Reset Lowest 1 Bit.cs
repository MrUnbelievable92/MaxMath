...
namespace MaxMath
{
    namespace Intrinsics
    {
        unsafe public static partial class Xse
        {
            ...
            public static v128 blsr_epi16(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return and_si128(a, dec_epi16(a));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsr_epi32(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return and_si128(a, dec_epi32(a));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsr_epi64(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return and_si128(a, dec_epi64(a));
                }
                else throw new IllegalInstructionException();
            }
    ...
    {
        /// <summary>       Sets the lowest 1 bit in <paramref name="x"/> to 0.     </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Sets the lowest 1 bit in each <paramref name="x"/> component to 0.     </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        public static ushort2 bitfield(byte2 x0, byte2 x1)
        {
            ...
            {
                return Sse2.unpacklo_epi8(x0, x1);
            }
            else
            {
        ...
        public static ushort16 bitfield(byte16 x0, byte16 x1)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 lo = Sse2.unpacklo_epi8(x0, x1);
                v128 hi = Sse2.unpackhi_epi8(x0, x1);
        ...
        public static uint8 bitfield(byte8 x0, byte8 x1, byte8 x2, byte8 x3)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 lo0 = Sse2.unpacklo_epi8(x0, x1);
                v128 lo1 = Sse2.unpacklo_epi8(x2, x3);
                v128 resultlo = Sse2.unpacklo_epi16(lo0, lo1);
                v128 resulthi = Sse2.unpackhi_epi16(lo0, lo1);
        ...
        public static uint8 bitfield(ushort8 x0, ushort8 x1)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 resultlo = Sse2.unpacklo_epi16(x0, x1);
                v128 resulthi = Sse2.unpackhi_epi16(x0, x1);
        ...
        public static ulong2 bitfield(byte2 x0, byte2 x1, byte2 x2, byte2 x3, byte2 x4, byte2 x5, byte2 x6, byte2 x7)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 x01 = Sse2.unpacklo_epi8(x0, x1);
                v128 x23 = Sse2.unpacklo_epi8(x2, x3);
                v128 x45 = Sse2.unpacklo_epi8(x4, x5);
                v128 x67 = Sse2.unpacklo_epi8(x6, x7);

                v128 x0123 = Sse2.unpacklo_epi16(x01, x23);
                v128 x4567 = Sse2.unpacklo_epi16(x45, x67);

                return Sse2.unpacklo_epi32(x0123, x4567);
            }
            else
            {
        ...
        public static ulong3 bitfield(byte3 x0, byte3 x1, byte3 x2, byte3 x3, byte3 x4, byte3 x5, byte3 x6, byte3 x7)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 resultlo = Sse2.unpacklo_epi32(x0123, x4567);
                v128 resulthi = Sse2.unpackhi_epi32(x0123, x4567);
        ...
        public static ulong2 bitfield(ushort2 x0, ushort2 x1, ushort2 x2, ushort2 x3)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 x01 = Sse2.unpacklo_epi16(x0, x1);
                v128 x23 = Sse2.unpacklo_epi16(x2, x3);

                return Sse2.unpacklo_epi32(x01, x23);
            }
            else
            {
        ...
        public static ulong3 bitfield(ushort3 x0, ushort3 x1, ushort3 x2, ushort3 x3)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 resultlo = Sse2.unpacklo_epi32(x01, x23);
                v128 resulthi = Sse2.unpackhi_epi32(x01, x23);
        ...
        public static ulong2 bitfield(uint2 x0, uint2 x1)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.unpacklo_epi32(RegisterConversion.ToV128(x0), RegisterConversion.ToV128(x1)); 
            }
            else
            {
        ...
        public static ulong3 bitfield(uint3 x0, uint3 x1)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                v128 resultlo = Sse2.unpacklo_epi32(_x0, _x1);
                v128 resulthi = Sse2.unpackhi_epi32(_x0, _x1);

...
namespace MaxMath
{
    namespace Intrinsics
    {
        unsafe public static partial class Xse
        {
            ...
            public static v128 blsmsk_epi16(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return xor_si128(a, dec_epi16(a));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsmsk_epi32(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return xor_si128(a, dec_epi32(a));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsmsk_epi64(v128 a)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    return xor_si128(a, dec_epi64(a));
                }
                else throw new IllegalInstructionException();
            }
    ...
    {
        /// <summary>       Sets all the low order bits up to and including the lowest set bit in <paramref name="x"/> to 1 and the remaining bits to 0.     </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Sets all the componentwise low order bits up to and including the lowest set bits in each <paramref name="x"/> component to 1 and the remaining bits to 0.     </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

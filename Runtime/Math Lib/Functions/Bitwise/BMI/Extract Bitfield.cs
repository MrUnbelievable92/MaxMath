        ...
        unsafe public static partial class Xse
        {
            ...
            public static v128 bextr_epi8(v128 a, v128 index, v128 length, byte elements = 16)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return Sse2.and_si128(srlv_epi8(a, index, elements), Sse2.sub_epi8(sllv_epi8(ONE, length, elements), ONE));
                }
            ...
            public static v128 bextr_epi16(v128 a, v128 index, v128 length, byte elements = 8)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return Sse2.and_si128(srlv_epi16(a, index, elements), Sse2.sub_epi16(sllv_epi16(ONE, length, elements), ONE));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 bextr_epi32(v128 a, v128 index, v128 length, byte elements = 4)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return Sse2.and_si128(srlv_epi32(a, index, elements), Sse2.sub_epi32(sllv_epi32(ONE, length, elements), ONE));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 bextr_epi64(v128 a, v128 index, v128 length)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return Sse2.and_si128(srlv_epi64(a, index), Sse2.sub_epi64(sllv_epi64(ONE, length), ONE));
                }
                else throw new IllegalInstructionException();
            }

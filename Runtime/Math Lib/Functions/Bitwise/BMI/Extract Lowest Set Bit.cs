...
namespace MaxMath
{
        ...
        unsafe public static partial class Xse
        {
            ...
            public static v128 blsi_epi8(v128 a)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return ternarylogic_si128(a, ALL_ONES, Sse2.add_epi8(a, ALL_ONES), TernaryOperation.Ox6O);
                }
            ...
            public static v128 blsi_epi16(v128 a)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return ternarylogic_si128(a, ALL_ONES, Sse2.add_epi16(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsi_epi32(v128 a)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return ternarylogic_si128(a, ALL_ONES, Sse2.add_epi32(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 blsi_epi64(v128 a)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return ternarylogic_si128(a, ALL_ONES, Sse2.add_epi64(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_blsi_epi8(v256 a)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    return mm256_ternarylogic_si256(a, ALL_ONES, Avx2.mm256_add_epi8(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_blsi_epi16(v256 a)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    return mm256_ternarylogic_si256(a, ALL_ONES, Avx2.mm256_add_epi16(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_blsi_epi32(v256 a)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    return mm256_ternarylogic_si256(a, ALL_ONES, Avx2.mm256_add_epi32(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_blsi_epi64(v256 a)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    return mm256_ternarylogic_si256(a, ALL_ONES, Avx2.mm256_add_epi64(a, ALL_ONES), TernaryOperation.Ox6O);
                }
                else throw new IllegalInstructionException();
            }
        }
    ...
    unsafe public static partial class maxmath
    {
        ...
        /// <summary>       Isolates the lowest set bit in each <paramref name="x"/> component.     </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public static uint2 bits_extractlowest(uint2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint2>(Xse.blsi_epi32(RegisterConversion.ToV128(x)));
            }
            else
            {
        ...
        public static uint3 bits_extractlowest(uint3 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint3>(Xse.blsi_epi32(RegisterConversion.ToV128(x)));
            }
            else
            {
        ...
        public static uint4 bits_extractlowest(uint4 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint4>(Xse.blsi_epi32(RegisterConversion.ToV128(x)));
            }
            else
            {

            ...
            public static void vminmax_epi8(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 16:
                        {
                            vmin = min_epi8(vmin, bsrli_si128(vmin, 4 * sizeof(byte)));
                            vmax = max_epi8(vmax, bsrli_si128(vmax, 4 * sizeof(byte)));
                            vmin = min_epi8(vmin, bsrli_si128(vmin, 2 * sizeof(byte)));
                            vmax = max_epi8(vmax, bsrli_si128(vmax, 2 * sizeof(byte)));
                            vmin = min_epi8(vmin, bsrli_si128(vmin, 1 * sizeof(byte)));
                            vmax = max_epi8(vmax, bsrli_si128(vmax, 1 * sizeof(byte)));
            ...
            public static void vminmax_epi16(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 8)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 8:
                        {
                            vmin = min_epi16(vmin, bsrli_si128(vmin, 2 * sizeof(short)));
                            vmax = max_epi16(vmax, bsrli_si128(vmax, 2 * sizeof(short)));
                            vmin = min_epi16(vmin, bsrli_si128(vmin, 1 * sizeof(short)));
                            vmax = max_epi16(vmax, bsrli_si128(vmax, 1 * sizeof(short)));
                        ...
                        case 3:
                        {
                            a = bsrli_si128(a, 2 * sizeof(short));
                            vmin = min_epi16(vmin, a);
                            vmax = max_epi16(vmax, a);
            ...
            public static void vminmax_epi32(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 4:
                        {
                            vmin = min_epi32(vmin, bsrli_si128(vmin, 1 * sizeof(int)));
                            vmax = max_epi32(vmax, bsrli_si128(vmax, 1 * sizeof(int)));

                            return;
                        }
                        case 3:
                        {
                            a = bsrli_si128(a, 2 * sizeof(int));
            ...
            public static void vminmax_epu8(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 16:
                        {
                            vmin = min_epu8(vmin, bsrli_si128(vmin, 4 * sizeof(byte)));
                            vmax = max_epu8(vmax, bsrli_si128(vmax, 4 * sizeof(byte)));
                            vmin = min_epu8(vmin, bsrli_si128(vmin, 2 * sizeof(byte)));
                            vmax = max_epu8(vmax, bsrli_si128(vmax, 2 * sizeof(byte)));
                            vmin = min_epu8(vmin, bsrli_si128(vmin, 1 * sizeof(byte)));
                            vmax = max_epu8(vmax, bsrli_si128(vmax, 1 * sizeof(byte)));
                        ...
                        {
                            a = bsrli_si128(a, 2 * sizeof(byte));
                            vmin = min_epu8(vmin, a);
                            vmax = max_epu8(vmax, a);
            ...
            public static void vminmax_epu16(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 8)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 8:
                        {
                            vmin = min_epu16(vmin, bsrli_si128(vmin, 2 * sizeof(short)));
                            vmax = max_epu16(vmax, bsrli_si128(vmax, 2 * sizeof(short)));
                            vmin = min_epu16(vmin, bsrli_si128(vmin, 1 * sizeof(short)));
                            vmax = max_epu16(vmax, bsrli_si128(vmax, 1 * sizeof(short)));
            ...
            public static void vminmax_epu32(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 4:
                        {
                            vmin = min_epu32(vmin, bsrli_si128(vmin, 1 * sizeof(int)));
                            vmax = max_epu32(vmax, bsrli_si128(vmax, 1 * sizeof(int)));
            ...
            public static void vminmax_ps(v128 a, [NoAlias] out v128 vmin, [NoAlias] out v128 vmax, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    switch (elements)
                    {
                        case 4:
                        {
                            vmin = min_ps(vmin, bsrli_si128(vmin, 1 * sizeof(float)));
                            vmax = max_ps(vmax, bsrli_si128(vmax, 1 * sizeof(float)));

                            return;
                        }
                        case 3:
                        {
                            a = bsrli_si128(a, 2 * sizeof(float));
                            vmin = min_ps(vmin, a);
                            vmax = max_ps(vmax, a);
    ...
    unsafe public static partial class maxmath
    {
        ...
        public static void cminmax(byte32 a, [NoAlias] out byte min, [NoAlias] out byte max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epu8(_min.Lo128, _min.Hi128).Byte0;
                max = Xse.max_epu8(_max.Lo128, _max.Hi128).Byte0;
            }
            else
            {
        ...
        public static void cminmax(sbyte32 a, [NoAlias] out sbyte min, [NoAlias] out sbyte max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epi8(_min.Lo128, _min.Hi128).SByte0;
                max = Xse.max_epi8(_max.Lo128, _max.Hi128).SByte0;
            }
            else
            {
        ...
        public static void cminmax(ushort16 a, [NoAlias] out ushort min, [NoAlias] out ushort max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epu16(_min.Lo128, _min.Hi128).UShort0;
                max = Xse.max_epu16(_max.Lo128, _max.Hi128).UShort0;
            }
            else
            {
        ...
        public static void cminmax(short16 a, [NoAlias] out short min, [NoAlias] out short max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epi16(_min.Lo128, _min.Hi128).SShort0;
                max = Xse.max_epi16(_max.Lo128, _max.Hi128).SShort0;
            }
            else
            {
        ...
        public static void cminmax(int8 a, [NoAlias] out int min, [NoAlias] out int max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epi32(_min.Lo128, _min.Hi128).SInt0;
                max = Xse.max_epi32(_max.Lo128, _max.Hi128).SInt0;
            }
            else
            {
        ...
        public static void cminmax(uint8 a, [NoAlias] out uint min, [NoAlias] out uint max)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                min = Xse.min_epu32(_min.Lo128, _min.Hi128).UInt0;
                max = Xse.max_epu32(_max.Lo128, _max.Hi128).UInt0;
            }
            else
            {

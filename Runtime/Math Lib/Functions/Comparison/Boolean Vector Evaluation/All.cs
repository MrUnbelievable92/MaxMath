...
Assert.IsSafeBoolean(x.x7);
        ...
        public static bool all(bool16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return maxmath.bitmask32(16) == Sse2.movemask_epi8(Xse.neg_epi8(x));
            }
            else
            {
        ...
        public static bool all(bool32 x)
        {
            ...
            {
                return uint.MaxValue == (uint)Avx2.mm256_movemask_epi8(Xse.mm256_neg_epi8(x));
            }
            else
            {
        ...
        public static bool all(byte2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.extract_epi16(Sse2.cmpeq_epi8(x, Sse2.setzero_si128()), 0);
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(byte3 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == (bitmask32(24) & Sse2.cmpeq_epi8(x, Sse2.setzero_si128()).UInt0);
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(byte4 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.cmpeq_epi8(x, Sse2.setzero_si128()).UInt0;
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(byte8 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.cmpeq_epi8(x, Sse2.setzero_si128()).ULong0;
            }
            else
            {
                return all(x != 0);
        ...
        public static bool all(byte16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.movemask_epi8(Sse2.cmpeq_epi8(x, Sse2.setzero_si128()));
            }
            else
            {
                return all(x != 0);
        ...
        public static bool all(byte32 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return 0 == Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi8(x, Avx.mm256_setzero_si256()));
            }
            else
            {
                return all(x.v16_0) & all(x.v16_16);
        ...
        public static bool all(short2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.cmpeq_epi16(x, Sse2.setzero_si128()).UInt0;
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(short3 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == (bitmask64(48ul) & Sse2.cmpeq_epi16(x, Sse2.setzero_si128()).ULong0);
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(short4 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.cmpeq_epi16(x, Sse2.setzero_si128()).ULong0;
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(short8 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.movemask_epi8(Sse2.cmpeq_epi16(x, Sse2.setzero_si128()));
            }
            else
            {
                return all(x != 0);
        ...
        public static bool all(short16 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return 0 == Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi16(x, Avx.mm256_setzero_si256()));
            }
            else
            {
                return all(x.v8_0) & all(x.v8_8);
        ...
        public static bool all(int8 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return 0 == Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi32(x, Avx.mm256_setzero_si256()));
            }
            else
            {
        ...
        public static bool all(long2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return 0 == Sse2.movemask_epi8(Xse.cmpeq_epi64(x, Sse2.setzero_si128()));
            }
            else
            {
                return math.all(x != 0);
        ...
        public static bool all(long3 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return 0 == (bitmask32(3 * sizeof(long)) & Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi64(x, Avx.mm256_setzero_si256())));
            }
            else
            {
        ...
        public static bool all(long4 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return 0 == Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi64(x, Avx.mm256_setzero_si256()));
            }
            else
            {
        ...
        public static bool all(float8 x)
        {
            ...
            {
                return 0 == Avx.mm256_movemask_ps(Avx.mm256_cmp_ps(x, Avx.mm256_setzero_ps(), (int)Avx.CMP.EQ_OQ));
            }
            else
            {
                return math.all(x.v4_0) & math.all(x.v4_4);

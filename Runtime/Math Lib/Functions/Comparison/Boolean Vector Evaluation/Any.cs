...
Assert.IsSafeBoolean(x.x7);
        ...
        public static bool any(bool16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.movemask_epi8(Xse.neg_epi8(x)) != 0;
            }
            else
            {
        ...
        public static bool any(bool32 x)
        {
            ...
            {
                return 0 != Avx2.mm256_movemask_epi8(Xse.mm256_neg_epi8(x));
            }
            else
            {
        ...
        public static bool any(byte16 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return bitmask32(16 * sizeof(byte)) != Sse2.movemask_epi8(Sse2.cmpeq_epi8(x, Sse2.setzero_si128()));
            }
            else
            {
                return any(x != 0);
        ...
        public static bool any(byte32 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return -1 != Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi8(x, Avx.mm256_setzero_si256()));
            }
            else
            {
                return any(x.v16_0) & any(x.v16_16);
        ...
        public static bool any(short8 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return bitmask32(8 * sizeof(short)) != Sse2.movemask_epi8(Sse2.cmpeq_epi16(x, Sse2.setzero_si128()));
            }
            else
            {
                return any(x != 0);
        ...
        public static bool any(short16 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return -1 != Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi16(x, Avx.mm256_setzero_si256()));
            }
            else
            {
                return any(x.v8_0) & any(x.v8_8);
        ...
        public static bool any(int8 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return bitmask32(8 * sizeof(int)) != Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi32(x, Avx.mm256_setzero_si256()));
            }
            else
            {
        ...
        public static bool any(long2 x)
        {
            if (Sse2.IsSse2Supported)
            {
                return bitmask32(2 * sizeof(long)) != Sse2.movemask_epi8(Xse.cmpeq_epi64(x, Sse2.setzero_si128()));
            }
            else
            {
                return math.any(x != 0);
        ...
        public static bool any(long3 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return bitmask32(3 * sizeof(long)) != (bitmask32(3 * sizeof(long)) & Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi64(x, Avx.mm256_setzero_si256())));
            }
            else
            {
        ...
        public static bool any(long4 x)
        {
            if (Avx2.IsAvx2Supported)
            {
                return bitmask32(4 * sizeof(long)) != Avx2.mm256_movemask_epi8(Avx2.mm256_cmpeq_epi64(x, Avx.mm256_setzero_si256()));
            }
            else
            {
        ...
        public static bool any(float8 x)
        {
            ...
            {
                return bitmask32(8) != Avx.mm256_movemask_ps(Avx.mm256_cmp_ps(x, Avx.mm256_setzero_ps(), (int)Avx.CMP.EQ_OQ));
            }
            else
            {
                return math.any(x.v4_0) | math.any(x.v4_4);

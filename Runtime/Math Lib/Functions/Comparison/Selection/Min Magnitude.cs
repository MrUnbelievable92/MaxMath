...
namespace MaxMath
{
                ...
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    else
                    {
                        if (Ssse3.IsSsse3Supported)
                        {
                            ...
                            return blendv_si128(min, max, or_si128(cmpgt_epi32(minAbs, maxAbs), srai_epi32(minAbs, 31)));
                        }
                        else
                        {
                            if (elements == 2)
            ...
            public static v256 mm256_minmag_epi32(v256 a, v256 b, bool promiseNoOverflow = false)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    else
                    {
                        ...
                        return mm256_blendv_si256(min, max, Avx2.mm256_or_si256(Avx2.mm256_cmpgt_epi32(minAbs, maxAbs), Avx2.mm256_srai_epi32(minAbs, 31)));
                    }
                }
                else throw new IllegalInstructionException();
            }
    ...
    unsafe public static partial class math
    {
        ...
        public static int minmag(int a, int b)
        {
            ...
            {
                return abs((long)a) > abs((long)b) ? b : a;
            }
        }
        ...
        public static int2 minmag(int2 a, int2 b, Promise noOverFlow = Promise.Nothing)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.minmag_epi32(a, b, noOverFlow.Promises(Promise.NoOverflow), 2);
            }
            else
            {
        ...
        public static int3 minmag(int3 a, int3 b, Promise noOverFlow = Promise.Nothing)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.minmag_epi32(a, b, noOverFlow.Promises(Promise.NoOverflow), 3);
            }
            else
            {
        ...
        public static int4 minmag(int4 a, int4 b, Promise noOverFlow = Promise.Nothing)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.minmag_epi32(a, b, noOverFlow.Promises(Promise.NoOverflow), 4);
            }
            else
            {
        ...
        public static float minmag(float a, float b)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.minmag_ps(Xse.set_ss(a), Xse.set_ss(b), 1).Float0;
            }
            else
            {
                return abs(a) > abs(b) ? b : a;
        ...
        public static double minmag(double a, double b)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.minmag_pd(Xse.set_sd(a), Xse.set_sd(b)).Double0;
            }
            else
            {
                return abs(a) > abs(b) ? b : a;
        ...
        public static double3 minmag(double3 a, double3 b)
        {
            if (Avx.IsAvxSupported)
            {
                return Xse.mm256_minmag_pd(a, b, 3);
            }
            else
            {
        ...
        public static double4 minmag(double4 a, double4 b)
        {
            if (Avx.IsAvxSupported)
            {
                return Xse.mm256_minmag_pd(a, b, 4);
            }
            else
            {

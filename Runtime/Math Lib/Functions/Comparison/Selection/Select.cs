...
namespace MaxMath
{
    unsafe public static partial class math
    {
        ...
        {
            return new UInt128(select(a.lo64, b.lo64, c), select(a.hi64, b.hi64, c));
        }
        ...
        public static int2 select(int2 a, int2 b, int c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_si128(a, b, Xse.broadcastmask_epi32(c, MaskType.AllOnes));
            }
            else
            {
                return select(a, b, tobool(1 & new int2(c, (int)((uint)c >> 1))));
            }
        }
        ...
        public static int3 select(int3 a, int3 b, int c)
        {
            ...
            {
                return select(a, b, tobool(1 & new int3(c, (int)((uint)c >> 1), (int)((uint)c >> 2))));
            }
        }
        ...
        public static int4 select(int4 a, int4 b, int c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_si128(a, b, Xse.broadcastmask_epi32(c));
            }
            else
            {
                return select(a, b, tobool(1 & new int4(c, (int)((uint)c >> 1), (int)((uint)c >> 2), (int)((uint)c >> 3))));
            }
        }
        ...
        public static float2 select(float2 a, float2 b, int c)
        {
            if (Sse4_1.IsSse41Supported)
            {
                return Xse.blendv_ps(a, b, Xse.broadcastmask_epi32(c, MaskType.SignBit));
            }
            else if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_si128(a, b, Xse.broadcastmask_epi32(c, MaskType.AllOnes));
        ...
        public static float3 select(float3 a, float3 b, int c)
        {
            ...
            {
                return Xse.blendv_ps(a, b, Xse.broadcastmask_epi32(c, MaskType.AllOnes));
            }
            else
            {
                return select(a, b, tobool(1 & new int3(c, (int)((uint)c >> 1), (int)((uint)c >> 2))));
        ...
        public static int8 select(int8 a, int8 b, bool8 c)
        {
            ...
            {
                return new int8(select(a.v4_0, b.v4_0, c.v4_0), select(a.v4_4, b.v4_4, c.v4_4));
            }
        }
        ...
        public static long2 select(long2 a, long2 b, bool2 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_si128(a, b, Xse.cvtepi8_epi64(Xse.neg_epi8(c)));
            }
            else
            {
        ...
        public static long3 select(long3 a, long3 b, bool3 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Xse.mm256_blendv_si256(a, b, Avx2.mm256_cvtepi8_epi64(Xse.neg_epi8(c)));
            }
            else
            {
        ...
        public static float8 select(float8 a, float8 b, bool8 c)
        {
            ...
            {
                return new float8(select(a.v4_0, b.v4_0, c.v4_0), select(a.v4_4, b.v4_4, c.v4_4));
            }
        }
        ...
        public static byte32 select(byte32 a, byte32 b, mask8x32 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Xse.mm256_blendv_si256(a, b, c);
            }
            else
            {
                return new byte32(select(a.v16_0, b.v16_0, c.v16_0), select(a.v16_16, b.v16_16, c.v16_16));
        ...
        public static int2 select(int2 a, int2 b, mask32x2 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_ps(a, b, c);
            }
            else
            {
                return new int2(select(a.x, b.x, c.x), select(a.y, b.y, c.y));
            }
        }
        ...
        public static int3 select(int3 a, int3 b, mask32x3 c)
        {
            ...
            {
                return new int3(select(a.x, b.x, c.x), select(a.y, b.y, c.y), select(a.z, b.z, c.z));
            }
        }
        ...
        public static int4 select(int4 a, int4 b, mask32x4 c)
        {
            ...
            {
                return new int4(select(a.x, b.x, c.x), select(a.y, b.y, c.y), select(a.z, b.z, c.z), select(a.w, b.w, c.w));
            }
        }
        ...
        public static float2 select(float2 a, float2 b, mask32x2 c)
        {
            ...
            {
                return new float2(select(a.x, b.x, c.x), select(a.y, b.y, c.y));
            }
        }
        ...
        public static float3 select(float3 a, float3 b, mask32x3 c)
        {
            ...
            {
                return new float3(select(a.x, b.x, c.x), select(a.y, b.y, c.y), select(a.z, b.z, c.z));
            }
        }
        ...
        public static float4 select(float4 a, float4 b, mask32x4 c)
        {
            ...
            {
                return new float4(select(a.x, b.x, c.x), select(a.y, b.y, c.y), select(a.z, b.z, c.z), select(a.w, b.w, c.w));
            }
        }
        ...
        public static long2 select(long2 a, long2 b, mask64x2 c)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.blendv_pd(a, b, c);
            }
            else
            {
                return new long2(select(a.x, b.x, c.x), select(a.y, b.y, c.y));
            }
        }
        ...
        public static long3 select(long3 a, long3 b, mask64x3 c)
        {
            ...
            {
                return new long3(select(a.xy, b.xy, c.xy), select(a.z, b.z, c.z));
            }
        }
        ...
        public static double2 select(double2 a, double2 b, mask64x2 c)
        {
            ...
            {
                return new double2(select(a.x, b.x, c.x), select(a.y, b.y, c.y));
            }
        }
        ...
        public static double3 select(double3 a, double3 b, mask64x3 c)
        {
            ...
            {
                return new double3(select(a.xy, b.xy, c.xy), select(a.z, b.z, c.z));
            }
        }

...
namespace MaxMath
{
        ...
        unsafe public static partial class Xse
        {
            ...
            public static v128 maxmag_epi8(v128 a, v128 b, byte elements = 16)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    {
                        return Sse4_1.blendv_epi8(max, min, cmp);
                    }
                    else
                    {
                        return blendv_si128(max, min, Sse2.cmpgt_epi8(Sse2.setzero_si128(), cmp));
                    }
                }
            ...
            public static v128 maxmag_epi16(v128 a, v128 b, byte elements = 8)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    return blendv_si128(max, min, Sse2.srai_epi16(cmp, 15));
                }
                else throw new IllegalInstructionException();
            }
                ...
                if (Sse2.IsSse2Supported)
                {
                    ...
                    else
                    {
                        if (Ssse3.IsSsse3Supported)
                        {
                            ...
                            return blendv_si128(min, max, Sse2.cmpgt_epi32(maxAbs, minAbs));
                        }
                        else
                        {
                            if (elements == 2)
                    ...
                    if (Sse4_1.IsSse41Supported)
                    {
                        return Sse4_1.blendv_ps(max, min, cmp);
                    }
                    else
                    {
                        return blendv_si128(max, min, Sse2.srai_epi32(cmp, 31));
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 maxmag_epi64(v128 a, v128 b, bool promiseNoOverflow = false)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    if (Sse4_1.IsSse41Supported)
                    {
                        return Sse4_1.blendv_pd(max, min, cmp);
                    }
                    else
                    {
                        return blendv_si128(max, min, srai_epi64(cmp, 63));
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 maxmag_ps(v128 a, v128 b, byte elements = 4)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    {
                        return blendv_ps(max, min, Sse2.srai_epi32(cmp, 31));
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 maxmag_pd(v128 a, v128 b)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    {
                        return blendv_ps(max, min, srai_epi64(cmp, 63));
                    }
                }
                else throw new IllegalInstructionException();
            }
    ...
    unsafe public static partial class maxmath
    {
        ...
        public static int2 maxmag(int2 a, int2 b, Promise noOverFlow = Promise.Nothing)
        {
            ...
            {
                return math.select(b, a, math.abs(a) > math.abs(b));
            }
            else
            {
        ...
        /// <summary>       Returns the componentwise maximum of two <see cref="MaxMath.int8"/>s with regard to their magnitude. If abs(<paramref name="a"/>) is equal to abs(<paramref name="b"/>) for a component, the sign of the return value is undefined for that component.    </summary>
        /// <remarks>       A <see cref="Promise"/> '<paramref name="noOverflow"/>' with its <see cref="Promise.NoOverflow"/> flag set returns undefined results for any <paramref name="a"/> + <paramref name="b"/> component pair that overflows.    </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the componentwise maximum of two <see cref="MaxMath.long2"/>s with regard to their magnitude. If abs(<paramref name="a"/>) is equal to abs(<paramref name="b"/>) for a component, the sign of the return value is undefined for that component.    </summary>
        /// <remarks>       A <see cref="Promise"/> '<paramref name="noOverflow"/>' with its <see cref="Promise.NoOverflow"/> flag set returns undefined results for any <paramref name="a"/> + <paramref name="b"/> component pair that overflows.    </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the componentwise maximum of two <see cref="MaxMath.long3"/>s with regard to their magnitude. If abs(<paramref name="a"/>) is equal to abs(<paramref name="b"/>) for a component, the sign of the return value is undefined for that component.    </summary>
        /// <remarks>       A <see cref="Promise"/> '<paramref name="noOverflow"/>' with its <see cref="Promise.NoOverflow"/> flag set returns undefined results for any <paramref name="a"/> + <paramref name="b"/> component pair that overflows.    </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the componentwise maximum of two <see cref="MaxMath.long4"/>s with regard to their magnitude. If abs(<paramref name="a"/>) is equal to abs(<paramref name="b"/>) for a component, the sign of the return value is undefined for that component.    </summary>
        /// <remarks>       A <see cref="Promise"/> '<paramref name="noOverflow"/>' with its <see cref="Promise.NoOverflow"/> flag set returns undefined results for any <paramref name="a"/> + <paramref name="b"/> component pair that overflows.    </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

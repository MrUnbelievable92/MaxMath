...
namespace MaxMath
{
    unsafe public static partial class math
    {
        ...
        [Obsolete("This function was superceded by the '/' operator and will be removed in a subsequent release.")]
        ...
        public static uint2 div(uint2 dividend, uint2 divisor)
        {
            ...
            {
                return Xse.div_epu32(dividend, divisor, 2);
            }
            else
            {
        ...
        public static uint3 div(uint3 dividend, uint3 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.div_epu32(dividend, divisor, 3);
            }
            else
            {
                return dividend / divisor;
        ...
        public static uint4 div(uint4 dividend, uint4 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.div_epu32(dividend, divisor, 4);
            }
            else
            {
                return dividend / divisor;
        ...
        public static int2 div(int2 dividend, int2 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.div_epi32(dividend, divisor, 2);
            }
            else
            {
                return dividend / divisor;
        ...
        public static int3 div(int3 dividend, int3 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.div_epi32(dividend, divisor, 3);
            }
            else
            {
                return dividend / divisor;
        ...
        public static int4 div(int4 dividend, int4 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.div_epi32(dividend, divisor, 4);
            }
            else
            {
                return dividend / divisor;
        ...
        public static uint2 mod(uint2 dividend, uint2 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epu32(dividend, divisor, 2);
            }
            else
            {
                return dividend % divisor;
        ...
        public static uint3 mod(uint3 dividend, uint3 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epu32(dividend, divisor, 3);
            }
            else
            {
                return dividend % divisor;
        ...
        public static uint4 mod(uint4 dividend, uint4 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epu32(dividend, divisor, 4);
            }
            else
            {
                return dividend % divisor;
        ...
        public static int2 mod(int2 dividend, int2 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epi32(dividend, divisor, 2);
            }
            else
            {
                return dividend % divisor;
        ...
        public static int3 mod(int3 dividend, int3 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epi32(dividend, divisor, 3);
            }
            else
            {
                return dividend % divisor;
        ...
        public static int4 mod(int4 dividend, int4 divisor)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.rem_epi32(dividend, divisor, 4);
            }
            else
            {
                return dividend % divisor;

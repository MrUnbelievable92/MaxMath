...
namespace MaxMath
{
    ...
    unsafe public static partial class maxmath
    {
        ...
        public static float2 msubadd(float2 a, float2 b, float2 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return RegisterConversion.ToType<float2>(Xse.fmaddsub_ps(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c)));
            }
            else
            {
                return subadd(a * b, c);
        ...
        public static float3 msubadd(float3 a, float3 b, float3 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return RegisterConversion.ToType<float3>(Xse.fmaddsub_ps(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c)));
            }
            else
            {
                return subadd(a * b, c);
        ...
        public static float4 msubadd(float4 a, float4 b, float4 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return RegisterConversion.ToType<float4>(Xse.fmaddsub_ps(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c)));
            }
            else
            {
                return subadd(a * b, c);
        ...
        public static double2 msubadd(double2 a, double2 b, double2 c)
        {
            if (Avx2.IsAvx2Supported)
            {
                return RegisterConversion.ToType<double2>(Xse.fmaddsub_pd(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c)));
            }
            else
            {
                return subadd(a * b, c);
        ...
        public static double3 msubadd(double3 a, double3 b, double3 c)
        {
            if (Avx.IsAvxSupported)
            {
                return RegisterConversion.ToType<double3>(Xse.mm256_fmaddsub_pd(RegisterConversion.ToV256(a), RegisterConversion.ToV256(b), RegisterConversion.ToV256(c)));
            }
            else
            {
        ...
        public static double4 msubadd(double4 a, double4 b, double4 c)
        {
            if (Avx.IsAvxSupported)
            {
                return RegisterConversion.ToType<double4>(Xse.mm256_fmaddsub_pd(RegisterConversion.ToV256(a), RegisterConversion.ToV256(b), RegisterConversion.ToV256(c)));
            }
            else
            {
        ...
        public static uint2 msubadd(uint2 a, uint2 b, uint2 c)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint2>(Xse.fmaddsub_epi32(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c), 2));
            }
            else
            {
        ...
        public static uint3 msubadd(uint3 a, uint3 b, uint3 c)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint3>(Xse.fmaddsub_epi32(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c), 3));
            }
            else
            {
        ...
        public static uint4 msubadd(uint4 a, uint4 b, uint4 c)
        {
            if (Sse2.IsSse2Supported)
            {
                return RegisterConversion.ToType<uint4>(Xse.fmaddsub_epi32(RegisterConversion.ToV128(a), RegisterConversion.ToV128(b), RegisterConversion.ToV128(c), 4));
            }
            else
            {

...
namespace MaxMath
{
        ...
        unsafe public static partial class Xse
        {
            ...
            public static v128 toward_epu8(v128 a, v128 b, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi8(a, cmp_epu8(a, b, elements));
                }
            ...
            public static v128 toward_epu16(v128 a, v128 b, byte elements = 8)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi16(a, cmp_epu16(a, b, elements));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epu32(v128 a, v128 b, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi32(a, cmp_epu32(a, b, elements));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epu64(v128 a, v128 b)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi64(a, cmp_epu64(a, b));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epi8(v128 a, v128 b, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi8(a, cmp_epi8(a, b));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epi16(v128 a, v128 b, byte elements = 8)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi16(a, cmp_epi16(a, b));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epi32(v128 a, v128 b, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi32(a, cmp_epi32(a, b));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_epi64(v128 a, v128 b)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    return sub_epi64(a, cmp_epi64(a, b));
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_pq(v128 a, v128 b, bool promiseNonZero = false, bool promisePositive = false, bool promiseNegative = false, bool promiseNotNanInf = false, byte elements = 16)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    v128 isGreater = cmpgt_pq(a, b, promiseNeitherNaN: promiseNotNanInf, promiseNeitherZero: promiseNonZero && constexpr.ALL_NEQ_EPU8(b, 0, elements) && constexpr.ALL_NEQ_EPU8(b, 0b1000_0000, elements), elements: elements);
                    v128 areDifferent = cmpneq_pq(a, b, promiseNeitherNaN: promiseNotNanInf, promiseNeitherZero: promiseNonZero && constexpr.ALL_NEQ_EPU8(b, 0, elements) && constexpr.ALL_NEQ_EPU8(b, 0b1000_0000, elements), elements: elements);
                    v128 summand;
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            v128 xInfinite = cmpeq_epi8(SIGNALING_EXPONENT, and_si128(SIGNALING_EXPONENT, a));
                            v128 eitherNaN = cmpunord_pq(a, b, elements);

                            summand = ternarylogic_si128(eitherNaN, xInfinite, summand, TernaryOperation.OxO2);
                            a = or_si128(a, eitherNaN);
                        }
                    }
                    else
                    {
                        v128 NEGATIVE_ZERO = set1_epi8(1 << 7);
                        v128 IF_ZERO = set1_epi8(0x82);

                        v128 isNegativeZero = cmpeq_epi8(NEGATIVE_ZERO, a);
                        v128 isPositiveZero = cmpeq_epi8(setzero_si128(), a);
                    ...
                    if (promisePositive)
                    {
                        return sub_epi8(add_epi8(a, isGreater), summand);
                    }
                    else
                    {
                        return add_epi8(sub_epi8(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
                ...
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            v128 xInfinite = cmpeq_epi16(SIGNALING_EXPONENT, and_si128(SIGNALING_EXPONENT, a));
                    ...
                    else
                    {
                        ...
                        v128 IF_ZERO = set1_epi16(0x8002);

                        v128 isNegativeZero = cmpeq_epi16(NEGATIVE_ZERO, a);
                        v128 isPositiveZero = cmpeq_epi16(setzero_si128(), a);
                        v128 zeroMask = ternarylogic_si128(isNegativeZero, isPositiveZero, isGreater, TernaryOperation.Ox87);

                        summand = ternarylogic_si128(ONE, srai_epi16(a, 15), zeroMask, TernaryOperation.OxF8);
                        v128 aPart0 = ternarylogic_si128(a, isGreater, zeroMask,  TernaryOperation.OxEO);
                        v128 aPart1 = ternarylogic_si128(zeroMask, IF_ZERO, isGreater, TernaryOperation.OxO8);
                    ...
                    if (promisePositive)
                    {
                        return sub_epi16(add_epi16(a, isGreater), summand);
                    }
                    else
                    {
                        return add_epi16(sub_epi16(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_ps(v128 a, v128 b, bool promiseNonZero = false, bool promisePositive = false, bool promiseNegative = false, bool promiseNotNanInf = false, byte elements = 4)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    v128 isGreater = cmpgt_ps(a, b);
                    v128 areDifferent = cmpneq_ps(a, b);
                    v128 summand;
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            v128 xInfinite = cmpeq_epi32(SIGNALING_EXPONENT, and_si128(SIGNALING_EXPONENT, a));
                            v128 eitherNaN = cmpunord_ps(a, b);
                    ...
                    else
                    {
                        ...
                        v128 IF_ZERO = set1_epi32(0x8000_0002u);

                        v128 isNegativeZero = cmpeq_epi32(NEGATIVE_ZERO, a);
                        v128 isPositiveZero = cmpeq_epi32(setzero_si128(), a);
                        v128 zeroMask = ternarylogic_si128(isNegativeZero, isPositiveZero, isGreater, TernaryOperation.Ox87);

                        summand = ternarylogic_si128(ONE, srai_epi32(a, 31), zeroMask, TernaryOperation.OxF8);
                        v128 aPart0 = ternarylogic_si128(a, isGreater, zeroMask,  TernaryOperation.OxEO);
                        v128 aPart1 = ternarylogic_si128(zeroMask, IF_ZERO, isGreater, TernaryOperation.OxO8);
                    ...
                    if (promisePositive)
                    {
                        return sub_epi32(add_epi32(a, isGreater), summand);
                    }
                    else
                    {
                        return add_epi32(sub_epi32(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_toward_ps(v256 a, v256 b, bool promiseNonZero = false, bool promisePositive = false, bool promiseNegative = false, bool promiseNotNanInf = false)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    v256 isGreater = mm256_cmpgt_ps(a, b);
                    v256 areDifferent = mm256_cmpneq_ps(a, b);
                    v256 summand;
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            v256 eitherNaN = mm256_cmpunord_ps(a, b);
                    ...
                    {
                        v256 NEGATIVE_ZERO = mm256_set1_epi32(1u << 31);
                        v256 IF_ZERO = mm256_set1_epi32(0x8000_0002u);
                    ...
                    if (promisePositive)
                    {
                        return Avx2.mm256_sub_epi32(Avx2.mm256_add_epi32(a, isGreater), summand);
                    }
                    else
                    {
                        return Avx2.mm256_add_epi32(Avx2.mm256_sub_epi32(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 toward_pd(v128 a, v128 b, bool promiseNonZero = false, bool promisePositive = false, bool promiseNegative = false, bool promiseNotNanInf = false)
            {
                if (BurstArchitecture.IsSIMDSupported)
                {
                    ...
                    v128 isGreater = cmpgt_pd(a, b);
                    v128 areDifferent = cmpneq_pd(a, b);
                    v128 summand;
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            {
                                xInfinite = shuffle_epi32(cmpeq_epi32(SIGNALING_EXPONENT, and_si128(SIGNALING_EXPONENT, a)), Sse.SHUFFLE(3, 3, 1, 1));
                            }

                            v128 eitherNaN = cmpunord_pd(a, b);
                    ...
                    {
                        v128 NEGATIVE_ZERO = set1_epi64x(1ul << 63);
                        v128 IF_ZERO = set1_epi64x(0x8000_0000_0000_0002ul);

                        v128 isNegativeZero = cmpeq_epi64(NEGATIVE_ZERO, a);
                        v128 isPositiveZero = cmpeq_epi64(setzero_si128(), a);
                        v128 zeroMask = ternarylogic_si128(isNegativeZero, isPositiveZero, isGreater, TernaryOperation.Ox87);
                    ...
                    if (promisePositive)
                    {
                        return sub_epi64(add_epi64(a, isGreater), summand);
                    }
                    else
                    {
                        return add_epi64(sub_epi64(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v256 mm256_toward_pd(v256 a, v256 b, bool promiseNonZero = false, bool promisePositive = false, bool promiseNegative = false, bool promiseNotNanInf = false, byte elements = 4)
            {
                if (Avx2.IsAvx2Supported)
                {
                    ...
                    v256 isGreater = mm256_cmpgt_pd(a, b);
                    v256 areDifferent = mm256_cmpneq_pd(a, b);
                    v256 summand;
                    ...
                    if (promiseNonZero)
                    {
                        ...
                        if (!promiseNotNanInf)
                        {
                            ...
                            v256 eitherNaN = mm256_cmpunord_pd(a, b);
                    ...
                    else
                    {
                        ...
                        v256 IF_ZERO = mm256_set1_epi64x(0x8000_0000_0000_0002ul);
                        ...
                        summand = mm256_ternarylogic_si256(ONE, mm256_srai_epi64(a, 63, elements), zeroMask, TernaryOperation.OxF8);
                        v256 aPart0 = mm256_ternarylogic_si256(a, isGreater, zeroMask,  TernaryOperation.OxEO);
                        v256 aPart1 = mm256_ternarylogic_si256(zeroMask, IF_ZERO, isGreater, TernaryOperation.OxO8);
                    ...
                    if (promisePositive)
                    {
                        return Avx2.mm256_sub_epi64(Avx2.mm256_add_epi64(a, isGreater), summand);
                    }
                    else
                    {
                        return Avx2.mm256_add_epi64(Avx2.mm256_sub_epi64(a, isGreater), summand);
                    }
                }
                else throw new IllegalInstructionException();
            }
    ...
    unsafe public static partial class math
    {
        ...
        public static uint2 nexttoward(uint2 from, uint2 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epu32(from, to, 2);
            }
            else
            {
        ...
        public static uint3 nexttoward(uint3 from, uint3 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epu32(from, to, 3);
            }
            else
            {
        ...
        public static uint4 nexttoward(uint4 from, uint4 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epu32(from, to, 4);
            }
            else
            {
        ...
        public static int2 nexttoward(int2 from, int2 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epi32(from, to, 2);
            }
            else
            {
        ...
        public static int3 nexttoward(int3 from, int3 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epi32(from, to, 3);
            }
            else
            {
        ...
        public static int4 nexttoward(int4 from, int4 to)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_epi32(from, to, 4);
            }
            else
            {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quarter nexttoward(quarter from, quarter to, Promise promises = Promise.Nothing)
        {
            ...
            {
                int xNotInf = -tobyte((__x & MaxMath.quarter.SIGNALING_EXPONENT) != MaxMath.quarter.SIGNALING_EXPONENT);
                int eitherNaN = -tobyte(((__x & 0x7F) > MaxMath.quarter.SIGNALING_EXPONENT) | ((assbyte(to) & 0x7F) > MaxMath.quarter.SIGNALING_EXPONENT));
        ...
        public static quarter2 nexttoward(quarter2 from, quarter2 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new quarter2(nexttoward(from.x, to.x, promises),
                                    nexttoward(from.y, to.y, promises));
            }
        }
        ...
        public static quarter3 nexttoward(quarter3 from, quarter3 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new quarter3(nexttoward(from.x, to.x, promises),
                                    nexttoward(from.y, to.y, promises),
                                    nexttoward(from.z, to.z, promises));
            }
        }
        ...
        public static quarter4 nexttoward(quarter4 from, quarter4 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new quarter4(nexttoward(from.x, to.x, promises),
                                    nexttoward(from.y, to.y, promises),
                                    nexttoward(from.z, to.z, promises),
                                    nexttoward(from.w, to.w, promises));
            }
        }
        ...
        public static quarter8 nexttoward(quarter8 from, quarter8 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new quarter8(nexttoward(from.x0, to.x0, promises),
        ...
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any '<paramref name="from"/>' that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any '<paramref name="from"/>' that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any '<paramref name="from"/>' that is either MaxMath.half.PositiveInfinity, MaxMath.half.NegativeInfinity or MaxMath.half.NaN as well as any '<paramref name="to"/>' that is MaxMath.half.NaN.      </para>
        /// </remarks>
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static half nexttoward(half from, half to, Promise promises = Promise.Nothing)
        {
        ...
        public static half2 nexttoward(half2 from, half2 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new half2(nexttoward(from.x, to.x, promises),
                                 nexttoward(from.y, to.y, promises));
            }
        }
        ...
        public static half3 nexttoward(half3 from, half3 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new half3(nexttoward(from.x, to.x, promises),
                                 nexttoward(from.y, to.y, promises),
                                 nexttoward(from.z, to.z, promises));
            }
        }
        ...
        public static half4 nexttoward(half4 from, half4 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new half4(nexttoward(from.x, to.x, promises),
                                 nexttoward(from.y, to.y, promises),
                                 nexttoward(from.z, to.z, promises),
                                 nexttoward(from.w, to.w, promises));
            }
        ...
        public static half8 nexttoward(half8 from, half8 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new half8(nexttoward(from.x0, to.x0, promises),
                                 nexttoward(from.x1, to.x1, promises),
                                 nexttoward(from.x2, to.x2, promises),
                                 nexttoward(from.x3, to.x3, promises),
                                 nexttoward(from.x4, to.x4, promises),
        ...
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any '<paramref name="from"/>' that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any '<paramref name="from"/>' that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any '<paramref name="from"/>' that is either <see cref="float.PositiveInfinity"/>, <see cref="float.NegativeInfinity"/> or <see cref="float.NaN"/> as well as any '<paramref name="to"/>' that is <see cref="float.NaN"/>.      </para>
        /// </remarks>
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float nexttoward(float from, float to, Promise promises = Promise.Nothing)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_ps(Xse.set_ss(from),
                                     Xse.set_ss(to),
                                     promiseNonZero: promises.Promises(Promise.NonZero),
                                     promiseNegative: promises.Promises(Promise.Negative),
                                     promisePositive: promises.Promises(Promise.Positive),
            ...
            else
            {
                ...
                else
                {
                    ...
                    summand = 1 | ((__x >> 31) & zeroMask);
                    __x = (__x & (isGreater | zeroMask)) | (int)andnot(0x8000_0002u & (uint)isGreater, (uint)zeroMask);
                }

                if (!promises.Promises(Promise.Unsafe0))
                {
                    int xNotInf = -tobyte((__x & F32_SIGNALING_EXPONENT) != F32_SIGNALING_EXPONENT);
                    int eitherNaN = -tobyte(((__x & 0x7FFF_FFFF) > F32_SIGNALING_EXPONENT) | ((asint(to) & 0x7FFF_FFFF) > F32_SIGNALING_EXPONENT));
                    summand = andnot(summand & xNotInf, eitherNaN);
                    __x |= eitherNaN;
                }
        ...
        public static float2 nexttoward(float2 from, float2 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new float2(nexttoward(from.x, to.x, promises),
                                  nexttoward(from.y, to.y, promises));
            }
        }
        ...
        public static float3 nexttoward(float3 from, float3 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new float3(nexttoward(from.x, to.x, promises),
                                  nexttoward(from.y, to.y, promises),
                                  nexttoward(from.z, to.z, promises));
            }
        }
        ...
        public static float4 nexttoward(float4 from, float4 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new float4(nexttoward(from.x, to.x, promises),
                                  nexttoward(from.y, to.y, promises),
                                  nexttoward(from.z, to.z, promises),
                                  nexttoward(from.w, to.w, promises));
            }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 nexttoward(float8 from, float8 to, Promise promises = Promise.Nothing)
        {
            if (Avx2.IsAvx2Supported)
            {
            ...
            {
                return new float8(nexttoward(from.v4_0, to.v4_0, promises),
                                  nexttoward(from.v4_4, to.v4_4, promises));
            }
        }


        /// <summary>       Returns the next closest <see cref="double"/> to '<paramref name="from"/>' in the direction of '<paramref name="to"/>'.
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any '<paramref name="from"/>' that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any '<paramref name="from"/>' that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any '<paramref name="from"/>' that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="promises"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any '<paramref name="from"/>' that is either <see cref="double.PositiveInfinity"/>, <see cref="double.NegativeInfinity"/> or <see cref="double.NaN"/> as well as any '<paramref name="to"/>' that is <see cref="double.NaN"/>.      </para>
        /// </remarks>
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double nexttoward(double from, double to, Promise promises = Promise.Nothing)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.toward_pd(Xse.set_sd(from),
                                     Xse.set_sd(to),
                                     promiseNonZero: promises.Promises(Promise.NonZero),
                                     promiseNegative: promises.Promises(Promise.Negative),
                                     promisePositive: promises.Promises(Promise.Positive),
            ...
            else
            {
                ...
                if (!promises.Promises(Promise.Unsafe0))
                {
                    ...
                    long eitherNaN = -(long)tobyte(((__x & 0x7FFF_FFFF_FFFF_FFFF) > F64_SIGNALING_EXPONENT) | ((aslong(to) & 0x7FFF_FFFF_FFFF_FFFF) > F64_SIGNALING_EXPONENT));
                    summand = andnot(summand & xNotInf, eitherNaN);
                    __x |= eitherNaN;
                }
        ...
        public static double2 nexttoward(double2 from, double2 to, Promise promises = Promise.Nothing)
        {
            ...
            {
                return new double2(nexttoward(from.x, to.x, promises),
                                   nexttoward(from.y, to.y, promises));
            }
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 nexttoward(double3 from, double3 to, Promise promises = Promise.Nothing)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Xse.mm256_toward_pd(from,
                                           to,
                                           promiseNonZero: promises.Promises(Promise.NonZero),
                                           promiseNegative: promises.Promises(Promise.Negative),
                                           promisePositive: promises.Promises(Promise.Positive),
            ...
            {
                return new double3(nexttoward(from.xy, to.xy, promises),
                                   nexttoward(from.z,  to.z,  promises));
            }
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4 nexttoward(double4 from, double4 to, Promise promises = Promise.Nothing)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Xse.mm256_toward_pd(from,

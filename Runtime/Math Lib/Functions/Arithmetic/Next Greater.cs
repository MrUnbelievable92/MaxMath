...
namespace MaxMath
{
    ...
    unsafe public static partial class maxmath
    {
        ...
        /// <summary>       Returns the next closest <see cref="quarter"/> greater than <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any <paramref name="x"/> that is either <see cref="quarter.PositiveInfinity"/>, <see cref="quarter.NegativeInfinity"/> or <see cref="quarter.NaN"/>.       </para>
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a <see cref="MaxMath.quarter2"/>, where each component is the next closest <see cref="quarter"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="MaxMath.quarter3"/>, where each component is the next closest <see cref="quarter"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="MaxMath.quarter4"/>, where each component is the next closest <see cref="quarter"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="MaxMath.quarter8"/>, where each component is the next closest <see cref="quarter"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns the next closest <see cref="half"/> greater than <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any <paramref name="x"/> that is either half.PositiveInfinity, half.NegativeInfinity or half.NaN.       </para>
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a <see cref="half2"/>, where each component is the next closest <see cref="half"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="half3"/>, where each component is the next closest <see cref="half"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="half4"/>, where each component is the next closest <see cref="half"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="MaxMath.half8"/>, where each component is the next closest <see cref="half"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns the next closest <see cref="float"/> greater than <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any <paramref name="x"/> that is either <see cref="float.PositiveInfinity"/>, <see cref="float.NegativeInfinity"/> or <see cref="float.NaN"/>.       </para>
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a <see cref="float2"/>, where each component is the next closest <see cref="float"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="float3"/>, where each component is the next closest <see cref="float"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="float4"/>, where each component is the next closest <see cref="float"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="MaxMath.float8"/>, where each component is the next closest <see cref="float"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns the next closest <see cref="double"/> greater than <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Unsafe0"/> flag set returns incorrect results for any <paramref name="x"/> that is either <see cref="double.PositiveInfinity"/>, <see cref="double.NegativeInfinity"/> or <see cref="double.NaN"/>.       </para>
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns a <see cref="double2"/>, where each component is the next closest <see cref="double"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="double3"/>, where each component is the next closest <see cref="double"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>
        ...
        /// <summary>       Returns a <see cref="double4"/>, where each component is the next closest <see cref="double"/> greater than the corresponding component in <paramref name="x"/>.     </summary>
        /// <remarks>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.NonZero"/> flag set returns incorrect results for any <paramref name="x"/> that is negative 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Positive"/> flag set returns incorrect results for any <paramref name="x"/> that is negative or 0.       </para>
        /// <para>      A <see cref="Promise"/> "<paramref name="optimizations"/>" with its <see cref="Promise.Negative"/> flag set returns incorrect results for any <paramref name="x"/> that is positive or 0.       </para>

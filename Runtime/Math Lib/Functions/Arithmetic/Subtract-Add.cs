    ...
    namespace Intrinsics
    {
        unsafe public static partial class Xse
        {
            ...
            public static v128 addsub_epi8(v128 a, v128 b, byte elements = 16)
            {
                ...
                {
                    return Sse2.sub_epi8(a, Ssse3.sign_epi8(b, new v128(1, 255, 1, 255, 1, 255, 1, 255, 1, 255, 1, 255, 1, 255, 1, 255)));
                }
                else if (Sse2.IsSse2Supported)
                {
                    ...
                    if (elements == 2)
                    {
                        add = Sse2.bsrli_si128(add, sizeof(byte));
                        return Sse2.unpacklo_epi8(sub, add);
                    }
                    else
                    {
            ...
            public static v128 addsub_epi16(v128 a, v128 b, byte elements = 8)
            {
                if (Avx.IsAvxSupported) // This is only always as fast as the SSSE3 version with the VEX prefix
                {
                    ...
                    {
                        return Sse2.sub_epi16(a, Ssse3.sign_epi16(b, new ushort8(1, ushort.MaxValue, 1, ushort.MaxValue, 1, ushort.MaxValue, 1, ushort.MaxValue)));
                    }
                    ...
                    return Sse4_1.blend_epi16(sub, add, 0b1010_1010);
                }
                ...
                else if (Sse2.IsSse2Supported)
                {
                    ...
                    if (elements == 2)
                    {
                        add = Sse2.bsrli_si128(add, sizeof(ushort));
                        return Sse2.unpacklo_epi16(sub, add);
                    }
                    else
                    {
            ...
            public static v128 addsub_epi32(v128 a, v128 b, byte elements = 4)
            {
                if (Avx.IsAvxSupported) // This is only always as fast as the SSSE3 version with the VEX prefix
                {
                    if (Constant.IsConstantExpression(b))
                    {
                        return Sse2.sub_epi32(a, Ssse3.sign_epi32(b, new v128(1, uint.MaxValue, 1, uint.MaxValue)));
                    }
                    ...
                    return Sse4_1.blend_epi16(sub, add, 0b1100_1100);
                }
                else if (Ssse3.IsSsse3Supported)
                {
                    return Sse2.sub_epi32(a, Ssse3.sign_epi32(b, new v128(1, uint.MaxValue, 1, uint.MaxValue)));
                ...
                else if (Sse2.IsSse2Supported)
                {
                    ...
                    if (elements == 2)
                    {
                        add = Sse2.bsrli_si128(add, sizeof(uint));
                        return Sse2.unpacklo_epi32(sub, add);
                    }
                    else
                    {
            ...
            public static v128 addsub_epi64(v128 a, v128 b)
            {
                if (Sse2.IsSse2Supported)
                {
                    ...
                    {
                        return Sse4_1.blend_epi16(sub, add, 0b1111_0000);
                    }
                    else
                    {
                        add = Sse2.bsrli_si128(add, sizeof(ulong));
                        return Sse2.unpacklo_epi64(sub, add);
                    }
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 addsub_ps(v128 a, v128 b)
            {
                ...
                else if (Sse.IsSseSupported)
                {
                    ...
                    return Sse.add_ps(a, partialNeg);
                }
                else throw new IllegalInstructionException();
            }
            ...
            public static v128 addsub_pd(v128 a, v128 b)
            {
                ...
                else if (Sse2.IsSse2Supported)
                {
                    ...
                    return Sse2.add_pd(a, partialNeg);
                }
                else throw new IllegalInstructionException();
            }
        }

...
namespace MaxMath
{
    unsafe public static partial class math
    {
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.float2"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.float3"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.float4"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.double2"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.double3"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>       Returns the result of the componentwise fast approximate division of two <see cref="MaxMath.double4"/>s       </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]

...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        {
            return repeat((b - a), math.TAU_DBL);
        }
        ...
        public static float angledeltasgn(float a, float b)
        {
            ...
            return math.select(deltas, deltas - math.TAU, deltas > math.PI);
        }
        ...
        public static float8 angledeltasgn(float8 a, float8 b)
        {
            ...
            return select(deltas, deltas - math.TAU, deltas > math.PI);
        }
        ...
        public static double angledeltasgn(double a, double b)
        {
            ...
            return math.select(deltas, deltas - math.TAU_DBL, deltas > math.PI_DBL);
        }

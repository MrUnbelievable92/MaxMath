...
{
    [Serializable] 
    [StructLayout(LayoutKind.Sequential, Size = 3 * 3 * sizeof(sbyte))]
...
Assert.IsWithinArrayBounds(index, 3);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte3x3 operator / (sbyte3x3 left, sbyte3x3 right)
        {
            ...
            {
                return new sbyte3x3(left.c0 / right.c0, left.c1 / right.c1, left.c2 / right.c2);
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(sbyte3x3 other) => this.c0.Equals(other.c0) & this.c1.Equals(other.c1) & this.c2.Equals(other.c2);

...
{
    [Serializable] 
    [StructLayout(LayoutKind.Sequential, Size = 4 * 4 * sizeof(ushort))]
...
Assert.IsWithinArrayBounds(index, 4);
        ...
        public override readonly bool Equals(object obj) => obj is ushort4x4 converted && this.Equals(converted);

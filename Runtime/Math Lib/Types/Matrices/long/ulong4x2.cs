...
namespace MaxMath
{
    ...
    unsafe public struct ulong4x2 : IEquatable<ulong4x2>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator ulong4x2(int4x2 input) => new ulong4x2((ulong4)input.c0, (ulong4)input.c1);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ulong4x2(uint4x2 input) => new ulong4x2((ulong4)input.c0, (ulong4)input.c1);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x2(ulong4x2 input) => new int4x2((int4)input.c0, (int4)input.c1);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4x2(ulong4x2 input) => new uint4x2((uint4)input.c0, (uint4)input.c1);
...
Assert.IsWithinArrayBounds(index, 2);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, byte4x2 right) => new ulong4x2 (left.c0 / right.c0, left.c1 / right.c1);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, ushort4x2 right) => new ulong4x2 (left.c0 / right.c0, left.c1 / right.c1);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, uint4x2 right) => new ulong4x2 (left.c0 / right.c0, left.c1 / right.c1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator * (uint4x2 left, ulong4x2 right) => right * left;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator * (ushort4x2 left, ulong4x2 right) => right * left;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator * (byte4x2 left, ulong4x2 right) => right * left;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, byte right) => new ulong4x2 (left.c0 / right, left.c1 / right);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, ushort right) => new ulong4x2 (left.c0 / right, left.c1 / right);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ulong4x2 operator / (ulong4x2 left, uint right) => new ulong4x2 (left.c0 / right, left.c1 / right);

...
d.AssertOperationMatchesInitialization(sizeof(short), 2, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return bmdiv_epi16(x, mul, divisor, d._promises, 2);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(short), 3, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return bmdiv_epi16(x, mul, divisor, d._promises, 3);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(short), 4, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return bmdiv_epi16(x, mul, divisor, d._promises, 4);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(short), 8, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return bmdiv_epi16(x, mul.v4_0, mul.v4_4, divisor, d._promises);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(short), 16, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return new short16(bmdiv_epi16(x.v8_0, mulLo.v4_0, mulLo.v4_4, divisor.v8_0, d._promises),
                                           bmdiv_epi16(x.v8_8, mulHi.v4_0, mulHi.v4_4, divisor.v8_8, d._promises));
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(int), 2, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<int2>())
            {
                ...
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2div_epi32_si32(x, divisor, d._promises);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32_si32(x, mul, shift, divisor, d._promises, 2);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
            ...
            else
            {
                ...
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2div_epi32(x, divisor, d._promises, 2);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32(x, mul, shift, divisor, d._promises, 2);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
...
d.AssertOperationMatchesInitialization(sizeof(int), 3, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<int3>())
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32_si32(x, mul, shift, divisor, d._promises, 3);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
            ...
            else
            {
                ...
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2div_epi32(x, divisor, d._promises, 3);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32(x, mul, shift, divisor, d._promises, 3);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
...
d.AssertOperationMatchesInitialization(sizeof(int), 4, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<int4>())
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32_si32(x, mul, shift, divisor, d._promises, 4);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
            ...
            else
            {
                ...
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2div_epi32(x, divisor, d._promises, 4);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return msdiv_epi32(x, mul, shift, divisor, d._promises, 4);
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
...
d.AssertOperationMatchesInitialization(sizeof(int), 8, columnCount: 1, Signedness.Signed, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<int8>())
            {
                ...
                if (d._promises.Pow2)
                {
                    ...
                    {
                        return new int8(pow2div_epi32_si32(x.v4_0, divisor, d._promises),
                                        pow2div_epi32_si32(x.v4_4, divisor, d._promises));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        return new int8(msdiv_epi32_si32(x.v4_0, mul, shift, divisor, d._promises),
                                        msdiv_epi32_si32(x.v4_4, mul, shift, divisor, d._promises));
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)
            ...
            else
            {
                ...
                if (d._promises.Pow2)
                {
                    ...
                    {
                        return new int8(pow2div_epi32(x.v4_0, divisor.v4_0, d._promises),
                                        pow2div_epi32(x.v4_4, divisor.v4_4, d._promises));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        return new int8(msdiv_epi32(x.v4_0, mul.v4_0, shift.v4_0, divisor.v4_0, d._promises),
                                        msdiv_epi32(x.v4_4, mul.v4_4, shift.v4_4, divisor.v4_4, d._promises));
                    }
                    else
                    {
                        if (BurstArchitecture.IsBurstCompiled)

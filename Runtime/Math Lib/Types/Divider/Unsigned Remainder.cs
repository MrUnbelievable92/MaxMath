...
d.AssertOperationMatchesInitialization(sizeof(ushort), 2, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return bmrem_epu16(x, divisor, mul, 2);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(ushort), 3, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return bmrem_epu16(x, divisor, mul, 3);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(ushort), 4, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return bmrem_epu16(x, divisor, mul, 4);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(ushort), 8, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return bmrem_epu16(x, divisor, mulLo, mulHi);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(ushort), 16, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        return new ushort16(bmrem_epu16(x.v8_0, divisor.v8_0, mulLo.v4_0, mulLo.v4_4),
                                            bmrem_epu16(x.v8_8, divisor.v8_8, mulHi.v4_0, mulHi.v4_4));
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(uint), 2, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<uint2>())
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, Xse.set1_epi32(*(uint*)&d._divisor), 2);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32_su32(x, divisor, mul, shift, d._promises, 2);
                    }
                    else
                    {
            ...
            else
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, d._divisor.Reinterpret<T, uint2>(), 2);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32(x, divisor, mul, shift, d._promises, 2);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(uint), 3, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<uint3>())
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, Xse.set1_epi32(*(uint*)&d._divisor), 3);
                    }
                    else
                    {
                        uint divisor = *(uint*)&d._divisor;
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32_su32(x, divisor, mul, shift, d._promises, 3);
                    }
                    else
                    {
                        ulong mul = *(ulong*)&d._bigM;
            ...
            else
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, d._divisor.Reinterpret<T, uint3>(), 3);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32(x, divisor, mul, shift, d._promises, 3);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(uint), 4, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<uint4>())
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, Xse.set1_epi32(*(uint*)&d._divisor));
                    }
                    else
                    {
                        uint divisor = *(uint*)&d._divisor;
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32_su32(x, divisor, mul, shift, d._promises, 4);
                    }
                    else
                    {
                        ulong mul = *(ulong*)&d._bigM;
            ...
            else
            {
                if (d._promises.Pow2)
                {
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        return pow2_rem_epu32(x, d._divisor.Reinterpret<T, uint4>());
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (BurstArchitecture.IsSIMDSupported)
                    {
                        ...
                        return msrem_epu32(x, divisor, mul, shift, d._promises, 4);
                    }
                    else
                    {
...
d.AssertOperationMatchesInitialization(sizeof(uint), 8, columnCount: 1, Signedness.Unsigned, NumericDataType.Integer);
            ...
            if (d.DivideByScalar<uint8>())
            {
                if (d._promises.Pow2)
                {
                    ...
                    {
                        return new uint8(pow2_rem_epu32(x.v4_0, Xse.set1_epi32(divisor)),
                                         pow2_rem_epu32(x.v4_4, Xse.set1_epi32(divisor)));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        return new uint8(msrem_epu32_su32(x.v4_0, divisor, mul, shift, d._promises),
                                         msrem_epu32_su32(x.v4_4, divisor, mul, shift, d._promises));
                    }
                    else
                    {
            ...
            else
            {
                if (d._promises.Pow2)
                {
                    ...
                    {
                        return new uint8(pow2_rem_epu32(x.v4_0, divisor.v4_0),
                                         pow2_rem_epu32(x.v4_4, divisor.v4_4));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        return new uint8(msrem_epu32(x.v4_0, divisor.v4_0, mul.v4_0, shift.v4_0, d._promises),
                                         msrem_epu32(x.v4_4, divisor.v4_4, mul.v4_4, shift.v4_4, d._promises));
                    }
                    else
                    {

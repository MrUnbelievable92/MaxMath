...
namespace MaxMath
{
    ...
    unsafe public struct quarter3 : IEquatable<quarter3>, IFormattable
    {
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator v128(quarter3 input) => RegisterConversion.ToRegister128(input);
        
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator quarter3(v128 input) => RegisterConversion.ToAbstraction128<quarter3>(input);
        ...
        public static explicit operator quarter3(sbyte3 input)
        {
            ...
            {
                return Xse.cvtepi8_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
        ...
        public static explicit operator quarter3(byte3 input)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.cvtepu8_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter)input.x,
        ...
        public static explicit operator quarter3(short3 input)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.cvtepi16_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter)input.x,
        ...
        public static explicit operator quarter3(ushort3 input)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.cvtepu16_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter)input.x,
        ...
        public static explicit operator quarter3(int3 input)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.cvtepi32_pq(RegisterConversion.ToV128(input), quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter)input.x,
        ...
        public static explicit operator quarter3(uint3 input)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return Xse.cvtepu32_pq(RegisterConversion.ToV128(input), quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter)input.x,
        ...
        public static explicit operator quarter3(long3 input)
        {
            ...
            {
                return Xse.mm256_cvtepi64_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
        ...
        public static explicit operator quarter3(ulong3 input)
        {
            if (Avx2.IsAvx2Supported)
            {
                return Xse.mm256_cvtepu64_pq(input, quarter.PositiveInfinity, elements: 3);
            }
            else
            {
                return new quarter3((quarter2)input.xy,
        ...
        public static bool3 operator != (quarter3 left, quarter3 right)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                v128 results = RegisterConversion.IsTrue8(Xse.cmpneq_pq(left, right, elements: 3));

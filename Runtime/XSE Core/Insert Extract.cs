        ...
        public static uint extract_epi32(v128 a, byte i)
        {
            if (Constant.IsConstantExpression(i))
            {
                ...
                else if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        case 3: return (uint)Sse2.cvtsi128_si32(Sse2.bsrli_si128(a, 3 * sizeof(int)));
                        case 2: return (uint)Sse2.cvtsi128_si32(Sse2.bsrli_si128(a, 2 * sizeof(int)));
        ...
        public static ulong extract_epi64(v128 a, byte i)
        {
            if (Constant.IsConstantExpression(i))
            {
                ...
                else if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        case 1: return (ulong)Sse2.cvtsi128_si64x(Sse2.bsrli_si128(a, 1 * sizeof(ulong)));
                        case 0: return (ulong)Sse2.cvtsi128_si64x(a);
        ...
        public static float extract_ps(v128 a, byte i)
        {
            if (Constant.IsConstantExpression(i))
            {
                ...
                else if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        case 3: return math.asfloat(Sse2.cvtsi128_si32(Sse2.bsrli_si128(a, 3 * sizeof(float))));
                        case 2: return math.asfloat(Sse2.cvtsi128_si32(Sse2.bsrli_si128(a, 2 * sizeof(float))));
                        case 1: return math.asfloat(Sse2.cvtsi128_si32(Sse2.bsrli_si128(a, 1 * sizeof(float))));
                        case 0: return math.asfloat(Sse2.cvtsi128_si32(a));
            ...
            if (Constant.IsConstantExpression(i))
            {
                ...
                else if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        ...
                        case 7:
                        {
                            v128 MASK = Sse2.cvtsi64x_si128(unchecked((long)0xFF00_0000_0000_0000));

                            return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v << 56), Sse2.andnot_si128(MASK, a));
                        }
                        case 6:
                        {
                            v128 MASK = Sse2.cvtsi64x_si128(0xFF_0000_0000_0000);

                            return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v << 48), Sse2.andnot_si128(MASK, a));
                        }
                        case 5:
                        {
                            v128 MASK = Sse2.cvtsi64x_si128(0xFF00_0000_0000);

                            return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v << 40), Sse2.andnot_si128(MASK, a));
                        }
                        case 4:
                        {
                            v128 MASK = Sse2.cvtsi64x_si128(0xFF_0000_0000);

                            return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v << 32), Sse2.andnot_si128(MASK, a));
                        }
                        case 3:
                        {
                            v128 MASK = Sse2.cvtsi32_si128(unchecked((int)0xFF00_0000));

                            return Sse2.or_si128(Sse2.cvtsi32_si128(v << 24), Sse2.andnot_si128(MASK, a));
                        }
                        case 2:
                        {
                            v128 MASK = Sse2.cvtsi32_si128(0xFF_0000);

                            return Sse2.or_si128(Sse2.cvtsi32_si128(v << 16), Sse2.andnot_si128(MASK, a));
                        }
                        case 1:
                        {
                            v128 MASK = Sse2.cvtsi32_si128(0xFF00);

                            return Sse2.or_si128(Sse2.cvtsi32_si128(v << 8), Sse2.andnot_si128(MASK, a));
                        }
                        case 0:
                        {
                            v128 MASK = Sse2.cvtsi32_si128(0xFF);

                            return Sse2.or_si128(Sse2.cvtsi32_si128(v), Sse2.andnot_si128(MASK, a));
                        }
        ...
        public static v128 insert_epi32(v128 a, uint v, byte i)
        {
            if (Constant.IsConstantExpression(i))
            {
                ...
                if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        case 3: return Sse2.or_si128(Sse2.bslli_si128(Sse2.cvtsi32_si128((int)v), 3 * sizeof(int)), Sse2.and_si128(new v128(-1, -1, -1, 0), a));
                        case 2: return Sse2.or_si128(Sse2.bslli_si128(Sse2.cvtsi32_si128((int)v), 2 * sizeof(int)), Sse2.and_si128(new v128(-1, -1, 0, -1), a));
                        case 1: return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v << 32), Sse2.andnot_si128(Sse2.cvtsi64x_si128(unchecked((long)0xFFFF_FFFF_0000_0000)), a));
                        case 0: return Sse2.or_si128(Sse2.cvtsi32_si128((int)v), Sse2.andnot_si128(Sse2.cvtsi32_si128(unchecked((int)0xFFFF_FFFF)), a));
        ...
        public static v128 insert_epi64(v128 a, ulong v, byte i)
        {
            if (Constant.IsConstantExpression(i))
            {
                ...
                if (Sse2.IsSse2Supported)
                {
                    switch (i)
                    {
                        case 1: return Sse2.unpacklo_epi64(a, Sse2.cvtsi64x_si128((long)v));
                        case 0: return Sse2.or_si128(Sse2.cvtsi64x_si128((long)v), Sse2.andnot_si128(Sse2.cvtsi64x_si128(-1L), a));

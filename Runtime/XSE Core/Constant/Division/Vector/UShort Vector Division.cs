...
namespace MaxMath.Intrinsics
{
	...
	{
		public static v128 constdiv_epu16(v128 vector, v128 divisor, byte elements = 8)
		{
            if (Architecture.IsSIMDSupported)
		    {
				if (constexpr.ALL_SAME_EPU16(divisor, elements))
				{
					return constdiv_epu16(vector, divisor.UShort0);
				}
		...
		public static v256 mm256_constdiv_epu16(v256 vector, v256 divisor)
		{
			if (Avx2.IsAvx2Supported)
			{
				if (constexpr.ALL_SAME_EPU16(divisor))
				{
					return mm256_constdiv_epu16(vector, divisor.UShort0);
				}

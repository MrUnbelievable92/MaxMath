    ...
    unsafe public static partial class Xse
    {
        ...
        public static v128 div_epu8(v128 dividend, v128 divisor, byte elements = 16) 
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                else if (elements > 4)
                {
                    ...
                    v128 intsLo = DIV_FLOATV_USHORT_RANGE_RET_INT(leftLo, rightLo);
                    v128 intsHi = DIV_FLOATV_USHORT_RANGE_RET_INT(leftHi, rightHi);
                ...
                {
                    v128 ints = DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(cvtepu8_epi32(dividend)), Sse2.cvtepi32_ps(cvtepu8_epi32(divisor)));
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                else if (elements > 4)
                {
                    if (Avx2.IsAvx2Supported)
                    {
                        ...
                        v256 result32 = DIV_FLOATV_USHORT_RANGE_RET_INT(left, right);
                ...
                {
                    v128 ints = DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(cvtepi8_epi32(dividend)), Sse2.cvtepi32_ps(cvtepi8_epi32(divisor)));
        ...
        public static v128 rem_epu8(v128 dividend, v128 divisor, byte elements = 16) 
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                else if (elements > 4)
                {
                    ...
                    v128 quotientsLo = DIV_FLOATV_USHORT_RANGE_RET_INT(leftLo, rightLo);
                    v128 quotientsHi = DIV_FLOATV_USHORT_RANGE_RET_INT(leftHi, rightHi);
                ...
                else
                {
                    if (Sse4_1.IsSse41Supported)
                    {
                        ...
                        v128 quotients32 = DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(castDividend), Sse2.cvtepi32_ps(castDivisor));
                    ...
                    else
                    {
                        v128 castDividend = cvtepu8_epi16(dividend);
                        v128 castDivisor = cvtepu8_epi16(divisor);
                        v128 quotients32 = DIV_FLOATV_USHORT_RANGE_RET_INT(cvtepu16_ps(castDividend), cvtepu16_ps(castDivisor));
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        v128 castDividend = cvtepi8_epi16(dividend);
                        v128 castDivisor = cvtepi8_epi16(divisor);
                        v128 quotients32 = DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(cvtepi16_epi32(castDividend)), Sse2.cvtepi32_ps(cvtepi16_epi32(castDivisor)));
                        v128 quotients16 = Sse2.packs_epi32(quotients32, quotients32);
                        v128 rem16 = Sse2.sub_epi16(castDividend, Sse2.mullo_epi16(castDivisor, quotients16));
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                else
                {
                    if (Sse4_1.IsSse41Supported)
                    {
                        v128 castDividend = cvtepu8_epi32(dividend);
                        v128 castDivisor = cvtepu8_epi32(divisor);
                        v128 quotients32 = DIV_FLOATV_USHORT_RANGE_RET_INT(castDividend, castDivisor);
                        v128 rem32 = Sse2.sub_epi32(castDividend, Sse4_1.mullo_epi32(castDivisor, quotients32));
        ...
        public static v128 div_epi16(v128 dividend, v128 divisor, bool saturated = false, byte elements = 8) 
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                {
                    v128 ints = DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(cvtepi16_epi32(dividend)), Sse2.cvtepi32_ps(cvtepi16_epi32(divisor)));
        ...
        public static v128 div_epu16(v128 dividend, v128 divisor, byte elements = 8)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                if (elements > 4)
                {
                    ...
                    v128 qLo = DIV_FLOATV_USHORT_RANGE_RET_INT(leftLo, rightLo);
                    v128 qHi = DIV_FLOATV_USHORT_RANGE_RET_INT(leftHi, rightHi);
                ...
                {
                    v128 ints = DIV_FLOATV_USHORT_RANGE_RET_INT(cvtepu16_ps(dividend), cvtepu16_ps(divisor));
        ...
        public static v256 mm256_div_epi16(v256 dividend, v256 divisor, bool saturated = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                v256 lo = DIV_FLOATV_USHORT_RANGE_RET_INT(dividendLo, divisorLo);
                v256 hi = DIV_FLOATV_USHORT_RANGE_RET_INT(dividendHi, divisorHi);

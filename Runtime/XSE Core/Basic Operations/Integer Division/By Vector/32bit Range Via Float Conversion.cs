...
Assert.AreNotEqual(b.UInt3, 0u);
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                {
                    return Sse2.cvttps_epi32(DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(a), Sse2.cvtepi32_ps(b)));
                }
...
Assert.AreNotEqual(b.UInt7, 0u);
            ...
            if (Avx2.IsAvx2Supported)
            {
                ...
                {
                    return Avx.mm256_cvttps_epi32(DIV_FLOATV_USHORT_RANGE_RET_INT(Avx.mm256_cvtepi32_ps(a), Avx.mm256_cvtepi32_ps(b)));
                }
                if (constexpr.ALL_LE_EPU32(a, (uint)int.MaxValue) && constexpr.ALL_LE_EPU32(b, (uint)int.MaxValue))
                {
...
Assert.AreNotEqual(b.SInt3, 0);
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                if (constexpr.ALL_GE_EPI32(a, short.MinValue, elements) && constexpr.ALL_LE_EPI32(a, short.MaxValue, elements) &&
                    constexpr.ALL_GE_EPI32(b, short.MinValue, elements) && constexpr.ALL_LE_EPI32(b, short.MaxValue, elements))
                {
                    return Sse2.cvttps_epi32(DIV_FLOATV_USHORT_RANGE_RET_INT(Sse2.cvtepi32_ps(a), Sse2.cvtepi32_ps(b)));
                }
...
Assert.AreNotEqual(b.SInt7, 0);
            ...
            if (Avx2.IsAvx2Supported)
            {
                ...
                if (constexpr.ALL_GE_EPI32(a, short.MinValue) && constexpr.ALL_LE_EPI32(a, short.MaxValue) &&
                    constexpr.ALL_GE_EPI32(b, short.MinValue) && constexpr.ALL_LE_EPI32(b, short.MaxValue))
                {
                    return Avx.mm256_cvttps_epi32(DIV_FLOATV_USHORT_RANGE_RET_INT(Avx.mm256_cvtepi32_ps(a), Avx.mm256_cvtepi32_ps(b)));
                }

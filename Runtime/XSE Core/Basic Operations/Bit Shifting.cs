...
namespace MaxMath.Intrinsics
{
    unsafe public static partial class Xse
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v128 srai_epi8(v128 x, int n)
        {
            if (Sse2.IsSse2Supported)
            {
                ...
                return Xse.blendv_si128(even, odd, new v128(0xFF00_FF00));
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v256 mm256_srai_epi8(v256 x, int n)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                return Xse.mm256_blendv_si256(even, odd, new v256(0xFF00_FF00));
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v128 slli_epi32(v128 x, int n)
        {
            if (Sse2.IsSse2Supported)
            {
                return Sse2.sll_epi32(x, new v128(n, 0, 0, 0));
            }
            else throw new IllegalInstructionException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_srai_epi64(v256 x, int n, byte elements = 4)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.IS_TRUE(n <= 0 | n >= 64))

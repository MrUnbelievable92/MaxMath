    ...
    unsafe public static partial class Xse
    {
        ...
        internal static v128 impl_div_epu32(v128 a, v128 b, byte elements = 4)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                ...
                {
                    return DIV_FLOATV_SIGNED_BYTE_RANGE_RET_INT(cvtepi32_ps(a), cvtepi32_ps(b));
                }
        ...
        internal static v256 mm256_impl_div_epu32(v256 a, v256 b, uint maxValuePromise = uint.MaxValue)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                {
                    return DIV_FLOATV_SIGNED_BYTE_RANGE_RET_INT(Avx.mm256_cvtepi32_ps(a), Avx.mm256_cvtepi32_ps(b));
                }

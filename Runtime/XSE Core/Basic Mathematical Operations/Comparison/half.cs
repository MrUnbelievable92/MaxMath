...
namespace MaxMath.Intrinsics
{
    unsafe public static partial class Xse
    {
        ...
        private static v256 MM256_F16_ABS_MASK
        {
            get
            {
        ...
        public static v128 cmpngt_ph(v128 a, v128 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false, byte elements = 8)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return cmple_ph(a, b, promiseNeitherNaN, promiseNeitherZero, elements);
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v128 cmpnlt_ph(v128 a, v128 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false, byte elements = 8)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return cmpge_ph(a, b, promiseNeitherNaN, promiseNeitherZero, elements);
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v128 cmpnge_ph(v128 a, v128 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false, byte elements = 8)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return cmplt_ph(a, b, promiseNeitherNaN, promiseNeitherZero, elements);
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v128 cmpnle_ph(v128 a, v128 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false, byte elements = 8)
        {
            if (BurstArchitecture.IsSIMDSupported)
            {
                return cmpgt_ph(a, b, promiseNeitherNaN, promiseNeitherZero, elements);
            }
            else throw new IllegalInstructionException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpord_ph(v256 a, v256 b)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_LT_EPU16(a, 1 << 15) && constexpr.ALL_LT_EPU16(b, 1 << 15))
                {
                    return Avx2.mm256_and_si256(Avx2.mm256_cmpgt_epi16(mm256_set1_epi16(F16_SIGNALING_EXPONENT + 1), a),
                                                Avx2.mm256_cmpgt_epi16(mm256_set1_epi16(F16_SIGNALING_EXPONENT + 1), b));
                }
                else
                {
                    return Avx2.mm256_and_si256(Avx2.mm256_cmpgt_epi16(mm256_set1_epi16(F16_SIGNALING_EXPONENT + 1), Avx2.mm256_and_si256(a, MM256_F16_ABS_MASK)),
                                                Avx2.mm256_cmpgt_epi16(mm256_set1_epi16(F16_SIGNALING_EXPONENT + 1), Avx2.mm256_and_si256(b, MM256_F16_ABS_MASK)));
                }
            }
            else throw new IllegalInstructionException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpunord_ph(v256 a, v256 b)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_LT_EPU16(a, 1 << 15) && constexpr.ALL_LT_EPU16(b, 1 << 15))
                {
                    return Avx2.mm256_or_si256(Avx2.mm256_cmpgt_epi16(a, mm256_set1_epi16(F16_SIGNALING_EXPONENT)),
                                               Avx2.mm256_cmpgt_epi16(b, mm256_set1_epi16(F16_SIGNALING_EXPONENT)));
                }
                else
                {
                    return Avx2.mm256_or_si256(Avx2.mm256_cmpgt_epi16(Avx2.mm256_and_si256(a, MM256_F16_ABS_MASK), mm256_set1_epi16(F16_SIGNALING_EXPONENT)),
                                               Avx2.mm256_cmpgt_epi16(Avx2.mm256_and_si256(b, MM256_F16_ABS_MASK), mm256_set1_epi16(F16_SIGNALING_EXPONENT)));
                }
            }
            else throw new IllegalInstructionException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpeq_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_EQ_EPU16(a, 0) || constexpr.ALL_EQ_EPU16(a, 0x8000))
                {
                    if (promiseNeitherNaN)
                    {
                        return Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(b, 1), Avx.mm256_setzero_si256());
                    }
                    else
                    {
                        return Avx2.mm256_andnot_si256(mm256_cmpunord_ph(b, b), Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(b, 1), Avx.mm256_setzero_si256()));
                    }
                }
                else if (constexpr.ALL_EQ_EPU16(b, 0) || constexpr.ALL_EQ_EPU16(b, 0x8000))
                {
                    if (promiseNeitherNaN)
                    {
                        return Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(a, 1), Avx.mm256_setzero_si256());
                    }
                    else
                    {
                        return Avx2.mm256_andnot_si256(mm256_cmpunord_ph(a, a), Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(a, 1), Avx.mm256_setzero_si256()));
                    }
                }
                else
                {
                    v256 equalValues = Avx2.mm256_cmpeq_epi16(a, b);
                    ...
                    if (promiseNeitherNaN)
                    {
                        ...
                        {
                            v256 neitherZero = Avx2.mm256_cmpeq_epi16(Avx.mm256_setzero_si256(), Avx2.mm256_slli_epi16(Avx2.mm256_or_si256(a, b), 1));

                            return Avx2.mm256_or_si256(neitherZero, equalValues);
                        }
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            return mm256_ternarylogic_si256(eitherNaN, neitherZero, equalValues, TernaryOperation.OxOE);
                        }
                    }
                }
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpneq_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_EQ_EPU16(a, 0) || constexpr.ALL_EQ_EPU16(a, 0x8000))
                {
                    if (promiseNeitherNaN)
                    {
                        return mm256_not_si256(Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(b, 1), Avx.mm256_setzero_si256()));
                    }
                    else
                    {
                        return Avx2.mm256_andnot_si256(Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(b, 1), Avx.mm256_setzero_si256()), mm256_cmpord_ph(b, b));
                    }
                }
                else if (constexpr.ALL_EQ_EPU16(b, 0) || constexpr.ALL_EQ_EPU16(b, 0x8000))
                {
                    if (promiseNeitherNaN)
                    {
                        return mm256_not_si256(Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(a, 1), Avx.mm256_setzero_si256()));
                    }
                    else
                    {
                        return Avx2.mm256_andnot_si256(Avx2.mm256_cmpeq_epi16(Avx2.mm256_slli_epi16(a, 1), Avx.mm256_setzero_si256()), mm256_cmpord_ph(a, a));
                    }
                }
                else
                {
                    ...
                    if (promiseNeitherNaN)
                    {
                        ...
                        {
                            v256 bothZero = Avx2.mm256_cmpeq_epi16(Avx.mm256_setzero_si256(), Avx2.mm256_slli_epi16(Avx2.mm256_or_si256(a, b), 1));

                            return mm256_nor_si256(bothZero, equalValues);
                        }
                    }
                    else
                    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmplt_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_EQ_EPU16(b, 0) || constexpr.ALL_EQ_EPU16(b, 0x8000))
                {
                    v256 negative = Avx2.mm256_cmpgt_epi16(Avx.mm256_setzero_si256(), a);
                    v256 zero = Avx2.mm256_cmpeq_epi16(Avx.mm256_setzero_si256(), Avx2.mm256_slli_epi16(a, 1));
                    ...
                    {
                        return mm256_ternarylogic_si256(mm256_cmpunord_ph(a, a), zero, negative, TernaryOperation.OxO2);
                    }
                }
                if (constexpr.ALL_EQ_EPU16(a, 0) || constexpr.ALL_EQ_EPU16(a, 0x8000))
                {
                    v256 positive = Avx2.mm256_cmpgt_epi16(b, Avx.mm256_setzero_si256());
                    v256 zero = Avx2.mm256_cmpeq_epi16(Avx.mm256_setzero_si256(), Avx2.mm256_slli_epi16(b, 1));
                    ...
                    {
                        return mm256_ternarylogic_si256(mm256_cmpunord_ph(b, b), zero, positive, TernaryOperation.OxO2);
                    }
                }
                ...
                v256 signA = Avx2.mm256_srai_epi16(a, 15);
                v256 signB = Avx2.mm256_srai_epi16(b, 15);
                v256 equalSigns = Avx2.mm256_cmpeq_epi16(signA, signB);
                v256 ifEqualSigns;
                //if (Avx512.IsAvx512Supported)
                //{
                //    ifEqualSigns = mm256_ternarylogic_si256(equalValues, signA, mm256_cmple_epu16(b, a), TernaryOperation.OxO9);
                //}
                //else
                //{
                      ifEqualSigns = mm256_ternarylogic_si256(equalValues, signA, mm256_cmpgt_epu16(b, a), TernaryOperation.OxO6);
                //}
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpgt_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmplt_ph(b, a, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmple_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                if (constexpr.ALL_EQ_EPU16(b, 0) || constexpr.ALL_EQ_EPU16(b, 0x8000))
                {
                    v256 intLEzero = Avx2.mm256_cmpgt_epi16(mm256_set1_epi16(1), a);
                    ...
                    {
                        return Avx2.mm256_andnot_si256(mm256_cmpunord_ph(a, a), intLEzero);
                    }
                }
                if (constexpr.ALL_EQ_EPU16(a, 0) || constexpr.ALL_EQ_EPU16(a, 0x8000))
                {
                    v256 uintGEzero = Avx2.mm256_cmpgt_epi16(b, Avx.mm256_setzero_si256());
                    v256 negativeZero = Avx2.mm256_cmpeq_epi16(b, mm256_set1_epi16(1 << 15));
                    ...
                    {
                        return mm256_ternarylogic_si256(mm256_cmpunord_ph(b, b), uintGEzero, negativeZero, TernaryOperation.OxOE);
                    }
                }
                ...
                //if (Avx512.IsAvx512Supported)
                //{
                //    ifEqualSigns = mm256_ternarylogic_si256(equalValues, signA, mm256_cmple_epu16(b, a), TernaryOperation.OxF9);
                //}
                //else
                //{
                      ifEqualSigns = mm256_ternarylogic_si256(equalValues, signA, mm256_cmpgt_epu16(b, a), TernaryOperation.OxF6);
                //}
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpge_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmple_ph(b, a, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpngt_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmple_ph(a, b, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpnlt_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmpge_ph(a, b, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpnge_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmplt_ph(a, b, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_cmpnle_ph(v256 a, v256 b, bool promiseNeitherNaN = false, bool promiseNeitherZero = false)
        {
            if (Avx2.IsAvx2Supported)
            {
                return mm256_cmpgt_ph(a, b, promiseNeitherNaN, promiseNeitherZero);
            }
            else throw new IllegalInstructionException();
        }
    }

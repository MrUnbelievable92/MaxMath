    ...
    unsafe public static partial class Xse
    {
        ...
        public static v128 mulhi_epi8(v128 a, v128 b, byte elements = 16)
        {
            ...
            if (Sse2.IsSse2Supported)
            {
                ...
                return blendv_si128(even, odd, Sse2.set1_epi16(unchecked((short)0xFF00)));
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v256 mm256_mulhi_epi8(v256 a, v256 b)
        {
            if (Avx2.IsAvx2Supported)
            {
                ...
                return mm256_blendv_si256(even, odd, Avx.mm256_set1_epi16(unchecked((short)0xFF00)));
            }
            else throw new IllegalInstructionException();
        }
        ...
        public static v128 mullo_epi32(v128 a, v128 b, byte elements = 4) 
        {
            ...
            else if (Sse2.IsSse2Supported)
            {
                ...
                else
                {
                    if (elements == 2)
                    {
                        a = Sse2.shuffle_epi32(a, Sse.SHUFFLE(0, 1, 0, 0));
                        b = Sse2.shuffle_epi32(b, Sse.SHUFFLE(0, 1, 0, 0));

                        return Sse2.shuffle_epi32(Sse2.mul_epu32(a, b), Sse.SHUFFLE(0, 0, 2, 0));
                    }
                    else
                    {
        ...
        public static v128 mulhi_epi64(v128 x, v128 y, out v128 low)
        {
            if (Sse2.IsSse2Supported)
            {
                v128 high = mulhi_epu64(x, y, out low);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static v256 mm256_mulhi_epi64(v256 x, v256 y, out v256 low, byte elements = 4)
        {
            if (Avx2.IsAvx2Supported)
            {
                v256 high = mm256_mulhi_epu64(x, y, out low);

                if (constexpr.ALL_GE_EPI64(x, 0, elements) && constexpr.ALL_GE_EPI64(y, 0, elements))
                {
                    ;
                }
                else
                {
                    high = Avx2.mm256_sub_epi64(high, Avx2.mm256_add_epi64(Avx2.mm256_and_si256(y, mm256_srai_epi64(x, 63)), Avx2.mm256_and_si256(x, mm256_srai_epi64(y, 63))));
                }

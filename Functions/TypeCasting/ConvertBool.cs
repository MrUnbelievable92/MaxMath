...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte8 cvt_uint8(bool4x2 v)
        {
            return select(default(byte8), new byte8(1), v);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte16 cvt_uint8(bool4x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte8 cvt_int8(bool4x2 v)
        {
            return select(default(sbyte8), new sbyte8(1), v);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sbyte16 cvt_int8(bool4x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort8 cvt_uint16(bool4x2 v)
        {
            return select(default(ushort8), new ushort8(1), v);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ushort16 cvt_uint16(bool4x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short8 cvt_int16(bool4x2 v)
        {
            return select(default(short8), new short8(1), v);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static short16 cvt_int16(bool4x4 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint8 cvt_uint32(bool4x2 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int8 cvt_int32(bool4x2 v)
        {
        ...
        {                                                  // new half(1f).value
            ushort2 backingFields = select(default(ushort2), new ushort2(0x3C00), v);
        ...
        {                                                  // new half(1f).value
            ushort3 backingFields = select(default(ushort3), new ushort3(0x3C00), v);
        ...
        {                                                  // new half(1f).value
            ushort4 backingFields = select(default(ushort4), new ushort4(0x3C00), v);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 cvt_f32(bool4x2 v)
        {

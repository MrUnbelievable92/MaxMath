...
namespace MaxMath
{
    unsafe public static partial class maxmath
    {
        ...
        {
            return X86.Fma.mm256_fmadd_ps(a, b, c);
        }
        ...
        {
            return X86.Avx.mm256_round_ps(x, (int)X86.RoundingMode.FROUND_TRUNC);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 round(float8 x)
        {
            return X86.Avx.mm256_round_ps(x, (int)X86.RoundingMode.FROUND_NINT);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 floor(float8 x)
        {
            return X86.Avx.mm256_floor_ps(x);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 ceil(float8 x)
        {
            return X86.Avx.mm256_ceil_ps(x);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 sqrt(float8 x)
        {
            return X86.Avx.mm256_sqrt_ps(x);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float8 rsqrt(float8 x)
        {
            return X86.Avx.mm256_rsqrt_ps(x);
        }

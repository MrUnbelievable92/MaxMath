...
Assert.IsBetween(imm8, 0, 3);
        ...
        /// <summary>       Returns a bool4x2 vector from the first 8 bits of an int value.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool8 mask2bool8(int imm8)
        {
            return (v128)(byte8)(1 & shr_l(imm8, new int8(0, 1, 2, 3, 4, 5, 6, 7)));
        }

        /// <summary>       Returns a bool4x4 vector from the first 16 bits of an int value.      </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
Assert.IsBetween(imm8, 0, ushort.MaxValue);
        ...
        public static bool32 mask2bool32(int imm8)
        {
            ...
            byte32 result = Avx2.mm256_packus_epi16(Avx2.mm256_packus_epi32(1 & shr_l(broadcast, new int8(0, 1, 2, 3, 4, 5, 6, 7)),
                                                                            1 & shr_l(broadcast, new int8(8, 9, 10, 11, 12, 13, 14, 15))),   
                                                    1 & (ushort16)Avx2.mm256_packus_epi32(shr_l(broadcast, new int8(16, 17, 18, 19, 20, 21, 22, 23)),
                                                                                          shr_l(broadcast, new int8(24, 25, 26, 27, 28, 29, 30, 31))));

            result = Avx2.mm256_permutevar8x32_epi32(result, new v256(0, 4, 1, 5, 2, 6, 3, 7));
